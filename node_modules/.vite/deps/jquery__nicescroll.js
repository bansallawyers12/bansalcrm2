import {
  require_jquery
} from "./chunk-G4TVLTN3.js";
import {
  __commonJS
} from "./chunk-HKJ2B2AA.js";

// node_modules/jquery.nicescroll/jquery.nicescroll.js
var require_jquery_nicescroll = __commonJS({
  "node_modules/jquery.nicescroll/jquery.nicescroll.js"(exports, module) {
    (function(factory) {
      ...
      "use strict";
      var domfocus = false, mousefocus = false, tabindexcounter = 0, ascrailcounter = 2e3, globalmaxzindex = 0;
      var $ = jQuery2, _doc = document, _win = window, $window = $(_win);
      var delegatevents = [];
      ...
      var getBrowserDetection = function() {
        ...
        var _el = _doc.createElement("DIV"), _style = _el.style, _agent = navigator.userAgent, _platform = navigator.platform, d = {};
      ...
      var NiceScrollClass = function(myopt, me) {
        ...
        if (myopt || false) {
          for (var a in opt) {
            if (myopt[a] !== void 0) opt[a] = myopt[a];
          }
        }
        ...
        this.scrollTop = function(val) {
          return val === void 0 ? self.getScrollTop() : self.setScrollTop(val);
        };
        this.scrollLeft = function(val) {
          return val === void 0 ? self.getScrollLeft() : self.setScrollLeft(val);
        };
        ...
        this.init = function() {
          ...
          if (!self.ispage || !cap.isieold) {
            ...
            var v, a2, kp = ["left", "right", "top", "bottom"];
            for (var n in kp) {
              a2 = kp[n];
              v = opt.railpadding[a2] || 0;
              v && rail.css("padding-" + a2, v + "px");
            }
            rail.append(cursor);
                    ...
                    if (!ip) {
                      ...
                      if (opt.emulatetouch) {
                        if (tg.onclick && !(tg._onclick || false)) {
                          ...
                          tg.onclick = function(e2) {
                            if (self.hasmoving) return false;
                            tg._onclick.call(this, e2);
                          };
                        }
                        return self.cancelEvent(e);
                      }
        ...
        this.mousewheel = function(dom, fn, bubble) {
          ...
          if ("onwheel" in _doc.createElement("div")) {
            ...
            var wname = _doc.onmousewheel !== void 0 ? "mousewheel" : "DOMMouseScroll";
          ...
          if (!de) {
            de = {
              ...
              f: function(e) {
                ...
                var r = false;
                for (var a2 = l; a2 >= 0; a2--) {
                  r = lst[a2].call(e.target, e);
        ...
        this.undelegate = function(dom, name, fn, bubble, active) {
          var de = delegatevents[name] || false;
          if (de && de.l) {
            for (var a2 = 0, l = de.l.length; a2 < l; a2++) {
              if (de.a[a2] === self.id) {
                de.a.splice(a2);
                de.l.splice(a2);
                if (de.a.length === 0) {
        ...
        this.unbindAll = function() {
          for (var a2 = 0; a2 < self.events.length; a2++) {
            var r = self.events[a2];
        ...
        this.remove = function() {
          ...
          for (var a2 = 0; a2 < self.saved.css.length; a2++) {
            var d = self.saved.css[a2];
            d[0].css(d[1], d[2] === void 0 ? "" : d[2]);
          }
          self.saved = false;
          self.me.data("__nicescroll", "");
          var lst = $.nicescroll;
          lst.each(function(i2) {
            if (!this) return;
            if (this.id === self.id) {
              delete lst[i2];
              for (var b = ++i2; b < lst.length; b++, i2++) lst[i2] = lst[b];
              lst.length--;
        ...
        this.getViewport = function(me2) {
          var dom = me2 && me2.parentNode ? me2.parentNode : false;
        ...
        this.doZoomIn = function(e) {
          ...
          for (var a2 in lst) {
            var pp = lst[a2];
            self.zoomrestore.style[pp] = win[pp] !== void 0 ? win[pp] : "";
          }
      ...
      var _scrollTop = jQuery2.fn.scrollTop;
      jQuery2.cssHooks.pageYOffset = {
      ...
      jQuery2.fn.scrollTop = function(value) {
        if (value === void 0) {
          var nice = this[0] ? $.data(this[0], "__nicescroll") || false : false;
          return nice && nice.ishwscroll ? nice.getScrollTop() : _scrollTop.call(this);
        } else {
          return this.each(function() {
            var nice2 = $.data(this, "__nicescroll") || false;
            nice2 && nice2.ishwscroll ? nice2.setScrollTop(parseInt(value)) : _scrollTop.call($(this), value);
          });
        }
      };
      var _scrollLeft = jQuery2.fn.scrollLeft;
      ...
      jQuery2.fn.scrollLeft = function(value) {
        if (value === void 0) {
          var nice = this[0] ? $.data(this[0], "__nicescroll") || false : false;
          ...
          return this.each(function() {
            var nice2 = $.data(this, "__nicescroll") || false;
            nice2 && nice2.ishwscroll ? nice2.setScrollLeft(parseInt(value)) : _scrollLeft.call($(this), value);
          });
        }
      };
      var NiceScrollArray = function(doms) {
        ...
        this.push = function(nice2) {
          self[self.length] = nice2;
          self.length++;
        };
      ...
      jQuery2.fn.getNiceScroll = function(index) {
        if (index === void 0) {
      ...
      var pseudos = jQuery2.expr.pseudos || jQuery2.expr[":"];
      pseudos.nicescroll = function(a) {
        return $.data(a, "__nicescroll") !== void 0;
      };
      $.fn.niceScroll = function(wrapper, _opt) {
        if (_opt === void 0 && typeof wrapper == "object" && !("jquery" in wrapper)) {
          _opt = wrapper;
          wrapper = false;
        }
...
export default require_jquery_nicescroll();
//# sourceMappingURL=jquery__nicescroll.js.map
