    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/pages/admin/partner-detail-entry.js',
                'resources/js/pages/admin/popover-entry.js',
                'resources/js/pages/admin/client-edit-entry.js',
                'resources/js/pages/admin/client-create-entry.js',
                'resources/js/pages/admin/invoice-create-entry.js',
                'resources/js/pages/admin/emails-v2-entry.js',
