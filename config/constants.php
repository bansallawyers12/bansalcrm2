...
return [
    ...
    */
	...
	'media_thumbnail_gallery' => public_path().'/img/media_gallery/thumbnail',
    ...
    'client_receipts' => public_path().'/img/client_receipts',
