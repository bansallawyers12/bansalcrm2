...
trait ClientHelpers
{
    ...
    /**
     * Normalize related client IDs from a request array or comma-separated string.
     *
     * @param  array<int, mixed>|string|null  $value
     * @return list<string>
     */
    protected function normalizeRelatedClientIds(array|string|null $value): array
    {
        if ($value === null || $value === '') {
            return [];
        }
