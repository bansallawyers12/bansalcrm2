...
class ListTables extends Command
{
     ...
     * @var string
     */
    protected $signature = 'db:list-tables {--connection=pgsql : Database connection to use}';
     ...
     */
    private function getAllTables(string $connection): array
    {
        if ($connection !== 'pgsql') {
            throw new \InvalidArgumentException("Unsupported connection: {$connection}. Use pgsql.");
        }
