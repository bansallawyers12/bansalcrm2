...
class Note extends Model
{
    ...
    protected $fillable = [
        'id','user_id','client_id','title','mail_id','type','assigned_to','pin','action_assign_date','is_action','status','description','created_at', 'updated_at','task_group','mobile_number'
    ];
