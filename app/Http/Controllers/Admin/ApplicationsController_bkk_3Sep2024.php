					...
					<div class="row">
                        <div class="col-12 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<input type="text" readonly name="college_name" class="form-control" value="<?php echo $appInfo->partner_name;?>">
                        ...
                        <div class="col-12 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<input type="text" readonly name="course_name" class="form-control" value="<?php echo $appInfo->coursename;?>">
                        ...
                        <div class="col-12 col-md-4 col-lg-4">
							<div class="form-group">
                                ...
                                <select name="installment" class="form-control" data-valid="required">
                                    ...
                                    <option value="Yes" <?php if( $appfeeoption->installment == 'Yes' ) { echo ' selected="selected"'; } else { echo '';} ?> >Yes</option>
	                                <option value="No" <?php if( $appfeeoption->installment == 'No' ) { echo ' selected="selected"'; } else { echo '';} ?> >No</option>
                                </select>
								...
								<table class="table text_wrap" id="productitemview">
									...
									<tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td>Bonus - <input type="text" name="bonus" id="bonus" value="<?php if( isset($appfeeoption->bonus_amount) && $appfeeoption->bonus_amount != "") { echo $appfeeoption->bonus_amount;} ?>"></td>
                                        </tr>
                                    </tfoot>
								</table>
							</div>
					...
					<div class="row">
						...
						<div class="col-12 col-md-12 col-lg-12" style="margin-top: 10px;">
                            ...
                            <div style="float:left;">
                                <div class="fee_option_addbtn_latest">
