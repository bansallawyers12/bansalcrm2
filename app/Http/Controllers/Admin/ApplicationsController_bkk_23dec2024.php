...
class ApplicationsController extends Controller
{
						...
						<div class="accordion cus_accrodian">
							...
							<div class="accordion-header collapsed <?php echo $stage1; ?> <?php if($fetchData->stage == $stages->name && $fetchData->status != 1){ echo  'app_blue'; }  ?>"" role="button" data-toggle="collapse" data-target="#<?php echo $stagname; ?>_accor" aria-expanded="false">
								...
								<div class="accord_hover">
									...
									<a title="Add Document" class="opendocnote" data-app-type="<?php echo $stagname; ?>" data-typename="<?php echo $stages->name; ?>" data-id="<?php echo $fetchData->id; ?>" href="javascript:;"><i class="fa fa-file-image"></i></a>
                                    ...
                                    <a data-course="<?php echo $course_name; ?>" data-school="<?php echo $school_name; ?>" data-app-type="<?php echo $stages->name; ?>" title="Actions" class="openappaction" data-id="<?php echo $fetchData->id; ?>" href="javascript:;"><i class="fa fa-calendar"></i></a>
							...
							<div class="table-responsive">
								<table class="table text_wrap" id="productitemview">
									...
									<tfoot>
										...
										<input type="hidden" name="bonus" id="bonus" value="<?php if( isset($appfeeoption->bonus_amount) && $appfeeoption->bonus_amount != "") { echo $appfeeoption->bonus_amount;} ?>">
                                        <input type="hidden" name="bonus_paid" value="<?php if( isset($appfeeoption->bonus_paid) && $appfeeoption->bonus_paid != "") { echo $appfeeoption->bonus_paid;} ?>">
    ...
    public function checklistupload(Request $request){ //dd($request->all());
        ...
        foreach($applicationdocuments as $applicationdocument){
            ...
            $checklistdata .= '<td>'.@$applicationdocument->document_type.'</td>';
            $checklistdata .= '<td><div class="circular-box cursor-pointer"><button class="transparent-button paddingNone">'.$appcount.'</button></div></td>';
            $checklistdata .= '<td><a data-aid="'.$application_id.'" data-type="'.$request->type.'" data-typename="'.$request->typename.'" data-id="'.$applicationdocument->id.'" class="openfileupload" href="javascript:;"><i class="fa fa-plus"></i></a></td>';
            $checklistdata .= '</tr>';
        }
		$checklistdata .= '</tbody></table>';
		$response['checklistdata']	=	$checklistdata;
							...
							<div class="table-responsive">
                               <div style="float:right;margin-bottom:10px;">
								...
								<table class="table text_wrap" id="productitemviewlatest">
									<thead>
										<tr>
											<th style="white-space: initial;width: 150px;">Date</th>
											<th style="white-space: initial;width: 135px;">Tuition Fees Paid($)</th>
											<th style="white-space: initial;width: 100px;">Commission Percentage(%)</th>
                                            <th style="white-space: initial;width: 135px;">Commission Earned($)</th>
                                            <th style="white-space: initial;width: 135px;">Adjustment/Discount Entries($)</th>
                                    ...
                                    $total_adjustment_discount = 0.00;
									...
									if($appfeeoption){
										...
										foreach($appfeeoptiontype as $fee){
                                            ...
                                            $total_adjustment_discount += $fee->adjustment_discount_entry;
									...
									?>
										<tr class="add_fee_option cus_fee_option">
                                            ...
                                            <td>
												<input type="number" data-valid="required" value="" class="form-control commission_percentage" name="commission_percentage[]">
											</td>
									...
									<tfoot>
                                        <tr>
                                            ...
                                            <td class="net_totl text-info total_adjustment_discount_entry"><?php if( isset($total_adjustment_discount) && $total_adjustment_discount != "" ){ echo $total_adjustment_discount;}?></td>
   ...
   //Save application Fee latest
    ...
    public function overdueApplicationList(Request $request)
	{
		...
		$lists	= $query->sortable(['id' => 'desc'])->paginate(10);
        return view('Admin.applications.overdue', compact(['lists', 'totalData','allstages']));
    }
