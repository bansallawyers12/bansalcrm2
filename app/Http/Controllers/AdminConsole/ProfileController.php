...
class ProfileController extends Controller
{
	...
	$query 		= Profile::query();
		...
		return view('AdminConsole.profile.index',compact(['lists', 'totalData'])); 	
		
		//return view('AdminConsole.profile.index');	 
	}
	...
	public function create(Request $request)
	{
		...
		return view('AdminConsole.profile.create');	
	}
	...
	{		
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/adminconsole/profiles')->with('success', 'Profile Added Successfully');
			}				
		}	
	...
	public function edit(Request $request, $id = NULL)
	{
		...
		if ($request->isMethod('post')) 
		{
			...
			{
				return Redirect::to('/adminconsole/profiles')->with('success', 'Profile updated Successfully');
			}				
		}
		...
		{		
			if(isset($id) && !empty($id))
			{
				...
				if(Profile::where('id', '=', $id)->exists()) 
				{
					...
					return view('AdminConsole.profile.edit', compact(['fetchedData']));
				}
				else 
				{
			...
			{
				return Redirect::to('/adminconsole/profiles')->with('error', Config::get('constants.unauthorized'));
			}		
		} 	
