						...
						$.ajax({
							...
							success: function(response){
								...
								if(obj.status){
                                    if(obj.function_type == 'add')
                                    {
                                        if(obj.requestData){
                                            ...
                                            //$.each(reqData, function(index, subArray) {
                                                ...
                                                trRows += "<tr id='TrRow_"+last_invoice_id+"'><td style='padding-top: 5px !important;padding-bottom: 5px !important;'>"+subArray.invoice_date+" "+awsLink+"</td><td style='padding-top: 5px !important;padding-bottom: 5px !important;'>"+subArray.invoice_no+"</td><td style='padding-top: 5px !important;padding-bottom: 5px !important;'>"+db_total_enrolled_student+"</td><td style='padding-top: 5px !important;padding-bottom: 5px !important;'>$"+db_total_amount+" "+printLink+"</td><td style='padding-top: 5px !important;padding-bottom: 5px !important;'><select name='sent_option'  class='sent_option' data-invoiceid="+last_invoice_id+"><option value='No'>No</option><option value='Yes'>Yes</option></select></td></tr>";
                                            //});
                                        }
                                        //console.log('trRows='+trRows);
                                        $('.lastRow').before(trRows);
                                    ...
                                    if(obj.db_total_deposit_amount){
										$('.totDepoAmTillNow').html("$"+obj.db_total_deposit_amount);
                                        $('#Total_Amount_Invoiced').val("$"+obj.db_total_deposit_amount);
                                    }
									$('.custom-error-msg').html('<span class="alert alert-success">'+obj.message+'</span>');
								}else{
									$('.custom-error-msg').html('<span class="alert alert-danger">'+obj.message+'</span>');
                                    ...
                                    if(obj.function_type == 'add')
                                    {
                                        if(obj.requestData){
                                            ...
                                            $.each(reqData, function(index, subArray) {
                                                ...
                                                trRows += "<tr><td>"+subArray.invoice_date+" "+awsLink+"</td><td>"+subArray.sent_date+"</td><td>"+subArray.invoice_no+"</td><td>$"+subArray.amount_aud+"</td></tr>";
                                            });
                                        }
                                        //console.log('trRows='+trRows);
                                    ...
                                    if(obj.function_type == 'add')
                                    {
                                        if(obj.requestData){
                                            ...
                                            $.each(reqData, function(index, subArray) {
                                                ...
                                                trRows += "<tr><td>"+subArray.invoice_no+" "+awsLink+"</td><td>"+subArray.method_received+"</td><td>"+subArray.verified_by+"</td><td>"+subArray.verified_date+"</td><td>$"+subArray.amount_aud+"</td></tr>";
                                            });
                                        }
                                        //console.log('trRows='+trRows);
