					...
					<div class="card">
						...
						<div class="card-body">
							...
							<ul class="nav nav-pills" id="checkin_tabs" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active" id="waiting-tab"  href="<?php echo e(URL::to('/admin/office-visits/waiting')); ?>" >Waiting <span class="countAction"><?php echo e($InPersonCount_waiting_type); ?></span></a>
								</li>
								<li class="nav-item">
								...
								<li class="nav-item">
									<a class="nav-link" id="completed-tab"  href="<?php echo e(URL::to('/admin/office-visits/completed')); ?>" >Completed <span class="countAction"><?php echo e($InPersonCount_completed_type); ?></span></a>
								</li>
								<li class="nav-item">
							...
							<div class="tab-content" id="checkinContent">
								<div class="mydropdown" style="margin-top:10px;">
								  ...
								  <a href="<?php echo e(URL::to('/admin/office-visits/waiting')); ?>">All Branches</a>
								  <?php
								  $branchs = \App\Models\Branch::all();
								  foreach($branchs as $branch){
									?>
									<a href="<?php echo e(URL::to('/admin/office-visits/waiting')); ?>?office=<?php echo e($branch->id); ?>&office_name=<?php echo e($branch->office_name); ?>"><?php echo e($branch->office_name); ?></a>
								  <?php } ?>
										...
										<table class="table text_wrap">
											...
											<tbody class="tdata checindata">
												...
												$client = \App\Models\Lead::where('id', '=', $list->client_id)->first();
												 ?>
										    <a target="_blank" href="<?php echo e(route('admin.leads.detail', base64_encode(convert_uuencode(@$client->id)))); ?>"><?php echo e(@$client->first_name); ?> <?php echo e(@$client->last_name); ?></a>
										    <?php
										}else{
										    $client = \App\Models\Admin::where('role', '=', '7')->where('id', '=', $list->client_id)->first();
										    ?>
										    <a target="_blank" href="<?php echo e(URL::to('/admin/clients/detail/'.base64_encode(convert_uuencode(@$client->id)))); ?>"><?php echo e(@$client->first_name); ?> <?php echo e(@$client->last_name); ?></a>
										    <?php
										}
													...
													?>
													<a href="<?php echo e(URL::to('/admin/users/view/'.@$admin->id)); ?>"><?php echo e(@$admin->first_name); ?> <?php echo e(@$admin->last_name); ?></a><br><?php echo e(@$admin->email); ?>

													</td>
													<td id="count<?php echo e($list->id); ?>" data-checkintime="<?php echo e(date('Y-m-d H:i:s',strtotime($list->created_at))); ?>"><?php if($list->status == 0){ ?><span id="waitcount"> 00h:00m:00s</span><?php }else if($list->status == 2){ echo '<span>'.$list->wait_time.'</span>'; }else{ echo '<span >-</span>'; } ?></td>
										<td style="white-space: initial;">
										    <!--<a href="javascript:;" data-id="<?php echo e(@$list->id); ?>" class="btn btn-success attendsessionforclient">Pls send</a>-->
										    
										    <?php
                                            if($list->wait_type == 1){ ?>
                                                <a href="javascript:;" data-id="<?php echo e(@$list->id); ?>" data-waitingtype="<?php echo e(@$list->wait_type); ?>" class="btn btn-success attendsessionforclient">Pls send</a>
                                            <?php } else { ?>
                                                <a href="javascript:;" data-id="<?php echo e(@$list->id); ?>" data-waitingtype="<?php echo e(@$list->wait_type); ?>" class="btn btn-danger attendsessionforclient">Waiting</a>
                                            <?php } ?>
										    
											<input type="hidden" value="0-6h:0-24m:0-7s" id="lwaitcountdata<?php echo e(@$list->id); ?>">
											</td>
												</tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\officevisits\waiting.blade.php ENDPATH**/ ?>