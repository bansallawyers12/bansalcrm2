...
<?php $__env->startSection('title', 'Agent Detail'); ?>
					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
								<a href="<?php echo e(route('admin.agents.active')); ?>" class="btn btn-primary">Agent List</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
					...
					<div class="card author-box">
						<div class="card-body">
							<div class="author-box-center">
								<span class="author-avtar" style="background: rgb(68, 182, 174);"><b><?php echo e(substr($fetchedData->full_name, 0, 1)); ?></b></span>
								<div class="clearfix"></div>
								<div class="author-tag">
									<span><?php echo e($fetchedData->struture); ?></span>
								</div>
								<div class="author-box-name">
									<a href="#"><?php echo e($fetchedData->full_name); ?></a>
								</div>
								<div class="author-mail_sms">
									<a href="#" title="Compose SMS"><i class="fas fa-comment-alt"></i></a>
									<a href="javascript:;" data-id="<?php echo e(@$fetchedData->id); ?>" data-email="<?php echo e(@$fetchedData->email); ?>" data-name="<?php echo e(@$fetchedData->full_name); ?>" class="clientemail" title="Compose Mail"><i class="fa fa-envelope"></i></a>  
									<a href="<?php echo e(URL::to('/admin/agents/edit/'.base64_encode(convert_uuencode(@$fetchedData->id)))); ?>" title="Edit"><i class="fa fa-edit"></i></a>
								</div>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div class="card-body">
							<p class="clearfix"> 
								...
								<span class="float-right text-muted"><?php echo e($fetchedData->country_code); ?><?php echo e($fetchedData->phone); ?></span>
							</p>
							<p class="clearfix"> 
							...
							<p class="clearfix"> 
								...
								<span class="float-right text-muted"><a href="javascript:;" class="btn btn-sm btn-outline-primary"><?php echo e($fetchedData->agent_type); ?></a> </span>
							</p>
							<p class="clearfix"> 
								<span class="float-left">Claim Revenue Percentage:</span>
								<span class="float-right text-muted"><?php echo e($fetchedData->claim_revenue); ?></span>
							</p>
							<p class="clearfix"> 
								<span class="float-left">Income Sharing Percentage:</span>
								<span class="float-right text-muted"><?php echo e($fetchedData->income_sharing); ?></span>
							</p>
							<p class="clearfix"> 
							...
							<p class="clearfix"> 
								...
								<span class="float-right text-muted"><?php echo e($fetchedData->tax_number); ?></span>
							</p>
						</div>
					</div>
				</div>
									...
									<div class="table-responsive"> 
										<table class="table text_wrap table-2">
											...
											<tbody class="referredclienttdata">
												...
												?>
												<tr id="id_<?php echo e($reflist->id); ?>">
													<td><?php echo e($reflist->first_name); ?> <?php echo e($reflist->last_name); ?></td>
													<td>-</td>
													<td><?php echo e($reflist->city); ?><br/><?php echo e($reflist->country); ?></td>
													<td><span class="ag-label--circular" style="color: #6777ef" >In Progress</span></td>
													<td><?php echo e($reflist->assignee); ?></td>
													<td><?php echo e(date('Y-m-d', strtotime($reflist->created_at))); ?></td>
												</tr>
												<?php
													} 
												?>
				...
				$clientdetail = \App\Models\Admin::where('id', $alist->client_id)->first();
												...
												<tr id="id_<?php echo e($alist->id); ?>">
													<td><a href="<?php echo e(URL::to('admin/clients/detail/')); ?>/<?php echo e(base64_encode(convert_uuencode(@$clientdetail->id))); ?>?tab=application"><?php echo e(@$clientdetail->first_name); ?> <?php echo e(@$clientdetail->last_name); ?></a><br/><?php echo e(@$clientdetail->email); ?></td> 
													<td><a href="<?php echo e(URL::to('admin/clients/detail/')); ?>/<?php echo e(base64_encode(convert_uuencode(@$clientdetail->id))); ?>?tab=application"><?php echo e($productdetail->name); ?></a> <br><small><?php echo e($partnerdetail->partner_name); ?> (<?php echo e($PartnerBranch->name); ?>)</small></td> 
													<td><?php echo e($alist->stage); ?><br><?php echo e($workflow->name); ?></td>
									...
									<div class="table-responsive if_partnerdetail"> 
										<table class="table text_wrap table-2">
											...
											<tbody class="partnerdata">
												...
												?> 
												<tr id="id_<?php echo e($partnertlist->id); ?>">
													...
													<td><a onclick="deleteAction(<?php echo e($partnertlist->id); ?>, 'representing_partners')" href="javascript:;"><i class="fa fa-link"></i></a></td>
												</tr>
												<?php } ?>
											</tbody>
										</table>
...
<?php echo $__env->make('Admin/agents/addagentmodal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>  
<?php echo $__env->make('Admin/agents/editagentmodal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>  
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\agents\detail.blade.php ENDPATH**/ ?>