...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('route' => 'admin.partners.store', 'method' => 'post', 'name'=>"add-partner", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
						...
						<div class="card">
							<div class="card-body">
													...
													<div class="row">
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group">
																...
																<select data-valid="required" id="getpartnertype" class="form-control addressselect2" name="master_category">
																	...
																	<option value="<?php echo e($clist->id); ?>"><?php echo e($clist->category_name); ?></option>
														...
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group">
																...
																<?php echo Form::text('partner_name', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Trading Name' )); ?>
														...
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group">
																...
																<?php echo Form::text('business_reg_no', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter ABN' )); ?>
                                                        ...
                                                        <div class="col-12 col-md-6 col-lg-6">
															<div class="form-group">
																...
																<?php echo Form::text('legal_name', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Legal Name' )); ?>
                                            ...
                                            <div class="row">
												...
												<div class="col-4 col-md-4 col-lg-4">
                                                    <div class="form-group">
														...
														<?php if($errors->has('partner_email')): ?>
															<span class="custom-error" role="alert">
																<strong><?php echo e(@$errors->first('partner_email')); ?></strong>
															</span>
														<?php endif; ?>
													</div>
												</div>
                                            ...
                                            <div class="row">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<?php echo Form::text('website', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Website' )); ?>
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<?php echo Form::text('level', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter level' )); ?>
								...
								<div class="form-group float-right">
									<?php echo Form::button('Save Partner', ['class'=>'btn btn-primary', 'onClick'=>'customValidate("add-partner")' ]); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\partners\create.blade.php ENDPATH**/ ?>