					...
					<div class="card">
						...
						<div class="card-body">
							...
							<ul class="nav nav-pills" id="checkin_tabs" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active" id="attending-tab"  href="<?php echo e(URL::to('/admin/office-visits/attending')); ?>" >Attending <span class="countAction"><?php echo e($InPersonCount_attending_type); ?></span></a>
								</li>
								<li class="nav-item">
							...
							<div class="mydropdown" style="margin-top:10px;">
								  ...
								  <a href="<?php echo e(URL::to('/admin/office-visits/attending')); ?>">All Branches</a>
								  <?php
								  $branchs = \App\Models\Branch::all();
								  foreach($branchs as $branch){
									?>
									<a href="<?php echo e(URL::to('/admin/office-visits/attending')); ?>?office=<?php echo e($branch->id); ?>&office_name=<?php echo e($branch->office_name); ?>"><?php echo e($branch->office_name); ?></a>
								  <?php } ?>
									...
									<div class="table-responsive common_table">
										<table class="table text_wrap">
										    ...
										    <?php
													...
													<td id="count<?php echo e($list->id); ?>" data-checkintime="<?php echo e(date('Y-m-d H:i:s',strtotime($list->sesion_start))); ?>"><?php if($list->status == 0){ ?><span id="waitcount"> 00h:00m:00s</span><?php }else if($list->status == 2){ echo '<span>'.$list->attend_time.'</span>'; }else{ echo '<span >-</span>'; } ?></td>
												</tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\officevisits\attending.blade.php ENDPATH**/ ?>