...
<?php $__env->startSection('title', 'Import Business Agents'); ?>
				...
				<div class="col-12 col-md-12 col-lg-12">
					<div class="card">
						<div class="card-header">
							<h4>Import Business Agents</h4>
							
							<div class="card-header-action">
									<a href="<?php echo e(asset('img/BusinessTemplate.xlsx')); ?>" class="btn btn-primary"><i class="fa fa-download"></i> Download Template</a>
								</div>
						</div>
						<div class="card-body">
							...
							<div class="tab-content" id="clientContent">	
								...
								<?php echo Form::open(array('url' => 'admin/agents/import/business', 'name'=>"add-agents", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
										...
										<div class="row"> 
											...
											<div class="col-6 col-md-6 col-lg-6">
												...
												<ul>
													...
													<li>Tax No.</li>
													<li>Contract Expiry Date (yyyy/mm/dd)</li>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\agents\importbusiness.blade.php ENDPATH**/ ?>