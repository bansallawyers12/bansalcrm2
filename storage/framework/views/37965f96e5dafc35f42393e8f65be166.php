					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
								<a href="<?php echo e(route('admin.products.index')); ?>" class="btn btn-primary">Product List</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-3 col-md-3 col-lg-3">
					<div class="card author-box">
						<div class="card-body">
							...
							<span class="author-avtar" style="background: rgb(68, 182, 174);"><b><?php echo e(substr($fetchedData->name, 0, 1)); ?></b></span>
								<div class="clearfix"></div>
								<div class="author-box-name">
									<a href="#"><?php echo e($fetchedData->name); ?></a>
								</div>
								<div class="author-mail_sms"> 
									<a href="<?php echo e(URL::to('/admin/products/edit/'.base64_encode(convert_uuencode(@$fetchedData->id)))); ?>" title="Edit"><i class="fa fa-edit"></i></a>
								</div>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div class="card-body">
							...
							<p class="clearfix"> 
								...
								<span class="float-right text-muted"><?php echo e($fetchedData->duration); ?></span>
							</p>
							<p class="clearfix"> 
								<span class="float-left">Intake Month:</span>
								<span class="float-right text-muted"><?php if($fetchedData->preferredIntake != '-- Select Intake Month --' || $fetchedData->preferredIntake != ''){ ?><?php echo e($fetchedData->intake_month); ?><?php } ?></span>
							</p>
							<p class="clearfix"> 
								<span class="float-left">Revenue Type: </span>
								<span class="float-right text-muted"><?php echo e($fetchedData->revenue_type); ?></span>
							</p>
							<p class="clearfix"> 
								<span class="float-left">Notes: </span>
								<span class="float-right text-muted"><?php echo e($fetchedData->note); ?></span>
							</p>
							<p class="clearfix"> 
								<span class="float-left">Description: </span>
								<span class="float-right text-muted"><?php echo $fetchedData->description; ?></span>
							</p> 
						</div>
					</div>
				</div>
				...
				$workflow = \App\Models\Workflow::where('id', $alist->workflow)->first();
												...
												<tr id="id_<?php echo e($alist->id); ?>">
													<td><a class="" data-id="<?php echo e($alist->id); ?>" href="<?php echo e(URL::to('/admin/clients/detail')); ?>/<?php echo e(base64_encode(convert_uuencode(@$alist->id))); ?>" style="display:block;"><?php echo e($clientdetail->first_name); ?> <?php echo e($clientdetail->last_name); ?></a> </td> 
													<td><?php echo e($admindetail->first_name); ?> <?php echo e($admindetail->last_name); ?></td>
													...
													<td>
													<?php echo e(date('Y-m-d', strtotime($alist->updated_at))); ?>
...
<?php echo $__env->make('Admin/products/addproductmodal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>  
<?php echo $__env->make('Admin/products/editproductmodal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>    
...
$(document).delegate('.other_info_edit', 'click', function(){
	...
	$.ajax({
			url: '<?php echo e(URL::to('/admin/product/getotherinfo')); ?>',
			type:'GET',
			data:{id:'<?php echo e($fetchedData->id); ?>'},
			success:function(response){
				$('.popuploader').hide();
...
$(document).delegate('#notes-tab', 'click', function(){
  ...
  $('#attachments').on('change',function(){
	...
	$(document).delegate('.editfeeoption', 'click', function(){
		...
		$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getfeeoptionedit')); ?>',
			type:'GET',
			data:{id:appliid},
			success:function(response){
				$('.popuploader').hide();
	...
	<?php foreach(\App\Models\FeeType::all() as $feetypes){ ?>
			htmldd +='<option <?php if($feetypes->name == 'Tution fees'): ?> selected <?php endif; ?> value="<?php echo e($feetypes->name); ?>"><?php echo e($feetypes->name); ?></option>';
	<?php } ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\products\detail.blade.php ENDPATH**/ ?>