...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('url' => 'admin/branch/store', 'name'=>"add-branch", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
						...
						<div class="card">
							<div class="card-body">
											...
											<div class="row"> 						
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<?php echo Form::text('office_name', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Office Name' )); ?>
													...
													<div class="form-group"> 
														...
														<?php
															foreach(\App\Models\Country::all() as $list){
																?>
																<option value="<?php echo e(@$list->sortname); ?>" ><?php echo e(@$list->name); ?></option>
																<?php
															}
															?>
														</select>
											...
											<div class="row">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<?php echo Form::text('mobile', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Mobile' )); ?>
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<?php echo Form::text('contact_person', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Contact Person' )); ?>
								...
								<div class="form-group float-right">
									<?php echo Form::button('Save Branch', ['class'=>'btn btn-primary', 'onClick'=>'customValidate("add-branch")']); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\branch\create.blade.php ENDPATH**/ ?>