...
<head>
	...
	<!-- Template CSS -->
	<link rel="stylesheet" href="<?php echo e(asset('css/niceCountryInput.css')); ?>">
	<!--<link rel="stylesheet" href="<?php echo e(asset('css/flagstrap.css')); ?>">-->
...
<body>
	...
	<div id="app">
		<div class="main-wrapper main-wrapper-1">
			...
			<!--Header-->
			<?php echo $__env->make('../Elements/Agent/header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
			<!--Left Side Bar-->
			<?php echo $__env->make('../Elements/Agent/left-side-bar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

			<?php echo $__env->yieldContent('content'); ?>
				
			<?php echo $__env->make('../Elements/Agent/footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
		</div>
	</div>
	<script>var site_url = '<?php echo e(URL::to('/')); ?>';</script>	 
	<!--<script src="<?php echo e(asset('js/niceCountryInput.js')); ?>"></script> -->  
	...
	<!--<script src="<?php echo e(asset('js/jquery.flagstrap.js')); ?>"></script>--> 
	<script src="<?php echo e(asset('js/bootstrap-formhelpers.min.js')); ?>"></script> 
	<script src="<?php echo e(asset('js/intlTelInput.js')); ?>"></script> 
	<script src="<?php echo e(asset('js/agent-custom-form-validation.js')); ?>"></script> 
	<!-- Template JS File -->
					...
					<div class="row">
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<?php
								$assignee = \App\Models\Admin::where('role',1)->get();
								?>
...
<?php echo $__env->yieldContent('scripts'); ?>	
	<script src="<?php echo e(asset('js/custom-chart.js')); ?>"></script>  
</body>
</html> <?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\layouts\agent.blade.php ENDPATH**/ ?>