						...
						<div class="card-body">
							...
							<ul class="nav nav-pills" id="client_tabs" role="tablist">
								...
								<li class="nav-item is_checked_clientn">
									<a class="nav-link active" id="prospects-tab"  href="<?php echo e(URL::to('/admin/invoice/unpaid')); ?>" >Unpaid Invoices</a>
								</li>
								<li class="nav-item is_checked_clientn">
									<a class="nav-link " id="clients-tab"  href="<?php echo e(URL::to('/admin/invoice/paid')); ?>" >Paid Invoices</a>
								</li>
										...
										<table class="table text_wrap">
											...
											<tbody class="tdata">	
												...
												<tr id="id_<?php echo $invoicelist->id; ?>">
													...
													<td><?php echo e(date('d/m/Y', strtotime($invoicelist->due_date))); ?> <?php //echo $invoicelist->due_date; ?></td>
													<td>
													<a href="<?php echo e(URL::to('admin/invoice/view/')); ?>/<?php echo $invoicelist->id; ?>"><i class="fa fa-eye"></i></a>
													<a class="clientemail" data-id="<?php echo e($invoicelist->id); ?>" data-rec-name="invoice_<?php echo e($invoicelist->id); ?>.pdf" data-href="<?php echo e(URL::to('admin/invoice/preview/')); ?>/<?php echo e(@$invoicelist->id); ?>" data-cus-id="<?php echo e(@$clientdata->id); ?>" data-email="<?php echo e(@$clientdata->email); ?>" data-name="<?php echo e(@$clientdata->first_name); ?> <?php echo e(@$clientdata->last_name); ?>" href="javascript:;"><i class="fa fa-envelope"></i></a>
													<a href="<?php echo e(URL::to('admin/invoice/edit/')); ?>/<?php echo $invoicelist->id; ?>"><i class="fa fa-edit"></i></a>
													<a href="javascript:;" class="openpaymentform" data-netamount="<?php echo e($netamount); ?>" data-dueamount="<?php echo e($totaldue); ?>" data-invoiceid="<?php echo e($invoicelist->id); ?>">$</a>
													<a data-id="<?php echo e($invoicelist->id); ?>" href="javascript:;" class="deleteinvoice"><i class="fa fa-trash"></i></a>
													</td>
												</tr>
												<?php
													}
...
<div id="addpaymentmodal" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="false" class="modal fade" >
	...
	<?php echo Form::open(array('url' => 'admin/invoice/payment-store', 'name'=>"invoicepaymentform", 'autocomplete'=>'off', "enctype"=>"multipart/form-data", "id"=>"invoicepaymentform")); ?>
						...
						<div class="payment_field_col payment_first_step">
							...
							<div class="field_col">
								<div class="input-group">
									...
									<input type="date" name="payment_date[]" placeholder="" class=" form-control" value="<?php echo e(date('Y-m-d')); ?>"/>
								</div>
...
jQuery(document).ready(function($){
	...
	$(document).delegate('#confirmModal .accept', 'click', function(){
		...
		$('.popuploader').show(); 
		$.ajax({
			url: '<?php echo e(URL::to('/admin/')); ?>/delete-invoice',
			type:'GET',
			datatype:'json',
			data:{id:notid},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\invoice\unpaid.blade.php ENDPATH**/ ?>