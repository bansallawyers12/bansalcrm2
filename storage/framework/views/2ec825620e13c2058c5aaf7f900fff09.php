					...
					<div class="card">
						...
						<div class="card-body">
							<ul class="nav nav-pills" id="quotation_tabs" role="tablist">
								<li class="nav-item">
									<a class="nav-link" id="quotation_template-tab"  href="<?php echo e(URL::to('/admin/quotations/template')); ?>" >Quotation Template</a>
								</li>
								<li class="nav-item">
									<a class="nav-link active" id="active_quotation-tab"  href="<?php echo e(URL::to('/admin/quotations')); ?>" >Active Quotations</a>
								</li>
								<li class="nav-item">
									...
									?>
										<tbody class="tdata">	
											<tr id="id_<?php echo e(@$list->id); ?>">
												...
												<td><a href="<?php echo e(URL::to('/admin/quotation/detail')); ?>/<?php echo e(base64_encode(convert_uuencode(@$list->id))); ?>"><?php echo e(@$list->id); ?></a></td>
												<td><?php echo e($client->first_name); ?> <?php echo e($client->last_name); ?><br/><?php echo e(@$client->email == "" ? config('constants.empty') : str_limit(@$client->email, '50', '...')); ?></td> 
												...
												<td><?php echo e(date('d/m/Y', strtotime($list->due_date))); ?></td>
												...
												<td>
													<div class="dropdown d-inline">
														...
														<a class="dropdown-item has-icon" target="_blank" href="<?php echo e(URL::to('/admin/quotation/preview')); ?>/<?php echo e(base64_encode(convert_uuencode(@$list->id))); ?>">Preview</a>
														<?php if($list->status != 2 && $list->status != 4){?>
															<a class="is_declined dropdown-item has-icon" href="<?php echo e(URL::to('/admin/quotations/edit/'.base64_encode(convert_uuencode(@$list->id)))); ?>">Edit</a>
														<?php } ?>
															<a class="dropdown-item has-icon clientemail" data-q-id="<?php echo e(@$list->id); ?>" data-id="<?php echo e(@$client->id); ?>" data-email="<?php echo e(@$client->email); ?>" data-name="<?php echo e(@$client->first_name); ?> <?php echo e(@$client->last_name); ?>" href="javascript:;" >Send Email</a>
															<?php if($list->status == 0 || $list->status == 3){ ?>
																<a class="is_declined dropdown-item has-icon" href="javascript:;" onClick="declineAction(<?php echo e(@$list->id); ?>, 'quotations')"><i class="far fa-mail"></i> Decline</a>
																
															<?php } ?>
															<?php if($list->status == 3): ?>
																<a class="is_declined dropdown-item has-icon" href="javascript:;" onClick="approveAction(<?php echo e(@$list->id); ?>, 'quotations')"><i class="far fa-mail"></i> Approve</a>
															<?php endif; ?>
															<?php if($list->status == 1): ?>
															<a class="processquo dropdown-item has-icon" href="javascript:;" onClick="processedAction(<?php echo e(@$list->id); ?>, 'quotations')"><i class="far fa-mail"></i> Process</a>
															<?php endif; ?>
															<?php if($list->status == 4): ?><?php else: ?>
															<a class="is_archived dropdown-item has-icon" href="javascript:;" onClick="deleteAction(<?php echo e(@$list->id); ?>, 'quotations')">Archive</a>
															<?php endif; ?>
														</div>
													</div>								  
												</td>
...
<div id="emailmodal"  data-backdrop="static" data-keyboard="false" class="modal fade custom_modal" tabindex="-1" role="dialog" aria-labelledby="clientModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" name="sendmail" action="<?php echo e(URL::to('/admin/quotations/sendmail')); ?>" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
					<div class="row">
...
$(document).delegate('.changestatus', 'click', function(){
	...
	$.ajax({
		url: '<?php echo e(URL::to('/admin/quotations/changestatus')); ?>',
		type:'GET',
		datatype:'json',
		data:{id:array},
		success: function(response){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\quotations\index.blade.php ENDPATH**/ ?>