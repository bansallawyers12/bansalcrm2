...
<?php $__env->startSection('title', 'Create Quotations'); ?>
...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('url' => 'admin/quotations/store', 'name'=>"add-quotations", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
				...
				<div class="row">
					...
					<div class="col-12 col-md-4 col-lg-4">
						<div class="card">
							...
							<div class="card-body">
								<p><?php echo e($fetchedData->first_name); ?> <?php echo e($fetchedData->last_name); ?><br><?php echo e($fetchedData->email); ?></p>
						...
						<div class="card">							
							<div class="card-body">
								<div class="form-group"> 
									...
									<?php echo Form::text('due_date', '', array('class' => 'form-control datepicker', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>
								...
								<div class="form-group"> 
									...
									<?php
									if($templatedata){
										$cuttency = $templatedata->currency;
									}else{
										$cuttency = 'AUD';
									}
									?>
									<div class="bfh-selectbox bfh-currencies" data-currency="<?php echo e($cuttency); ?>" data-flags="true" data-name="quotation_currency"></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\quotations\create.blade.php ENDPATH**/ ?>