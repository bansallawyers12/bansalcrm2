...
<?php $__env->startSection('title', 'Create Leads'); ?>
...
<div class="main-content">
	<section class="section">
		...
		<form action="<?php echo e(route('admin.leads.store')); ?>" method="POST" name="add-leads" autocomplete="off" enctype="multipart/form-data" novalidate>
			<?php echo csrf_field(); ?>
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-12 col-md-12 col-lg-12">
										<div class="row">
											<div class="col-4 col-md-4 col-lg-4">
												...
												<input type="text" name="first_name" value="<?php echo e(old('first_name')); ?>" class="form-control <?php echo e($errors->has('first_name') ? 'is-invalid' : ''); ?>" data-valid="required" autocomplete="off" placeholder="">
											...
											<div class="col-4 col-md-4 col-lg-4">
												...
												<input type="text" name="last_name" value="<?php echo e(old('last_name')); ?>" class="form-control <?php echo e($errors->has('last_name') ? 'is-invalid' : ''); ?>" data-valid="required" autocomplete="off" placeholder="">
                                            ...
                                            <div class="col-3 col-md-3 col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo Form::text('client_id', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Client ID' )); ?>
									...
									<div class="col-sm-3">
										<div class="form-group">
											...
											<input type="text" name="phone" value="<?php echo e(old('phone')); ?>" class="form-control tel_input contactno_unique <?php echo e($errors->has('phone') ? 'is-invalid' : ''); ?>" data-valid="required" autocomplete="off" placeholder="">
									...
									<div class="col-sm-3">
										...
										<input type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-control email_unique <?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>" data-valid="required email" autocomplete="off" placeholder="">
								...
								<div class="row">
									<div class="col-sm-3">
										<div class="form-group">
											...
											<?php echo Form::text('address', '', array('placeholder'=>"Search Box" , 'id'=>"pac-input" , 'class' => 'form-control controls', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
									...
									<div class="col-sm-3">
										<div class="form-group">
											...
											<?php echo Form::text('city', '', array('id' => 'locality', 'class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
									...
									<div class="col-sm-3">
										<div class="form-group">
											...
											<?php echo Form::text('zip', '', array('id' => 'postal_code', 'class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
								...
								<div class="row" id="internal">
									<div class="col-sm-3">
										...
										<select class="form-control select2 <?php echo e($errors->has('service') ? 'is-invalid' : ''); ?>" name="service" data-valid="required">
									...
									<div class="col-sm-3">
										...
										<select style="padding: 0px 5px;" name="assign_to" id="assign_to" class="form-control select2 <?php echo e($errors->has('assign_to') ? 'is-invalid' : ''); ?>" data-valid="required">
											<?php
									...
									<div class="col-sm-3">
										...
										<select style="padding: 0px 5px;" name="lead_quality" id="lead_quality" class="form-control <?php echo e($errors->has('lead_quality') ? 'is-invalid' : ''); ?>" data-valid="required">
									...
									<div class="col-sm-3">
										...
										<select style="padding: 0px 5px;" name="lead_source" id="lead_source" class="form-control select2 <?php echo e($errors->has('lead_source') ? 'is-invalid' : ''); ?>" data-valid="required">
							...
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									...
									<div class="col-sm-12">
										<div class="form-group float-right">
											<?php echo Form::button('Save', ['class'=>'btn btn-primary btn_submit', 'onClick'=>'customValidate("add-leads")' ]); ?>
...
jQuery(document).ready(function($){
    ...
    $(document).delegate('.email_unique', 'keyup blur', function(){
        ...
        $.ajax({
			type:'post',
            url:"<?php echo e(URL::to('/')); ?>/admin/is_email_unique",
    ...
    $(document).delegate('.contactno_unique', 'keyup blur', function(){
        ...
        $.ajax({
			type:'post',
            url:"<?php echo e(URL::to('/')); ?>/admin/is_contactno_unique",
            headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\leads\create.blade.php ENDPATH**/ ?>