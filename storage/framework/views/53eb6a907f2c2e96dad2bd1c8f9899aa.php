...
<?php $__env->startSection('title', 'Invoice Schedules'); ?>
						...
						<div class="card-body">							
							<ul class="nav nav-pills" id="invoice_tabs" role="tablist">
								<li class="nav-item is_checked_clientn">
									<a class="nav-link active" id="invoiceschedule-tab"  href="<?php echo e(URL::to('/admin/invoice-schedules')); ?>" >Invoice Schedule</a>
								</li> 						
							</ul> 
										...
										<table class="table text_wrap">
											...
											<?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												...
												<tr id="id_<?php echo e(@$list->id); ?>">
													...
													<td style="white-space: initial;"><a href="<?php echo e(URL::to('/admin/clients/detail/')); ?>/<?php echo e(base64_encode(convert_uuencode(@$clientdetail->id))); ?>"><?php echo e(@$clientdetail->first_name); ?> <?php echo e(@$clientdetail->last_name); ?></a><br><?php echo e(@$clientdetail->email); ?></td>
													<td style="white-space: initial;"><?php echo @$productdetail->name.'<br>'.@$partnerdetail->partner_name.'<br>'; ?> <?php echo @$PartnerBranch->name; ?></td>
													<td style="white-space: initial;"><?php echo e(@$application->stage); ?> <br/>(<?php echo e(@$Workflow->name); ?>)</td>
													<td style="white-space: initial;"><?php echo e($list->installment_name); ?></td>
													<td style="white-space: initial;">USD	<?php echo e(number_format($amt,2,'.','')); ?></td>
													<td style="white-space: initial;"><?php echo e(date('d/m/Y', strtotime($list->invoice_sc_date))); ?></td>
													<td></td>
													...
													<td style="text-align:right;">
														<div class="dropdown d-inline">
															...
															<div class="dropdown-menu">
																<a class="dropdown-item openeditform" data-id="<?php echo e($list->id); ?>" href="javascript:;">Edit</a>
																<a onClick="deleteAction(<?php echo e(@$list->id); ?>, 'invoice_schedules')" class="dropdown-item" href="javascript:;">Delete</a>
																<a data-cid="<?php echo e($clientdetail->id); ?>" data-app-id="<?php echo e(@$list->application_id); ?>" data-id="<?php echo e(@$list->id); ?>" class="dropdown-item createinvoice" href="javascript:;">Create Invoice</a>
															</div>
														</div>	
													</td>
												</tr>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content"> 
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/paymentschedule')); ?>" name="invpaymentschedule"  autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
							...
							<div class="form-group">
								...
								<select data-valid="required" class="form-control clientname" id="clientname" name="client_id">
									...
									<?php $__currentLoopData = \App\Models\Admin::where('role',7)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($wlist->id); ?>"><?php echo e($wlist->first_name); ?> <?php echo e($wlist->last_name); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
...
jQuery(document).ready(function($){ 
	...
	$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/application/getapplicationbycid')); ?>',
			type: 'GET',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\invoice\invoiceschedules.blade.php ENDPATH**/ ?>