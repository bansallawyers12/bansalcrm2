				...
				<div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
					<div class="card card-primary">
						...
						<div class="card-body">
							...
							<form action="<?php echo e(URL::to('agent/login')); ?>" method="post" name="admin_login">
...
<?php echo $__env->make('layouts.agent-login', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\auth\agent-login.blade.php ENDPATH**/ ?>