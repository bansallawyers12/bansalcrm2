						...
						<div class="card">							
							<div class="card-body">
								<table>
									<tr>
										<td><b>Invoice:</b></td>
										<td><?php echo e($invoicedetail->invoice_no); ?></td>
									</tr>
									<tr>
										<td><b>Invoice Date:</b></td>
										<td><?php echo e(date('d/m/Y', strtotime($invoicedetail->invoice_date))); ?></td> 
									</tr>
									<tr>
										<td><b>Invoice Due Date:</b></td>
										<td><?php echo e(date('d/m/Y', strtotime($invoicedetail->due_date))); ?></td>
									</tr>
									<tr>
										<td><b>Created By:</b></td>
										<td><?php echo e(@$admindata->first_name); ?></td>
									</tr>
								</table>
							...
							<div class="card-body">
									...
									<table border="1" class="table text_wrap table-striped table-hover table-md vertical_align">
										...
										foreach($invoiceitemdetails as $invoiceitemdetail){
											...
											if($invoicedetail->type == 3){
												...
												<td><?php echo e($invoiceitemdetail->income_type); ?></td>
												<td>
												<span class="currencyinput">$
													<input class="form-control" type="number" name="bonus_amount[]" value="<?php echo e($invoiceitemdetail->bonus_amount); ?>" />
												</span>
												</td>
												<td><span class="percentageinput">$<?php echo e($invoiceitemdetail->total_fee); ?></span></td>
												<td><span class="percentageinput"><?php echo e($invoiceitemdetail->tax); ?>%</span></td>
												<td><span class="percentageinput">$<?php echo e($invoiceitemdetail->tax_amount); ?></span></td>
												<td><span class="percentageinput">$<?php echo e($invoiceitemdetail->netamount); ?></span></td>
											</tr>
												<?php
											}else{
												?>
												...
												<td><?php echo e($invoiceitemdetail->description); ?></td>
												<td><span class="percentageinput">$<?php echo e($invoiceitemdetail->total_fee); ?></span></td>
												<td><span class="percentageinput"><?php echo e($invoiceitemdetail->comm_per); ?>%</span></td>
												<td><span class="percentageinput">$<?php echo e($invoiceitemdetail->comm_amt); ?></span></td>
												<td>
												<span class="currencyinput">$
													<input class="form-control" type="number" name="bonus_amount[]" value="<?php echo e($invoiceitemdetail->bonus_amount); ?>"/>
												</span>
										...
										<div class="col_half col_discount_field">
											<div class="form-group inline_field">
												...
												<span class="percentageinput">$
													<input class="form-control" readonly type="text" id="discount" value="<?php echo e($invoicedetail->discount); ?>" ></span>
											...
											<div class="form-group">
												<div class="field_col">
													<div class="input-group">
														...
														<input type="text" name="" placeholder="" value="<?php echo e(date('d/m/Y', strtotime($invoicedetail->discount_date))); ?>" class=" form-control" />
													</div>
								...
								<?php } ?>
									<div class="col-md-7 cus_col_7">
										...
										if($invoicedetail->type == 2){
											...
											<div class="invoiceNetResult"> 
												...
												<p id="totalFee" class="invoiceNetAmount"><span class="feecurrencyinput">$</span><?php echo e($invoicedetail->net_fee_rec); ?></p>
											</div>
											<?php
									...
									$paymentdetails = \App\Models\InvoicePayment::where('invoice_id', $invoicedetail->id)->orderby('created_at', 'DESC')->get();
										...
										if($invoicedetail->type == 2){
											...
											<div class="inline_field">
												...
												<div class="label_input">
													...
													<input type="text" id="" value="<?php echo e($coom_amt); ?>" readonly="readonly">
													<div class="basic_label">AUD</div>
												</div> 
											</div>
											...
											<div class="inline_field">
												...
												<div class="label_input">
													...
													<input readonly type="text" name="" value="<?php echo e($coom_amt); ?>">
													<div class="basic_label">AUD</div>
												</div>
											</div>
											<div class="inline_field">
												...
												<div class="label_input">
													...
													<input readonly type="text" name="" value="<?php echo e($amount_rec); ?>">
													<div class="basic_label">AUD</div>
												</div>
											</div>
											<?php
										...
										<input readonly type="text" name="" value="<?php echo e($totaldue); ?>">
													<div class="basic_label">AUD</div>
												</div>
											</div>
										</div>
										<?php }
											...
											<div class="inline_field">
												...
												<div class="label_input">
													...
													<input type="text" id="" value="<?php echo e($netamount); ?>" readonly="readonly">
													<div class="basic_label">AUD</div>
												</div> 
											</div>
											...
											<div class="inline_field">
												...
												<div class="label_input">
													...
													<input readonly type="text" name="" value="<?php echo e($netamount); ?>">
													<div class="basic_label">AUD</div>
												</div>
											</div>
											<div class="inline_field">
										...
										<div class="invoiceInformationDiv">
											<div class="inline_field">
												...
												<span class="currencyinput">$</span>
												<div class="label_input">
													<input readonly type="text" name="" value="<?php echo e($total_fee); ?>">
											...
											<div class="inline_field">
												...
												<div class="label_input">
													...
													<input type="text" id="" value="<?php echo e($bonus_amt); ?>" readonly="readonly">
													<div class="basic_label">AUD</div>
												</div> 
											</div>
											...
											<div class="inline_field">
												...
												<div class="label_input">
													...
													<input type="text" name="" value="<?php echo e($feepaid); ?>">
													<div class="basic_label">AUD</div>
												</div>
											</div>
										...
										<div class="payment_detail">
											<table>
												<tr>
													...
													<td><?php echo e($invoicedetail->payment_option); ?></td>
												</tr>
											</table>
								...
								<div class="row">
														...
														<tbody>
															...
															foreach($paymentdetails as $paymentdetail){
																...
																<td><?php echo e(date('d/m/Y', strtotime($paymentdetail->payment_date))); ?></td>
																	<td><?php echo e($clientdata->first_name); ?></td>
																	<td><span class="currencyinput">$<?php echo e($paymentdetail->amount_rec); ?></span></td>
																	<td><?php echo e($paymentdetail->payment_mode); ?></td>
																	<td><!--<a href=""><i class="fa fa-envelope"></i></a>&nbsp;<a href=""><i class="fa fa-inbox"></i></a>--></td>
																	<td><a data-id="<?php echo e($paymentdetail->id); ?>" class="revertpopup btn btn-danger" href="javascript:;">Revert</a></td>
																</tr>
																<?php
															}
															}else{
									...
									<div class="col-lg-4">
										<div class="add_notes" style="margin-bottom:15px;">
											<h4>Add Notes</h4>
											<textarea class="form-control" readonly name="notes"><?php echo e($invoicedetail->notes); ?></textarea>
										</div>
										<div class="attachment">
											<h4>Attachments</h4>
											<div class="invoice_attach_file">
											<?php if(@$invoicedetail->attachments != ''): ?>
												<span><a download href="<?php echo e(asset('img/invoice')); ?>/<?php echo e(@$invoicedetail->attachments); ?>"><?php echo e(@$invoicedetail->attachments); ?></a></span>
												<?php else: ?>
												No Attachment Found
											<?php endif; ?>
										...
										<div class="col-lg-8">
												...
												<div class="income_field">
													<div class="income_col">
														<b><?php echo e(@$IncomeBranch->office_name); ?></b>
													</div>
													<div class="income_col">
														<div class="label_input">
														<span class="currencyinput">$
															<input value="<?php echo e($IncomeSharing->amount); ?>" readonly type="text"  /></span>
															<div class="basic_label">AUD</div>
														</div>
													</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="invoice_btns text-right">
											<a target="_blank" href="<?php echo e(URL::to('admin/invoice/preview/')); ?>/<?php echo e($invoicedetail->id); ?>" class="btn btn-success">Preview & Print</a>
											
											<button class="btn btn-primary addpaymentmodal" >Add Payment</button>
											<a class="btn btn-secondary" href="<?php echo e(URL::to('admin/invoice/edit/')); ?>/<?php echo $invoicedetail->id; ?>">Edit</a>
											
											<button data-id="<?php echo e($invoicedetail->id); ?>" data-rec-name="invoice_<?php echo e($invoicedetail->id); ?>.pdf" data-href="<?php echo e(URL::to('admin/invoice/preview/')); ?>/<?php echo e(@$invoicedetail->id); ?>" data-cus-id="<?php echo e(@$clientdata->id); ?>" data-email="<?php echo e(@$clientdata->email); ?>" data-name="<?php echo e(@$clientdata->first_name); ?> <?php echo e(@$clientdata->last_name); ?>" class="btn btn-primary clientemail">Send</button>
										</div>
									</div>
								</div>
							</div>
...
<div id="addpaymentmodal" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="false" class="modal fade" >
	<div class="modal-dialog">
	<?php echo Form::open(array('url' => 'admin/invoice/payment-store', 'name'=>"invoicepaymentform", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>

	<input type="hidden" value="<?php echo e($invoicedetail->id); ?>" name="invoice_id">
					...
					<div class="invoiceamount">
						<table class="table">
							<tr>
								...
								<td ><span class="percentagenotinput">$</span><?php echo e($netamount); ?> AUD</td>
								<td><b>Total Due:</b><span class="percentagenotinput" style="margin-left: 30px;">$</span></td>
								<td class="totldueamount" data-totaldue="<?php echo e(@$totaldue); ?>"><?php echo e(@$totaldue); ?></td>
								<td>
							</tr>
...
$(document).delegate('.accepteducation', 'click', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to('/admin/')); ?>/invoice/delete-payment',
			type:'GET',
			datatype:'json',
			data:{pay_id:pid},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\invoice\show.blade.php ENDPATH**/ ?>