					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
								...
								<a href="<?php echo e(route('agent.clients.create')); ?>" class="btn btn-primary">Create Client</a>
						...
						<div class="card-body">
							...
							<ul class="nav nav-pills" id="client_tabs" role="tablist">
								...
								<li class="nav-item is_checked_clientn">
									<a class="nav-link active" id="clients-tab"  href="<?php echo e(URL::to('/agent/clients')); ?>" >Clients</a>
								</li>
								<li class="nav-item is_checked_clientn">
									<a class="nav-link" id="archived-tab"  href="<?php echo e(URL::to('/agent/archived')); ?>" >Archived</a>
								</li>
							</ul> 
							<div class="tab-content" id="clientContent">	
							<div class="filter_panel">
								<h4>Search By Details</h4>								
								<form action="<?php echo e(URL::to('/agent/clients')); ?>" method="get">
									<div class="row">
										<div class="col-md-4">
									...
									<div class="row">
										<div class="col-md-12 text-center">
											...
											<a class="btn btn-info" href="<?php echo e(URL::to('/agent/clients')); ?>">Reset</a>
										</div>
									</div>
								</form>
							</div>							
										...
										<table class="table text_wrap">
											...
											<tbody class="tdata">	
												...
												<tr id="id_<?php echo e(@$list->id); ?>"> 
													...
													<td><a href="<?php echo e(URL::to('/agent/clients/detail/'.base64_encode(convert_uuencode(@$list->id)))); ?>"><?php echo e(@$list->first_name == "" ? config('constants.empty') : str_limit(@$list->first_name, '50', '...')); ?> <?php echo e(@$list->last_name == "" ? config('constants.empty') : str_limit(@$list->last_name, '50', '...')); ?></a><br/><?php echo e(@$list->email == "" ? config('constants.empty') : str_limit(@$list->email, '50', '...')); ?></td> 
													...
													<td><?php echo e(@$list->client_id == "" ? config('constants.empty') : str_limit(@$list->client_id, '50', '...')); ?></td> 
													...
													?>
													<td><?php echo e(@$assignee->first_name == "" ? config('constants.empty') : str_limit(@$assignee->first_name, '50', '...')); ?></td> 
													<td><?php echo e(rtrim(@$followerss,', ')); ?></td> 
													<td><span class="ag-label--circular" style="color: #6777ef" >
														In Progress
													</span></td>
													<td> - </td>
													<td><?php echo e(date('Y-m-d', strtotime($list->created_at))); ?></td>
													<td><?php echo e(@$list->preferredIntake == "" ? config('constants.empty') : str_limit(@$list->preferredIntake, '50', '...')); ?></td>  	
													<td>
														<div class="dropdown d-inline">
															<button class="btn btn-primary dropdown-toggle" type="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
															<div class="dropdown-menu">
																
																<a class="dropdown-item has-icon" href="<?php echo e(URL::to('/agent/clients/edit/'.base64_encode(convert_uuencode(@$list->id)))); ?>"><i class="far fa-edit"></i> Edit</a>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" name="sendmail" action="<?php echo e(URL::to('/agent/sendmail')); ?>" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
					<div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.agent', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Agent\clients\index.blade.php ENDPATH**/ ?>