...
<div class="modal fade add_represent_partner custom_modal" tabindex="-1" role="dialog" aria-labelledby="partnerModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content"> 
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/agents/savepartner')); ?>" name="partnerform" id="addpartnerform" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
					<div class="row">
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<select data-valid="required" class="form-control partner select2" id="represent_partner" name="represent_partner">
									...
									<?php $__currentLoopData = \App\Models\Partner::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $replist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($replist->id); ?>"><?php echo e($replist->partner_name); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
...
</div><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\agents\addagentmodal.blade.php ENDPATH**/ ?>