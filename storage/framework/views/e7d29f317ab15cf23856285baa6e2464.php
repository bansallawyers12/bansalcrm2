					...
					<div class="card">
						...
						<div class="card-body">
						    ...
						    <div class="filter_panel">
								...
								<form action="<?php echo e(URL::to('/admin/applications-overdue')); ?>" method="get">
									<div class="row">
										<div class="col-md-4">
									...
									<div class="row">
										<div class="col-md-12 text-center">
											...
											<a class="btn btn-info" href="<?php echo e(URL::to('/admin/applications-overdue')); ?>">Reset</a>
										</div>
									</div>
								</form>
							</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\applications\overdue.blade.php ENDPATH**/ ?>