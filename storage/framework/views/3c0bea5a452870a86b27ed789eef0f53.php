...
<div class="main-content">
	...
	<form method="POST" action="<?php echo e(url('admin/invoice/general-store')); ?>" name="invoiceform" autocomplete="off" enctype="multipart/form-data">
	<?php echo csrf_field(); ?>
						...
						<div class="card">							
							<div class="card-body">
								<div class="form-group"> 
									...
									<?php echo Form::date('invoice_date', date('Y-m-d'), array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>
								...
								<div class="form-group"> 
									...
									<?php echo Form::date('invoice_due_date', date('Y-m-d'), array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>
												...
												<td>
													<select name="tax_code[]" class="form-control tax_per">
														...
														<?php $__currentLoopData = \App\Models\Tax::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<option value="<?php echo e($taxlist->amount); ?>" <?php if($taxlist->amount=='10'): ?><?php echo e('selected'); ?><?php endif; ?>><?php echo e($taxlist->name); ?></option>
														<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
													</select>
												</td>
												<td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\invoice\general-invoice.blade.php ENDPATH**/ ?>