...
<div class="modal fade add_appointment custom_modal" id="create_appoint" tabindex="-1" role="dialog" aria-labelledby="create_interestModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/add-appointment')); ?>" name="appointform" id="appointform" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
					<div class="row">
						<div class="col-12 col-md-6 col-lg-6">
...
<div class="modal fade custom_modal" id="add_academic_requirement" tabindex="-1" role="dialog" aria-labelledby="academiModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/saveacademic')); ?>" name="saveacademic" id="saveacademic" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
...
<div class="modal-dialog modal-lg">
	<div class="modal-content">
		...
		<div class="modal-body">
			<form method="post" action="<?php echo e(URL::to('/admin/saveotherinfo')); ?>" name="savesubjectarea" id="savesubjectarea" autocomplete="off" enctype="multipart/form-data">
			<?php echo csrf_field(); ?> 
			<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
...
<div class="modal-dialog modal-lg">
	<div class="modal-content">
		...
		<div class="modal-body">
			<form method="post" action="<?php echo e(URL::to('/admin/saveotherinfo')); ?>" name="editsubjectarea" id="editsubjectarea" autocomplete="off" enctype="multipart/form-data">
			<?php echo csrf_field(); ?> 
			<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
...
<div id="addpaymentmodal" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="false" class="modal fade" >
	<div class="modal-dialog">
		<form action="<?php echo e(url('admin/invoice/payment-store')); ?>" method="POST" name="ajaxinvoicepaymentform" autocomplete="off" enctype="multipart/form-data" id="ajaxinvoicepaymentform">
			<?php echo csrf_field(); ?>
											...
											<div class="form-group">
												<select class="form-control select2" name="fee_type" data-valid="required">
													<option value="">Select Fee Type</option>
														<?php $__currentLoopData = \App\Models\FeeType::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feetypes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option <?php if($feetypes->name == 'Tution fees'): ?> selected <?php endif; ?> value="<?php echo e($feetypes->name); ?>"><?php echo e($feetypes->name); ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												</select>
											</div>
										</div>
...
<div class="modal fade custom_modal" id="new_fee_option" tabindex="-1" role="dialog" aria-labelledby="feeoptionModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/savefee')); ?>" name="feeform" id="feeform" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="product_id" value="<?php echo e($fetchedData->id); ?>">
					<div class="row">
						<div class="col-12 col-md-4 col-lg-4">
							<div class="form-group">
								<label for="fee_option_name">Fee Option Name <span class="span_req">*</span></label> 	
								<?php echo Form::text('fee_option_name', '', array('class' => 'form-control selectedappsubject', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Fee Option Name' )); ?>
...
</div> <?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\products\addproductmodal.blade.php ENDPATH**/ ?>