...
<html lang="en">
	<head>
		...
		<!-- Font Awesome -->
	  <link rel="stylesheet" href="<?php echo e(URL::asset('icons/font-awesome/css/all.min.css')); ?>">
	  <!-- Ionicons -->
	  ...
	  <link rel="stylesheet" href="<?php echo e(URL::asset('css/select2-bootstrap4.min.css')); ?>">
	  <!-- Theme style -->
	  <link rel="stylesheet" href="<?php echo e(URL::asset('css/admintheme.min.css')); ?>">
	  <!-- overlayScrollbars -->
	  ...
	  <!--<link rel="stylesheet" href="<?php echo e(URL::asset('css/niceCountryInput.css')); ?>">-->
	...
	<body class="hold-transition sidebar-mini layout-fixed loderover">
		...
		<div class="modal fade" id="leadsearch_modal">
			<div class="modal-dialog modal-lg">
			  <div class="modal-content">
				...
				<form action="<?php echo e(route('admin.leads.index')); ?>" method="get">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<?php echo Form::text('lead_id', Request::get('lead_id'), array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Lead ID', 'id' => 'lead_id' )); ?>	 						
										<?php if($errors->has('lead_id')): ?>
											<span class="custom-error" role="alert">
												<strong><?php echo e(@$errors->first('lead_id')); ?></strong>
											</span> 
										<?php endif; ?>
								   </div>	
								</div>
							...
							<div class="col-md-6">
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<?php echo Form::text('followupdate', Request::get('followupdate'), array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Followup Date', 'id' => 'followupdate' )); ?>	 						
										<?php if($errors->has('followupdate')): ?>
											<span class="custom-error" role="alert">
												<strong><?php echo e(@$errors->first('followupdate')); ?></strong>
											</span> 
										<?php endif; ?>
								   </div>	
								</div>
				...
				<div class="modal-footer justify-content-between">
				  <a href="<?php echo e(route('admin.leads.index')); ?>" class="btn btn-default" >Reset</a>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<?php echo Form::text('subject', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Subject', 'id' => 'subject' )); ?>	 						
								...
								<div class="form-group">
									...
									<?php echo Form::text('how_help_you', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'How can we help you today?', 'id' => 'how_help_you' )); ?>	 						
									<?php if($errors->has('how_help_you')): ?>
										<span class="custom-error" role="alert">
											<strong><?php echo e(@$errors->first('how_help_you')); ?></strong>
										</span> 
									<?php endif; ?>
								</div>
								<div class="form-group">
									...
									<?php if($errors->has('attach_file')): ?>
										<span class="custom-error" role="alert">
											<strong><?php echo e(@$errors->first('attach_file')); ?></strong>
										</span> 
									<?php endif; ?>
								</div>
								<div class="form-group">
									<label for="contact_no" class="col-form-label">Contact Number</label>
									<?php echo Form::text('contact_no', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Contact Number', 'id' => 'contact_no' )); ?>	 						
								...
								<div class="form-group">
									...
									<?php if($errors->has('critical_request')): ?>
										<span class="custom-error" role="alert">
											<strong><?php echo e(@$errors->first('critical_request')); ?></strong>
										</span> 
									<?php endif; ?>
								</div>
							</div>
		...
		<!-- Select2 -->		
		<!--<script src="<?php echo e(URL::asset('js/select2.full.min.js')); ?>"></script>	-->
		<!-- Select2 -->		
		<script src="<?php echo e(URL::asset('js/select2.min.js')); ?>"></script>			
		<!-- daterangepicker -->
		
		<!-- TinyMCE -->
		<script src="<?php echo e(URL::asset('assets/tinymce/js/tinymce/tinymce.min.js')); ?>"></script>
		<script src="<?php echo e(URL::asset('js/tinymce-init.js')); ?>"></script>
		<script src="<?php echo e(URL::asset('js/tinymce-summernote-compat.js')); ?>"></script>
		
		<!-- Admin Theme App -->
		<script src="<?php echo e(URL::asset('js/admintheme.min.js')); ?>"></script>
		
		<!-- Admin Theme dashboard demo (This is only for demo purposes) -->
	
		
		<script src="<?php echo e(URL::asset('js/custom-form-validation.js')); ?>"></script>
...
</html> <?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\layouts\adminnew.blade.php ENDPATH**/ ?>