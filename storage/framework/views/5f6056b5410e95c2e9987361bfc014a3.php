...
<div class="main-content">
	<section class="section">
		...
		<div class="section-body">
			<form action="<?php echo e(url('admin/clients/edit')); ?>" method="POST" name="edit-clients" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				<input type="hidden" name="id" value="<?php echo e(@$fetchedData->id); ?>">
				<input type="hidden" name="type" value="<?php echo e(@$fetchedData->type); ?>"> 
				<div class="row">   
							...
							<div class="card-body">
								<div class="row">
										...
										<div class="row">
											...
											<div class="col-3 col-md-3 col-lg-3">
												<div class="form-group"> 
													...
													<?php echo Form::text('client_id', @$fetchedData->client_id, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off', 'id' => 'checkclientid', 'placeholder'=>'' ,'readonly' => 'readonly' )); ?>
                                                ...
                                                <div class="row" id="metatag2_<?php echo e($iii); ?>">
                                                    <div class="col-4 col-md-4 col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="contact_type[]" id="contact_type" class="form-control">
                                                                ...
                                                                <option value="Personal" <?php if(@$clientphone->contact_type == "Personal"): ?> selected <?php endif; ?>>Personal</option>
                                                                <option value="Business" <?php if(@$clientphone->contact_type == "Business"): ?> selected <?php endif; ?>>Business</option>
                                                                <option value="Secondary" <?php if(@$clientphone->contact_type == "Secondary"): ?> selected <?php endif; ?>>Secondary</option>
                                                                <option value="Father" <?php if(@$clientphone->contact_type == "Father"): ?> selected <?php endif; ?>>Father</option>
                                                                <option value="Mother" <?php if(@$clientphone->contact_type == "Mother"): ?> selected <?php endif; ?>>Mother</option>
                                                                <option value="Brother" <?php if(@$clientphone->contact_type == "Brother"): ?> selected <?php endif; ?>>Brother</option>
                                                                <option value="Sister" <?php if(@$clientphone->contact_type == "Sister"): ?> selected <?php endif; ?>>Sister</option>
                                                                <option value="Uncle" <?php if(@$clientphone->contact_type == "Uncle"): ?> selected <?php endif; ?>>Uncle</option>
                                                                <option value="Aunt" <?php if(@$clientphone->contact_type == "Aunt"): ?> selected <?php endif; ?>>Aunt</option>
                                                                <option value="Cousin" <?php if(@$clientphone->contact_type == "Cousin"): ?> selected <?php endif; ?>>Cousin</option>
                                                                <option value="Others" <?php if(@$clientphone->contact_type == "Others"): ?> selected <?php endif; ?>>Others</option>
                                                                <option value="Partner" <?php if(@$clientphone->contact_type == "Partner"): ?> selected <?php endif; ?>>Partner</option>
                                                                <option value="Not In Use" <?php if(@$clientphone->contact_type == "Not In Use"): ?> selected <?php endif; ?>>Not In Use</option>
                                                            </select>
                                                    ...
                                                    <div class="col-6 col-md-6 col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="cus_field_input">
                                                                ...
                                                                <?php echo Form::text('client_phone[]', $clientphone->client_phone, array('class' => 'form-control tel_input', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Phone',  isset($clientphone->contact_type) && $clientphone->contact_type == "Personal" ? 'readonly' : '' )); ?>

                                                            </div>
                                                        </div>
                                                        <input autocomplete="off" placeholder="" name="clientphoneid[]" type="hidden" value="<?php echo e($clientphone->id); ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-2 col-md-2 col-lg-2">
                                                        <div class="form-group" style="margin-top: 38px;">
                                                            <a href="javascript:;" dataid="<?php echo e($iii); ?>" contactid="<?php echo e($clientphone->id); ?>" class="deletecontact"><i class="fa fa-times"></i></a>
                                                        </div>
                                                    </div>
                                                    <?php
                                                    }?>
                                   ...
                                   <div class="col-12 col-md-12 col-lg-12">
    								...
    								<?php echo Form::text('visa_opt', $fetchedData->visa_opt, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Visa' )); ?>
									...
									?>	
								<?php if($fetchedData->visa_type!="Citizen" && $fetchedData->visa_type!="PR"): ?>
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<div class="input-group">
												...
												<?php echo Form::text('visaExpiry', $visa_expiry_date, array('class' => 'form-control dobdatepicker', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<?php echo Form::text('passport_number', @$fetchedData->passport_number, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
								...
								<div class="row">
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<?php echo Form::text('address', @$fetchedData->address, array('placeholder'=>"Search Box" , 'id'=>"pac-input" , 'class' => 'form-control controls', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<?php echo Form::text('city', @$fetchedData->city, array('id' => 'locality', 'class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<?php echo Form::text('zip', @$fetchedData->zip, array('id' => 'postal_code', 'class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
								...
								<div class="row " id="internal">
									...
									<div class="col-sm-3">
										<div class="form-group">
                                            ...
                                            ?>
                                                <option <?php if($assigneeVal == $admin->id): ?> selected <?php endif; ?> value="<?php echo $admin->id; ?>"><?php echo $admin->first_name.' '.$admin->last_name.' ('.@$branchname->office_name.')'; ?></option>
                                            <?php
                                                    }
                                                }
                                            }
                                            else
                                            {
                                                ...
                                                foreach($admins as $admin){
                                                    $branchname = \App\Models\Branch::where('id',$admin->office_id)->first();
                                                ?>
                                                <option <?php if($fetchedData->assignee == $admin->id): ?> selected <?php endif; ?> value="<?php echo $admin->id; ?>"><?php echo $admin->first_name.' '.$admin->last_name.' ('.@$branchname->office_name.')'; ?></option>
                                            <?php
                                                }
                                            } ?>
									...
									<div class="col-sm-3">
										<div class="form-group">
											...
											<select style="padding: 0px 5px;" name="source" id="lead_source" class="form-control select2" data-valid="">
												...
												<option value="Sub Agent" <?php if(@$fetchedData->source == 'Sub Agent'): ?> selected <?php endif; ?>>Sub Agent</option>
												<?php $__currentLoopData = \App\Models\Source::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sources): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<option value="<?php echo e($sources->name); ?>" <?php if(@$fetchedData->source == $sources->name): ?> selected <?php endif; ?>><?php echo e($sources->name); ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</select>
										...
										<div class="form-group"> 
											...
											<select class="form-control select2" name="subagent">  
												...
												<?php $__currentLoopData = \App\Models\Agent::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agentlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<option <?php if(@$fetchedData->agent_id == $agentlist->id){ echo 'selected'; } ?> value="<?php echo e($agentlist->id); ?>"><?php echo e($agentlist->full_name); ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</select>
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<!--<select multiple class="form-control select2" name="tagname[]">
												...
												?>
										<!--<option <?php //if(in_array($tags->id, $explodee)){ echo 'selected'; } ?>  value=""></option>-->
												<?php
												//}
												?>	 
											<!--</select>-->
                                     ...
                                     <div class="col-sm-6">
										<div class="form-group">
                                            ...
                                            <span class="text-muted">
                                                <a href="javascript:;" data-id="<?php echo e($fetchedData->id); ?>" class="btn btn-primary serviceTaken btn-sm"><i class="fa fa-plus"></i> Add</a>
                                            </span>
                                        </div>
									...
									<div class="col-sm-12">
										<div class="form-group float-right">
											...
											<?php echo Form::button('Save', ['class'=>'btn btn-primary', 'onClick'=>'customValidate("edit-clients")' ]); ?>
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<div class="cus_field_input">
									...
									<?php echo Form::text('client_phone', '', array('class' => 'form-control tel_input', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Phone' )); ?>
...
jQuery(document).ready(function($){
	...
	$(document).delegate('.service_taken_edit','click', function(){
        ...
        $.ajax({
			url: '<?php echo e(URL::to('/admin/client/getservicetaken')); ?>',
			headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
			type:'POST',
			datatype:'json',
    ...
    $('#createservicetaken').submit(function(event) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(URL::to('/admin/client/createservicetaken')); ?>",
            data: formData,
            dataType: 'json',
            success: function(response) {
	...
	$(document).delegate('.service_taken_trash', 'click', function(e){
	    ...
	    if(conf){
            var sel_service_taken_id = $(this).attr('id');
            $.ajax({
                url: '<?php echo e(URL::to('/admin/client/removeservicetaken')); ?>',
                headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:'POST',
                datatype:'json',
                data:{sel_service_taken_id:sel_service_taken_id},
   ...
   $('.manual_email_phone_verified').on('click', function(){
        ...
        if(client_email != '' && client_id != ""){
            $.ajax({
                url: '<?php echo e(URL::to('email-verify')); ?>',
                type:'POST',
    ...
    $('#sendCodeBtn').click(function() {
        ...
        $.post('<?php echo e(route("verify.send-code")); ?>', {
    ...
    $('#verifyCodeBtn').click(function() {
        ...
        $.post('<?php echo e(route("verify.check-code")); ?>', {
            phone_number: phoneNumber,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views/Admin/clients/edit.blade.php ENDPATH**/ ?>