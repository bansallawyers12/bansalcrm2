...
<div class="card-header-action" style="padding-bottom:15px;">
	...
	<div class="float-right">
		<div class="application_btns">
			<a target="_blank" href="<?php echo e(URL::to('/admin/application/export/pdf/')); ?>/<?php echo e($fetchData->id); ?>" class="btn btn-primary"><i class="fa fa-print"></i></a>
          
			<a style="<?php if($fetchData->status == 2 || $fetchData->status == 1 || $fetchData->status == 8){ echo 'display:none;'; } ?>" href="javascript:;" data-id="<?php echo e($fetchData->id); ?>" class="btn btn-outline-danger discon_application ifdiscont"><i class="fa fa-times"></i> Discontinue</a>

            <a style="<?php if($fetchData->status == 2 || $fetchData->status == 1 || $fetchData->status == 8){ echo 'display:none;'; } ?>" href="javascript:;" data-id="<?php echo e($fetchData->id); ?>" class="btn btn-outline-danger refund_application ifdiscont"><i class="fa fa-undo"></i> Refund</a>
			...
			?>
			<a href="javascript:;" style="<?php if($fetchData->status == 2 || $fetchData->status == 1 || $fetchData->status == 8){ echo 'display:none;'; } ?>" data-stage="<?php echo e($fetchData->stage); ?>" data-id="<?php echo e($fetchData->id); ?>" class="btn btn-outline-primary backstage ifdiscont"><i class="fa fa-angle-left"></i> Back to Previous Stage</a>

			<a href="javascript:;" style="<?php if($fetchData->status == 2){ echo 'display:none;'; } ?> <?php if($displayback){  }else{ echo 'display:none;'; } ?>" data-stage="<?php echo e($fetchData->stage); ?>" data-id="<?php echo e($fetchData->id); ?>" class="btn btn-success completestage ifdiscont">Complete Application</a>
			<a href="javascript:;" style="<?php if($displayback || $fetchData->status == 2 || $fetchData->status == 8){ echo 'display:none;'; } ?>" data-stage="<?php echo e($fetchData->stage); ?>" data-id="<?php echo e($fetchData->id); ?>" class="btn btn-success nextstage ifdiscont">Proceed to Next Stage <i class="fa fa-angle-right"></i></a>

			<a href="javascript:;" style="<?php if($fetchData->status == 1 || $fetchData->status == 2){ echo ''; }else{ echo 'display:none;'; } ?>"  data-id="<?php echo e($fetchData->id); ?>" class="btn btn-success revertapp">Revert <i class="fa fa-angle-right"></i></a>
...
<div class="application_grid_col">
	<div class="grid_column">
		<span>Course:</span>
		<p><?php echo e(@$productdetail->name); ?></p>
	</div>
	<div class="grid_column">
		<span>School:</span>
	...
	<div class="grid_column">
		<span>Workflow:</span>
		<p><?php echo e(@$workflow->name); ?></p>
	</div>
	<div class="grid_column">
		<span>Current Stage:</span>
		<p class="text-success curerentstage" style="font-weight: 600;font-size: 14px;"><?php echo e(@$fetchData->stage); ?></p>
	</div>
	<div class="grid_column">
		<span>Application Id:</span>
		<p><?php echo e($fetchData->id); ?></p>
	</div>
	<!--<div class="grid_column">
	...
	<div class="grid_column">
		...
		<p><?php echo e(date('Y-m-d', strtotime($fetchData->created_at))); ?></p>
	</div>
	<div class="grid_column">
		<span>Last Updated:</span>
		<p><?php echo e(date('Y-m-d', strtotime($fetchData->updated_at))); ?></p>
	</div>
	<div class="grid_column">
		<div class="overall_progress">
			...
			?>
			 <div id="progresscir" class="progress-circle over_<?php echo e($over); ?> prgs_<?php echo e($width); ?>">
			   <span><?php echo e($width); ?> %</span>
	...
	<div class="col-md-9">
		<div class="application_other_info">
			<ul class="nav nav-pills" id="applicat_detail_tabs" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link" id="notes-tab" data-id="<?php echo e($fetchData->id); ?>" data-toggle="tab"  href="#notes">Notes</a>
				</li>
				<!--<li class="nav-item">
			...
			<div class="tab-content" id="applicationContent">
							...
							<div class="accordion-header collapsed <?php echo $stage1; ?> <?php if($fetchData->stage == $stages->name && $fetchData->status != 1){ echo  'app_blue'; }  ?>" role="button" data-toggle="collapse" data-target="#<?php echo $stagname; ?>_accor" aria-expanded="false">
								...
								<div class="accord_hover">
                                   ...
                                   <a data-course="<?php echo $productdetail->name; ?>" data-school="<?php echo $partnerdetail->partner_name; ?>" data-app-type="<?php echo $stages->name; ?>" title="Actions" class="openappaction" data-id="<?php echo $fetchData->id; ?>" href="javascript:;"><i class="fa fa-calendar"></i></a>
									...
									<a data-app-type="<?php echo $stages->name; ?>" title="Email" data-id="<?php echo e(@$fetchData->id); ?>" data-email="<?php echo e(@$fetchedData->email); ?>" data-name="<?php echo e(@$fetchedData->first_name); ?> <?php echo e(@$fetchedData->last_name); ?>" class="openclientemail" title="Compose Mail" href="javascript:;"><i class="fa fa-envelope"></i></a>
								</div>
							</div>
							<?php
								...
								?>
									<div class="activity_col">
										<div class="activity_txt_time">
											<span class="span_txt"><b><?php echo e($admin->first_name); ?></b> <?php echo $applicationlist->comment; ?></span>
				...
				<div class="tab-pane fade" id="documents" role="tabpanel" aria-labelledby="documents-tab">
					...
					$stagesquery = \App\Models\WorkflowStage::where('w_id', $fetchData->workflow)->get();
					?>
						<h4>Document Checklist (<span class="checklistuploadcount"><?php echo e(@$applicationuploadcount[0]->cnt); ?></span>/<span class="checklistcount"><?php echo e(@$applicationdocumentco); ?></span>)</h4>
							...
							<div class="col-md-5">
								<div class="checklist">
										...
										?>
												...
												<table class="table">
													<tbody>
														...
														<tr>
															...
															<td><?php echo e(@$applicationdocument->document_type); ?></td>
															<td><div class="circular-box cursor-pointer"><button class="transparent-button paddingNone"><?php echo e(@$appcount); ?></button></div></td>
															<td><a data-aid="<?php echo e($fetchData->id); ?>" data-typename="<?php echo $stages->name; ?>" data-type="<?php echo $name; ?>" data-id="<?php echo e($applicationdocument->id); ?>" class="openfileupload" href="javascript:;"><i class="fa fa-plus"></i></a></td>
														</tr>
														<?php } ?>
													</tbody>
											...
											<a class="openchecklist" data-id="<?php echo e($fetchData->id); ?>" data-typename="<?php echo $stages->name; ?>" data-type="<?php echo $name; ?>" href="javascript:;"><i class="fa fa-plus"></i> Add New Checklist</a></li>
										<?php } ?>
									...
									<td>
										...
										<div class="dropdown d-inline">
											...
											<div class="dropdown-menu">
												...
												<!--<a target="_blank" class="dropdown-item" href="/<?php //echo $doclist->file_name; ?>">Preview</a>
												<a data-id="" class="dropdown-item deletenote" data-href="deleteapplicationdocs" href="javascript:;">Delete</a>
												<a download class="dropdown-item" href="/<?php //echo $doclist->file_name; ?>">Download</a>-->

                                                <a target="_blank" class="dropdown-item" href="<?php echo $doclist->myfile; ?>">Preview</a>
                                                <a data-id="<?php echo e($doclist->id); ?>" class="dropdown-item deletenote" data-href="deleteapplicationdocs" href="javascript:;">Delete</a>
                                                <a download class="dropdown-item" href="<?php echo $doclist->myfile; ?>">Download</a>

												<?php
												if($doclist->status == 0){
												?>
												<a data-id="<?php echo e($doclist->id); ?>" href="javascript:;" class="dropdown-item publishdoc"  >Publish Document</a>
												<?php }else{ ?>
												<a data-id="<?php echo e($doclist->id); ?>" href="javascript:;" class="dropdown-item unpublishdoc"  >Unpublish Document</a>
												<?php } ?>
											</div>
										</div>								  
									</td>
				...
				<div class="tab-pane fade" id="paymentschedule" role="tabpanel" aria-labelledby="paymentschedule-tab">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="schedule_btns">
								<a class="openpaymentschedule btn btn-primary" data-id="<?php echo e($fetchData->id); ?>" href="javascript:;" ><i class="fa fa-plus"></i> Add Schedule</a>
								<div class="dropdown d-inline">
									...
									<div class="dropdown-menu">
										...
										<a target="_blank" class="dropdown-item" href="<?php echo e(URL::to('/admin/applications/preview-schedules/')); ?>/<?php echo e($fetchData->id); ?>">Preview Schedule</a>
									</div> 
								</div>
							</div>
						</div>
					...
					<div class="table-responsive"> 
						<table class="table text_wrap">
							...
							?>
								<tr id="<?php echo e(@$invoiceschedule->id); ?>">
									<td><?php echo e(@$invoiceschedule->id); ?></td> 
									<td >
										<div style="flex-direction: column;display: flex;">
										<span style="line-height: 23px;" class="text-info"><?php echo e(@$invoiceschedule->installment_name); ?></span>
										<span style="line-height: 16px;" class=""><?php echo e(@$invoiceschedule->installment_date); ?></span>
									...
									foreach($scheduleitem as $scheduleite){
										?>
										<span style="line-height: 23px;" class=""><?php echo e(@$scheduleite->fee_type); ?></span>
										<?php
									}
									?>
									</div>
									...
									foreach($scheduleitem as $scheduleite){
										...
										?>
										<span style="line-height: 23px;" class=""><?php echo e(@$scheduleite->fee_amount); ?></span>
										<?php
									}
									?>
									</div>
									</td>
									<td><?php echo e($totlfee); ?></td>
									<td><?php echo e(@$invoiceschedule->discount); ?></td>
									<td>-</td>
									...
									<td>
										<div class="dropdown d-inline">
											<button class="btn btn-primary dropdown-toggle" type="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
											<div class="dropdown-menu">
												<a class="dropdown-item editpaymentschedule" data-id="<?php echo e($invoiceschedule->id); ?>" href="javascript:;">Edit</a>
												<a class="dropdown-item deletenote" data-id="<?php echo e($invoiceschedule->id); ?>" data-href="deletepaymentschedule" href="javascript:;" >Delete</a>
	...
	<div class="col-md-3">
		<div class="cus_sidebar">
			<div class="form-group">
				...
				<?php echo Form::text('applied_intake', $fetchData->intakedate, array('class' => 'form-control datepicker', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>

				<span class="span_note">Date must be in YYYY-MM-DD (2012-12-22) format.</span>
				<?php if($errors->has('applied_intake')): ?>
					<span class="custom-error" role="alert">
						<strong><?php echo e(@$errors->first('applied_intake')); ?></strong>
					</span> 
				<?php endif; ?> 
			</div>
			...
			<div class="app_date_sec">
				<div class="app_start_date common_apply_date">
					...
					<div class="date_col">
						...
						<input type="text" value="<?php echo e(@$fetchData->start_date); ?>" class="startdatepicker" />
						<div class="apply_val">
				...
				<div class="app_end_date common_apply_date">
					...
					<div class="date_col">
						...
						<input type="text" value="<?php echo e(@$fetchData->end_date); ?>" class="enddatepicker" />
						<div class="apply_val">
			...
			?>
				<a style="<?php if($invoiceschedule){ echo 'display:none;'; } ?>" href="javascript:;" data-id="<?php echo e($fetchData->id); ?>"  class="btn btn-outline-primary openpaymentschedule"><i class="fa fa-plus"></i> Setup Payment Schedule</a>
			</div>
          
          	<div class="divider"></div>
            <input type="text" name="student_id" data-applicationid="<?php echo e($fetchData->id); ?>" id="student_id" value="<?php echo e($fetchData->student_id); ?>" placeholder="Enter Student Id" style="width: 132px;">
            
			<div class="divider"></div>
			
			<div class="cus_prod_fees">
				<h5>Product Fees <span>AUD</span></h5>
				<a href="javascript:;" data-id="<?php echo e($fetchData->id); ?>" data-partnerid="<?php echo e($fetchData->partner_id); ?>" class="openpaymentfee"><i class="fa fa-edit"></i></a>
				<div class="clearfix"></div>
			</div>
			<!--<p class="clearfix"> 
				<span class="float-left">Total Fee</span>
				<span class="float-right text-muted product_totalfee"></span>
			</p>
            <p class="clearfix">
				<span class="float-left">Commission</span>
				<span class="float-right text-muted product_totalcommission"></span>
			</p>
			<p class="clearfix" style="color:#ff0000;"> 
				<span class="float-left">Discount</span>
				<span class="float-right text-muted product_discount"></span>
			</p>
			<p class="clearfix" style="color:#6777ef;"> 
				<span class="float-left">Net Fee</span>
				<span class="float-right text-muted product_net_fee"></span>
			</p>-->
			...
			?>
				<!--<a href="javascript:;" data-id="<?php echo e($fetchData->id); ?>" data-client_revenue="<?php echo e($client_revenue); ?>" data-partner_revenue="<?php echo e($partner_revenue); ?>" data-discounts="<?php echo e($discounts); ?>" class="opensaleforcast"><i class="fa fa-edit"></i></a>-->
              
              <a href="javascript:;" data-id="<?php echo e($fetchData->id); ?>" class="openpaymentfeeLatest"><i class="fa fa-edit"></i></a>
			...
			<!--<p class="clearfix appsaleforcast"> 
				...
				<span class="float-right text-muted partner_revenue"></span>
			</p>
			<p class="clearfix appsaleforcast"> 
				<span class="float-left">Client Revenue</span>
				<span class="float-right text-muted client_revenue"></span>
			</p>
			<p class="clearfix appsaleforcast" style="color:#ff0000;"> 
				<span class="float-left">Discount</span>
				<span class="float-right text-muted discounts"></span>
			</p>
			<p class="clearfix appsaleforcast" style="color:#6777ef;"> 
				<span class="float-left">Net Revenue</span>
				<span class="float-right text-muted netrevenue"></span>
			</p>-->
          
			<div class="form-group">
				<label for="expect_win_date">Expected Win Date:</label>
				<?php echo Form::text('expect_win_date', $fetchData->expect_win_date, array('class' => 'form-control expectdatepicker', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>

				<span class="span_note">Date must be in YYYY-MM-DD (2012-12-22) format.</span>
				<?php if($errors->has('expect_win_date')): ?>
					<span class="custom-error" role="alert">
						<strong><?php echo e(@$errors->first('expect_win_date')); ?></strong>
					</span> 
				<?php endif; ?> 
			</div>
			<?php
			...
			?>
				<a href="javascript:;" data-ration="<?php echo e($ratio); ?>" data-name="<?php echo e($admin->first_name); ?>" data-id="<?php echo e($fetchData->id); ?>" class="btn btn-primary application_ownership">View Appliation Ownership Ratio</a>
			</div>
			...
			<div class="client_added client_info_tags"> 
				...
				<div class="client_info">
					<div class="cl_logo"><?php echo e(substr($admin->first_name, 0, 1)); ?></div>
					<div class="cl_name">
						<span class="name"><?php echo e($admin->first_name); ?></span>
						<span class="email"><?php echo e($admin->email); ?></span>
					</div>
				</div> 
			</div>
			...
			<p class="clearfix"> 
				...
				<span class="float-right text-muted">
					<a href="javascript:;" data-id="<?php echo e($fetchData->id); ?>" class="btn btn-primary btn-sm opensuperagent"><i class="fa fa-plus"></i> Add</a>
					<?php
					...
					<div class="supagent_data">
						<div class="client_info">
							...
							<div class="cl_del" style="display: inline-block;">
								<a href="javascript:;" data-href="superagent" data-id="<?php echo e($fetchData->id); ?>"  class="deletenote"><i class="fa fa-times"></i></a>
							</div>
						</div>
					</div>
					<?php } ?>
			...
			<p class="clearfix"> 
				...
				<span class="float-right text-muted">
					<a href="javascript:;" data-id="<?php echo e($fetchData->id); ?>" class="btn btn-primary btn-sm opensubagent"><i class="fa fa-plus"></i> Add</a>
					...
					<div class="client_info">
							...
							<div class="cl_del" style="display: inline-block;">
								<a href="javascript:;" data-href="subagent" data-id="<?php echo e($fetchData->id); ?>"  class="deletenote"><i class="fa fa-times"></i></a>
							</div>
						</div>
					<?php } ?>
					</div>
...
<?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\clients\applicationdetail.blade.php ENDPATH**/ ?>