					...
					<div class="card">
						...
						<div class="card-body">
							<ul class="nav nav-pills" id="client_tabs" role="tablist">
								...
								<li class="nav-item ">
									<a class="nav-link active" id="archived-tab"  href="<?php echo e(URL::to('/admin/archived')); ?>" >Archived</a>
								</li>
							</ul> 
										...
										<table class="table text_wrap">
											...
											<tbody class="tdata">
												...
												<tr id="id_<?php echo e($list->id); ?>">
													...
													<td style="white-space: initial;"><?php echo e(@$list->city); ?></td>
													<?php
													...
													<td style="white-space: initial;"><?php echo e(date('d/m/Y', strtotime($list->archived_on))); ?></td>
													<td style="white-space: initial;">-</td>
													...
													<td style="white-space: initial;">
														<div class="dropdown d-inline">
															...
															<div class="dropdown-menu">
																...
																<a class="dropdown-item has-icon" href="javascript:;" onclick="movetoclientAction(<?php echo e($list->id); ?>, 'admins','is_archived')">Move to clients</a>
															</div>
														</div>								  
													</td>
												</tr>											
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\archived\index.blade.php ENDPATH**/ ?>