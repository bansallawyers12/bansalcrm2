...
<?php $__env->startSection('title', 'Create Quotation Template'); ?>
...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('url' => 'admin/quotations/template/edit', 'name'=>"add-quotations", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
						...
						<div class="card">
							<div class="card-header">
								...
								<div class="card-header-action">
									<a href="<?php echo e(route('admin.quotations.template.index')); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="row">
									<div class="col-12 col-md-4 col-lg-4">
										<div class="form-group"> 
											...
											<?php echo Form::text('template_name', @$fetchedData->name, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Template Name' )); ?>

											<?php if($errors->has('template_name')): ?>
												<span class="custom-error" role="alert">
													<strong><?php echo e(@$errors->first('template_name')); ?></strong>
												</span> 
											<?php endif; ?>
										</div>
									</div>
										...
										<div class="form-group"> 
											...
											<select class="form-control select2" name="office">
												...
												foreach($offices as $office){
													?>
													<option <?php if($fetchedData->office == $office->id){ echo 'selected'; } ?> value="<?php echo e($office->id); ?>"><?php echo e($office->office_name); ?></option>
													<?php
												}
												?>
											</select>
									...
									<div class="col-12 col-md-4 col-lg-4">
										<div class="form-group"> 
											...
											<div class="bfh-selectbox bfh-currencies" data-currency="<?php echo e(@$fetchedData->currency); ?>" data-flags="true" data-name="quotation_currency"></div>
											<?php if($errors->has('quotation_currency')): ?>
												<span class="custom-error" role="alert">
													<strong><?php echo e(@$errors->first('quotation_currency')); ?></strong>
												</span> 
											<?php endif; ?>
										</div>
									</div>
										...
										<tbody class="productitem">
											...
											$Partnerdata = \App\Models\Partner::where('id',$q->partner)->first();	
												...
												<tr >
													...
													<td class="show_<?php echo e($l); ?>"><div class="productinfo"><a href="javascript:;" dataid="<?php echo e($l); ?>" class="edit_productinfo"><i class="fa fa-edit"></i></a><div class="productdet"><b><?php echo e(@$Productdata->name); ?></b></div><?php echo e(@$Partnerdata->partner_name); ?><div class="prodescription">(<?php echo e(@$workflowdata->name); ?>)</div></div><input type="hidden" class="workflowid" name="workflowid[]" value="<?php echo e(@$q->workflow); ?>"><input class="partnerid" type="hidden" name="partnerid[]" value="<?php echo e(@$q->partner); ?>"><input class="productid" type="hidden" name="productid[]" value="<?php echo e(@$q->product); ?>"><input type="hidden" name="branchid[]" class="branchid" value="<?php echo e(@$q->branch); ?>"></td>
													<td><textarea placeholder="Description" rows="1" cols="30" class="form-control" name="description[]"><?php echo e(@$q->description); ?></textarea></td>
													<td>AUD</td>
													<td><input type="tel" value="<?php echo e(number_format($servicefee,2,'.','')); ?>" placeholder="0.00" class="form-control servicefee" name="service_fee[]"></td>
													<td><input type="tel" value="<?php echo e(number_format($discount,2,'.','')); ?>" placeholder="0.00" class="form-control discount" name="discount[]"></td>
													
													<td class="netfare"><?php echo e(number_format($netfare,2,'.','')); ?></td>
													<td><input type="tel" value="<?php echo e(number_format($exg_rate,2,'.','')); ?>" class="form-control excrate" name="exg_rate[]"></td>
													<td dataprice="<?php echo e(number_format($exgrw,2,'.','')); ?>" class="totalamt"><?php echo e(number_format($exgrw,2,'.','')); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\quotations\template\edit.blade.php ENDPATH**/ ?>