		...
		<div class="inv-template-bodysection" style="margin-top:30px;">
				...
				<tbody>
					  <tr> 
						<td style="width:50%;padding: 2px 10px;vertical-align: middle;">
						  <div>
							<span style="font-weight: bold;" class="inv-orgname"><?php echo e(@$invoicedetail->company->company_name); ?><br></span>
							<span style="white-space: pre-wrap;font-size: 14px;line-height:21px;" id="tmp_org_address"><?php echo e(@$invoicedetail->company->address); ?> <br><?php echo e(@$invoicedetail->company->city); ?> <?php echo e(@$invoicedetail->company->state); ?> <?php echo e(@$invoicedetail->company->zip); ?> <br/><?php echo e(@$invoicedetail->company->country); ?></span>
						  </div>
						</td>
							...
							<td style="border-right: 1px solid #9e9e9e;padding-bottom: 10px;width: 50%">
								<div style="display:table;width:100%;">
									<div style="display:table-row;">
										...
										<div style="font-weight: 600;width: 50%;display:table-cell;" id="tmp_entity_number">: <?php echo e($invoicedetail->invoice); ?></div>
									</div>
									<div style="display:table-row;">
										<div style="width: 50%;display:table-cell;" class="inv-label">Invoice Date</div>
										<div style="font-weight: 600;width: 50%;display:table-cell;" id="tmp_entity_date">: <?php echo e(date('d/m/Y',strtotime($invoicedetail->invoice_date))); ?></div>
									</div>
									<div style="display:table-row;">
										<div style="width: 50%;display:table-cell;" class="inv-label">Terms</div>
										<div style="font-weight: 600;width: 50%;display:table-cell;" id="tmp_payment_terms">: <?php echo e($invoicedetail->terms); ?></div>
									</div>
									<div style="display:table-row;">
										<div style="width: 50%;display:table-cell;" class="inv-label">Due Date</div>
										<div style="font-weight: 600;width: 50%;display:table-cell;" id="tmp_due_date">: <?php echo e(date('d/m/Y',strtotime($invoicedetail->due_date))); ?></div>
									</div>	
			...
			<div style="background:#f3f3f3;padding:10px 5px;">
				<table style="" class="inv-addresstable" border="0" cellspacing="0" cellpadding="0">
					...
					<tbody> 
						<tr>
							<td style="" valign="top">
								<span style="white-space: pre-wrap;line-height: 15px;color:#0080ec;" id="tmp_billing_address"><strong><span class="inv-customer-name" id="zb-pdf-customer-detail"><a style="color:#0080ec;" href="#"><?php echo e(@$invoicedetail->customer->company_name); ?></a></span></strong></span>
							</td>
						</tr>
						<tr>
							<td valign="top">
								<span id="tmp_billing_address"><span class="inv-customer-name" id="zb-pdf-customer-detail"><?php echo e(@$invoicedetail->customer->first_name); ?> <?php echo e(@$invoicedetail->customer->last_name); ?></span></span>
							</td>
						</tr>
						<tr>
							<td valign="top">
								<span id="tmp_billing_address"><span class="inv-customer-name" id="zb-pdf-customer-detail">
								<span style="display:block;"><?php echo e(@$invoicedetail->customer->address); ?></span>
								<span style="display:block;"><?php echo e(@$invoicedetail->customer->city); ?></span>
								<span style="display:block;"><?php echo e(@$invoicedetail->customer->zip); ?></span>
								<span style="display:block;"><?php echo e(@$invoicedetail->customer->country); ?></span></span></span>
							</td>
						</tr>
					</tbody>
				</table>
			...
			<table style="width: 100%;table-layout:fixed;clear: both;" class="inv-itemtable" id="itemTable" cellspacing="0" cellpadding="0" border="1">
				...
				<tbody class="itemBody">
					...
					<?php $__currentLoopData = $invoicedetail->invoicedetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php $ntotal = $lst->quantity * $lst->rate; ?>
					<tr class="breakrow-inside breakrow-after">
						<td valign="top" style="text-align: center;" class="inv-item-row"><?php echo e($ist); ?></td>
						<td valign="top" class="inv-item-row" id="tmp_item_name">
							<div><span style="white-space: pre-wrap;word-wrap: break-word;" class="inv-item-desc" id="tmp_item_description"><?php echo e($lst->item_name); ?></span><br></div>
						</td>
						<td valign="top" style="text-align: right;" class="inv-item-row" id="tmp_item_qty"><?php echo e(number_format($lst->quantity,$currencydata->decimal)); ?> </td>
						<td valign="top" style="text-align: right;" class="inv-item-row" id="tmp_item_rate"><?php echo e(number_format($lst->rate,$currencydata->decimal)); ?></td>
						<td valign="top" style="text-align: right;" class="inv-item-row" id="tmp_item_amount"><?php echo e(number_format($ntotal,$currencydata->decimal)); ?></td>
					</tr>
					<?php 
					$subtotal += $ntotal;
					$ist++; ?>
					...
					<table class="inv-totaltable" id="itemTable" cellspacing="0" cellspacing="0" border="0" width="100%">
						<tbody>
							<tr>
								...
								<td id="tmp_subtotal" valign="middle" style="width:110px;"><?php echo e(number_format($subtotal,$currencydata->decimal)); ?></td>
							</tr>  
						<?php if($invoicedetail->discount != 0){ ?>
							<tr>
								<td valign="middle">Discount(<?php if($invoicedetail->discount_type == 'fixed'){ echo $currencydata->currency_symbol; } ?><?php echo e($invoicedetail->discount); ?> <?php if($invoicedetail->discount_type == 'percentage'){ echo '%'; } ?>)</td>
								<td id="tmp_total" valign="middle" style="width:110px;">(-) <?php echo $discoun; ?></td>
							</tr>
							<?php } ?>
							<?php if(@$invoicedetail->tax != 0): ?>
							<?php
							...
							?>
							<tr>
								<td valign="middle"><b><?php echo e(@$cure->name); ?> [<?php echo e(@$cure->rate); ?>%]</b></td>
								<td id="tmp_total" valign="middle" style="width:110px;"><b><?php echo e(number_format($taxcal,$currencydata->decimal)); ?></b></td>
							</tr>
							<?php } ?>
						<?php endif; ?>
							<tr>
								<td valign="middle"><b>Total</b></td>
								<td id="tmp_total" valign="middle" style="width:110px;"><b><?php echo e($currencydata->currency_symbol); ?><?php echo e(number_format($finaltotal,$currencydata->decimal)); ?></b></td>
							</tr>
				 
							<?php if($ispaymentexist): ?>
								<?php $baldue = $finaltotal - $amount_rec; ?>
							<tr style="height:10px;">
								<td valign="middle">Payment Made</td>
								<td valign="middle" style="width:110px;color: red;">(-) <?php echo e(number_format($amount_rec, $currencydata->decimal)); ?></td>
							</tr>
							<tr style="height:10px;" class="inv-balance">
								<td valign="middle"><b>Balance Due</b></td>
								<td id="tmp_balance_due" valign="middle" style="width:110px;;"><strong><?php echo e($currencydata->currency_symbol); ?><?php echo e(number_format($baldue, $currencydata->decimal)); ?></strong></td>
							</tr>
							<?php endif; ?>
						</tbody>
					</table>	
...
</html><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\invoices\invoice.blade.php ENDPATH**/ ?>