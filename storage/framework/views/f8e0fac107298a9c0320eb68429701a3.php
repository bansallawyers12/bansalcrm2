							...
							<div class="tab-content" id="payableContent">
								<div class="tab-pane fade show active" id="payables" role="tabpanel" aria-labelledby="payables-tab">
									<ul class="nav nav-pills" id="paypaid_tabs" role="tablist">
										<li class="nav-item is_checked_clientn">
											<a class="nav-link" id="unpaid-tab"  href="<?php echo e(URL::to('/admin/income-sharing/payables/unpaid')); ?>" >Unpaid</a>
										</li> 
										<li class="nav-item is_checked_clientn">
											<a class="nav-link active" id="paid-tab"  href="<?php echo e(URL::to('/admin/income-sharing/payables/paid')); ?>" >Paid</a>
										</li> 	
									</ul>
											...
											<div class="table-responsive common_table"> 
												<table class="table text_wrap">
													...
													<?php
																...
																<td><a href="<?php echo e(URL::to('/admin/invoice/view/')); ?>/<?php echo e($list->invoice_id); ?>"><?php echo e(@$list->invoice_id); ?></a></td>
																<td><a href="#"><?php echo e(@$list->branch->office_name); ?></a></td>
																<td>-</td>
																<td><a href="<?php echo e(URL::to('/admin/clients/detail/')); ?>/<?php echo e(base64_encode(convert_uuencode($list->invoice->customer->id))); ?>"><?php echo e(@$list->invoice->customer->first_name); ?> <?php echo e(@$list->invoice->customer->last_name); ?></a></td>
																<td><?php echo e(date('d/m/Y', strtotime(@$list->invoice->customer->dob))); ?></td>
																<td><?php echo e(@$partnerdata->partner_name); ?></td>
																<td><?php echo e(@$productdata->name); ?></td>
																<td>$ <?php echo e($list->amount); ?></td>
																<td>$ 0.00</td>
																
																<td><?php echo e(date('d/m/Y', strtotime(@$list->payment_date))); ?></td>
																<td><?php echo e(@$admindata->first_name); ?> <?php echo e(@$admindata->last_name); ?></td>
																<td style="text-align:right;">
																	<div class="dropdown d-inline">
																		...
																		<div class="dropdown-menu">
																			<a  data-id="<?php echo e($list->id); ?>" class="dropdown-item revertinvoice" href="javascript:;">Revert Payment</a>
...
jQuery(document).ready(function($){ 
	...
	$(document).delegate('#confirmModal .accept', 'click', function(){
		...
		$('.popuploader').show(); 
		$.ajax({
			url: '<?php echo e(URL::to('/admin/')); ?>/revert-payment',
			type:'GET',
			datatype:'json',
			data:{id:notid},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\account\payablepaid.blade.php ENDPATH**/ ?>