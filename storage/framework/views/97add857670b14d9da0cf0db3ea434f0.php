					...
					<div class="card">
						...
						<div class="card-body">
							<ul class="nav nav-pills" id="client_tabs" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" id="clients-tab" href="<?php echo e(URL::to('/admin/branch/view/')); ?>/<?php echo e($fetchedData->id); ?>" role="tab" >User List</a>
								</li>
								<li class="nav-item">
									<a class="nav-link"  id="date-tab" href="<?php echo e(URL::to('/admin/branch/view/client/')); ?>/<?php echo e($fetchedData->id); ?>" role="tab" >Client List</a>
								</li>
										...
										<table class="table text_wrap table-2">
											...
											foreach(\App\Models\Admin::where('role', '!=',7)->where('office_id',$fetchedData->id)->with(['usertype'])->get() as $alist){
												...
												<tr id="id_<?php echo e($alist->id); ?>">
													...
													<td><?php echo e(@$alist->usertype->name == "" ? config('constants.empty') : str_limit(@$alist->usertype->name, '50', '...')); ?></td>
													
													<td><?php if($alist->status == 1): ?> Active <?php else: ?> Inactive <?php endif; ?></td> 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\branch\view.blade.php ENDPATH**/ ?>