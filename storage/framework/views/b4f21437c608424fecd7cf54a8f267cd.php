					...
					<div class="card">
						...
						<div class="card-body">
							...
							<ul class="nav nav-pills" id="checkin_tabs" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active" id="archived-tab"  href="<?php echo e(URL::to('/admin/office-visits/archived')); ?>" >Archived <span class="countAction"><?php echo e($InPersonCount_archived_type); ?></span></a>
								</li>
								<li class="nav-item">
							...
							<div class="mydropdown" style="margin-top:10px;">
								  ...
								  <a href="<?php echo e(URL::to('/admin/office-visits/archived')); ?>">All Branches</a>
								  <?php
								  $branchs = \App\Models\Branch::all();
								  foreach($branchs as $branch){
									?>
									<a href="<?php echo e(URL::to('/admin/office-visits/archived')); ?>?office=<?php echo e($branch->id); ?>&office_name=<?php echo e($branch->office_name); ?>"><?php echo e($branch->office_name); ?></a>
								  <?php } ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\officevisits\archived.blade.php ENDPATH**/ ?>