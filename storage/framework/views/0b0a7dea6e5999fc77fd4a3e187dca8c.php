		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-6">
				  ...
				  <!-- /.card-header -->
				  <!-- form start -->
				  <form action="<?php echo e(url('admin/staff/edit')); ?>" method="POST" name="edit-staff" autocomplete="off" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
					<input type="hidden" name="id" value="<?php echo e(@$fetchedData->id); ?>">
						<div class="card-body">	
						  ...
						  <div class="form-group">
							...
							<?php echo Form::text('staff_id', @$fetchedData->staff_id, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter User Last Name' )); ?>
						  ...
						  <div class="form-group">
							...
							<?php echo Form::text('email', @$fetchedData->email, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter User Email' )); ?>
						  ...
						  <div class="form-group">
							...
							<?php echo Form::text('phone', @$fetchedData->phone, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter User Phone' )); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\staff\edit.blade.php ENDPATH**/ ?>