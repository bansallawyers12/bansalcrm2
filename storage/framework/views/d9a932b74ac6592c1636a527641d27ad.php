				...
				<tbody>
					...
					<tr>
						<td colspan="2">
							...
							<p style="font-size: 13px;line-height: 16px;color: #000;font-weight: normal;margin: 10px 0px 5px;"><b><?php echo e(@$cleintname->first_name); ?> <?php echo e(@$cleintname->last_name); ?></b></p>
							<p style="font-size: 14px;line-height: 21px;color: #000;font-weight: bold;margin: 0px;"><?php echo e(@$cleintname->email); ?></p>
												...
												<tbody>
													...
													foreach($invoiceschedules as $invoiceschedule){
														...
														<tr >
															<td>
																<div style="">
																	<span style="" class=""><?php echo e(@$invoiceschedule->installment_name); ?></span><br>
															...
															<td >
																...
																foreach($scheduleitem as $scheduleite){
																	?>
																	<span style="line-height: 23px;" class=""><?php echo e(@$scheduleite->fee_type); ?></span><br>
																	<?php
																}
																?>
																</div>
															...
															<td>
																...
																foreach($scheduleitem as $scheduleite){
																	...
																	?>
																	<span style="line-height: 23px;" class=""><?php echo e(@$scheduleite->fee_amount); ?></span><br>
																	<?php
																}
																?>
															</td>
...
<?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\emails\paymentschedules.blade.php ENDPATH**/ ?>