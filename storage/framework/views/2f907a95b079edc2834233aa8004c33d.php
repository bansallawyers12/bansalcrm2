...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<form action="<?php echo e(url('admin/products/store')); ?>" method="POST" name="add-products" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				<div class="row">
			...
			<div class="form-group"> 
				...
				<select class="form-control select2" data-valid="required" id="intrested_product" name="partner">
					...
					<?php $__currentLoopData = \App\Models\Partner::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($plist->id); ?>"><?php echo e($plist->partner_name); ?></option>
		...
		<div class="col-12 col-md-4 col-lg-4">
			<div class="form-group"> 
				...
				<?php $__currentLoopData = \App\Models\ProductType::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<option value="<?php echo e($plist->name); ?>"><?php echo e($plist->name); ?></option>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</select>
		...
		<div class="row">
			<div class="col-12 col-md-6 col-lg-6">
				<div class="form-group"> 
					...
					<?php echo Form::text('duration', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Duration' )); ?>
				...
				<div class="form-group"> 
					...
					<?php endif; ?>
								...
								<div class="form-group float-right">
									<?php echo Form::button('Save Product', ['class'=>'btn btn-primary', 'onClick'=>'customValidate("add-products")']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\products\create.blade.php ENDPATH**/ ?>