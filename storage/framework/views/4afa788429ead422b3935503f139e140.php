					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
                                ...
                                <a target="_blank" href="<?php echo e(URL::to('/admin/partners/updatecommissionpercentage/'.$fetchedData->id)); ?>" class="btn btn-primary">Update Commission Percentage</a>

                                <a target="_blank" href="<?php echo e(URL::to('/admin/partners/updatecommissionclaimed/'.$fetchedData->id)); ?>" class="btn btn-primary">Update Commission Claimed</a>

								<a href="<?php echo e(route('admin.partners.index')); ?>" class="btn btn-primary">Partner List</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-3 col-md-3 col-lg-3">
					<div class="card author-box">
						<div class="card-body">
							...
							<span class="author-avtar" style="background: rgb(68, 182, 174);"><b><?php echo e(substr($fetchedData->partner_name, 0, 1)); ?></b></span>
								<div class="clearfix"></div>
								<div class="author-box-name"> 
									<a href="#"><?php echo e($fetchedData->partner_name); ?></a>
								</div>
								<div class="author-mail_sms">
									<a href="#" title="Compose SMS"><i class="fas fa-comment-alt"></i></a>
									<a href="javascript:;" data-id="<?php echo e(@$fetchedData->id); ?>" data-email="<?php echo e(@$fetchedData->email); ?>" data-name="<?php echo e(@$fetchedData->partner_name); ?>" class="clientemail" title="Compose Mail"><i class="fa fa-envelope"></i></a> 
									<a href="<?php echo e(URL::to('/admin/partners/edit/'.base64_encode(convert_uuencode(@$fetchedData->id)))); ?>" title="Edit"><i class="fa fa-edit"></i></a>
									
									<?php if($fetchedData->is_archived == 0): ?>
										<a class="arcivedval" href="javascript:;" onclick="arcivedAction(<?php echo e($fetchedData->id); ?>, 'partners')" title="Archive"><i class="fas fa-archive"></i></a>
									<?php else: ?>
										<a class="arcivedval" style="background-color:red;" href="javascript:;" onclick="arcivedAction(<?php echo e($fetchedData->id); ?>, 'partners')" title="UnArchive"><i style="color: #fff;" class="fas fa-archive"></i></a>
									<?php endif; ?>
								</div>
							</div>
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<p class="clearfix"> 
								...
								<span class="float-right text-muted"><?php echo e($fetchedData->fax); ?></span>
							</p>
							<p class="clearfix"> 
							...
							<p class="clearfix"> 
								...
								<span class="float-right text-muted"><?php echo e($fetchedData->address); ?></span>
							</p>
							<p class="clearfix"> 
								<span class="float-left">Website:</span>
								<span class="float-right text-muted"><?php echo e($fetchedData->website); ?></span>
							</p>
							<?php
							...
							<p class="clearfix"> 
								...
								<span class="float-right text-muted"><?php echo e(@$workflows->name); ?></span>
							</p>
							
							<p class="clearfix"> 
								<span class="float-left">Added On:</span>
								<span class="float-right text-muted"><?php echo e(date('d/m/Y', strtotime($fetchedData->created_at))); ?></span>
							</p>
							<p class="clearfix"> 
								<span class="float-left">Business Registration Number:</span>
								<span class="float-right text-muted"><?php echo e($fetchedData->business_reg_no); ?></span>
							</p>
							<p class="clearfix"> 
								<span class="float-left">Currency code:</span>
								<span class="float-right text-muted"><?php echo e($fetchedData->currency); ?></span>
							</p>
												...
												<div class="card-statistic-4">
													<div class="align-items-center justify-content-between">
														<div class="card-content">
															...
															<h2 class="mb-3 font-18"><?php echo e($appprogresscount); ?></h2>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="card-statistic-4">
													<div class="align-items-center justify-content-between">
														<div class="card-content">
															...
															<h2 class="mb-3 font-18"><?php echo e($appcompletecount); ?></h2>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="card-statistic-4">
													<div class="align-items-center justify-content-between">
														<div class="card-content">
															...
															<h2 class="mb-3 font-18"><?php echo e($appdisccount); ?></h2>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="card-statistic-4">
													<div class="align-items-center justify-content-between">
														<div class="card-content">
															...
															<h2 class="mb-3 font-18"><?php echo e($appenrolcount); ?></h2>
														</div>
													</div>
												</div>
											</div>
				...
				$workflow = \App\Models\Workflow::where('id', $alist->workflow)->first();
												...
												<tr id="id_<?php echo e($alist->id); ?>">
													<td><a href="<?php echo e(URL::to('/admin/clients/detail/'.base64_encode(convert_uuencode(@$partnerdetail->id)))); ?>"><?php echo e($partnerdetail->first_name); ?> <?php echo e($partnerdetail->last_name); ?></a></td>
													<td></td>
													...
													<?php endif; ?>
											 		...
											 		<td><?php echo e(date('d/m/Y', strtotime($alist->created_at))); ?></td>
											 		<td><?php echo e(date('d/m/Y', strtotime($alist->updated_at))); ?></td>
												</tr>
												<?php
											} 
											?>											
                                        ...
                                        foreach($activities as $activit){
                                            ...
                                            <div class="activity" id="activity_<?php echo e($activit->id); ?>">
                                                ...
                                                <div class="activity-detail" style="border: 1px solid #dbdbdb;background-color: #dbdbdb;">
                                                    ...
                                                    <!--<div class="right" style="float: right;margin-top: -40px;">
                                                        ...
                                                        <div class="dropdown d-inline dropdown_ellipsis_icon">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a data-id="" data-href="deleteactivitylog" class="dropdown-item deleteactivitylog" href="javascript:;" >Delete</a>
                                                                <?php //if($activit->pin == 1){ ?>
                                                    ...
                                                    <?php if($activit->description != ''): ?>
                                                        <p><?php echo $activit->description; ?></p>
                                                    <?php endif; ?>

                                                    <?php if($activit->followup_date != ''): ?>
                                                        <p><?php echo date('d/m/Y',strtotime($activit->followup_date)); ?></p>
                                                    <?php endif; ?>
								...
								<div class="tab-pane fade <?php if(isset($_GET['tab']) && $_GET['tab'] == 'product'){ echo 'show active'; } ?>" id="products" role="tabpanel" aria-labelledby="products-tab">
									<div class="card-header-action text-right" style="padding-bottom:15px;">
										<a href="<?php echo e(route('admin.products.create')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
									</div>
									<div class="table-responsive"> 
										<table class="table text_wrap">
											...
											?>
												<tr id="id_<?php echo e(@$product->id); ?>">
													...
													?>
													<td><?php echo e(implode(', ', $bname)); ?></td>
													
													<?php
													$countapplication = \App\Models\Application::where('product_id', $product->id)->where('status', 0)->count();
													?>
													<td><?php echo e($countapplication); ?></td>
													<td>
														<div class="dropdown d-inline">
															<button class="btn btn-primary dropdown-toggle" type="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
															<div class="dropdown-menu"> 
																<a class="dropdown-item has-icon" href="<?php echo e(URL::to('/admin/products/detail/'.base64_encode(convert_uuencode(@$product->id)))); ?>"><i class="far fa-eye"></i> View</a>
																<a class="dropdown-item has-icon" href="<?php echo e(URL::to('/admin/products/edit/'.base64_encode(convert_uuencode(@$product->id)))); ?>"><i class="far fa-edit"></i> Edit</a>
																<a class="dropdown-item has-icon" href="javascript:;" onClick="deleteAction(<?php echo e(@$product->id); ?>, 'products')"><i class="fas fa-trash"></i> Delete</a>
															</div>
														</div>
													</td>
												</tr>
											...
											<div class="extra_content">
												...
												<div class="right">
													<div class="dropdown d-inline dropdown_ellipsis_icon">
														<a class="dropdown-toggle" type="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a class="dropdown-item openbranchform" data-id="<?php echo e($branch->id); ?>" href="javascript:;">Edit</a>
															<a data-id="<?php echo e($branch->id); ?>" data-href="deletebranch" class="dropdown-item deletenote" href="javascript:;" >Delete</a>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="tab-pane fade" id="agreements" role="tabpanel" aria-labelledby="agreements-tab">
									<div class="agreement_info">
										...
										<form method="post"  action="<?php echo e(URL::to('/admin/partner/saveagreement')); ?>" autocomplete="off" name="saveagreement" id="saveagreement" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										<input type="hidden" name="partner_id" value="<?php echo e($fetchedData->id); ?>">
										<div class="row">
                                            <div class="col-md-4">
												<div class="form-group">
													...
													<div class="input-group">
														...
														<?php echo Form::text('contract_start','', array('id' => 'contract_start','class' => 'form-control contract_expiry', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>

														<?php if($errors->has('contract_start')): ?>
															<span class="custom-error" role="alert">
																<strong><?php echo e(@$errors->first('contract_start')); ?></strong>
															</span>
														<?php endif; ?>
													</div>
												</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<div class="input-group">
														...
														<?php echo Form::text('contract_expiry', @$fetchedData->contract_expiry, array('id' => 'contract_expiry', 'class' => 'form-control contract_expiry', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>

														<?php if($errors->has('contract_expiry')): ?>
															<span class="custom-error" role="alert">
																<strong><?php echo e(@$errors->first('contract_expiry')); ?></strong>
															</span> 
														<?php endif; ?>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<select class="form-control represent_region select2" multiple name="represent_region[]" >
														...
														foreach(\App\Models\Country::all() as $list){
															?>
															<option <?php if(in_array($list->name, $represent_region)){ echo 'selected'; } ?> value="<?php echo e(@$list->name); ?>"><?php echo e(@$list->name); ?></option>
															<?php
														}
														?>
													</select>
													<?php if($errors->has('represent_region')): ?>
														<span class="custom-error" role="alert">
															<strong><?php echo e(@$errors->first('represent_region')); ?></strong>
														</span> 
													<?php endif; ?>
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group">
													...
													<?php echo Form::number('commission_percentage', @$fetchedData->commission_percentage, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Commission Percentage', 'step'=>'0.01' )); ?>

													<?php if($errors->has('commission_percentage')): ?>
														<span class="custom-error" role="alert">
															<strong><?php echo e(@$errors->first('commission_percentage')); ?></strong>
														</span> 
													<?php endif; ?>
												</div>
											</div>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<?php if($errors->has('default_super_agent')): ?>
														<span class="custom-error" role="alert">
															<strong><?php echo e(@$errors->first('default_super_agent')); ?></strong>
														</span> 
													<?php endif; ?>
												</div>
											</div>
								...
								<div class="tab-pane fade" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">  
									...
									?>
										<div class="note_col" id="contact_<?php echo e($clist->id); ?>" style="width:33.33333333%"> 
											<div class="note_content">
												<h4><?php echo e($clist->name); ?></h4>
											...
											<div class="extra_content">
												...
												<div class="right">
													<div class="dropdown d-inline dropdown_ellipsis_icon">
														<a class="dropdown-toggle" type="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a class="dropdown-item opencontactform" data-id="<?php echo e($clist->id); ?>" href="javascript:;">Edit</a>
															<a data-id="<?php echo e($clist->id); ?>" data-href="deletecontact" class="dropdown-item deletenote" href="javascript:;" >Delete</a>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="tab-pane fade" id="noteterm" role="tabpanel" aria-labelledby="noteterm-tab">
									...
									?>
										<div class="note_col" id="note_id_<?php echo e($list->id); ?>"> 
											...
											<div class="note_content">
												<!--<h4><a class="viewnote" data-id="<?php echo e($list->id); ?>" href="javascript:;"><?php echo e(@$list->title == "" ? config('constants.empty') : str_limit(@$list->title, '19', '...')); ?></a></h4>-->
                                              
                                                <div class="note-title" style="display: inline-block;margin-right: 60px;">
                                                    <p><b><?php echo e($admin->first_name); ?></b>  Added Note with Title <b><?php echo @$list->title; ?></b></p>
                                                </div>

                                                <div class="note-date" style="display: inline-block;">
                                                  <span class="text-job"><?php echo e(date('d M Y, H:i A', strtotime($list->updated_at))); ?></span>
                                                </div>
											...
											<div class="extra_content">
												...
												<!--<div class="left">
													<div class="author">
														<a href="#"><?php echo e(substr($admin->first_name, 0, 1)); ?></a>
													</div>
													<div class="note_modify">
														<small>Last Modified <span><?php echo e(date('d/m/Y', strtotime($list->updated_at))); ?></span></small>
													</div>
												</div>-->  
									...
									<div class="conversation_tabs">
										...
										<div class="tab-content" id="conversationContent">
                                                    ...
                                                    <div class="tab-pane show active" id="fetchemail" role="tabpanel" aria-labelledby="fetchemail-tab">
                                                        ...
                                                        <div class="conversation_list inbox_conversation_list">
                                                            <div class="conversa_item">
                                                                <div class="ds_flex">
                                                                    <div class="title">
                                                                        <span><?php echo e(substr(@$mailreport->subject, 0, 50)); ?></span>
                                                                    </div>
                                                                    <div class="conver_action">
                                                                        <div class="date">
                                                                            <?php if(isset($mailreport->fetch_mail_sent_time) && $mailreport->fetch_mail_sent_time != "") { ?>
                                                                                <span><?php echo e($mailreport->fetch_mail_sent_time); ?></span>
                                                                            <?php }  else {?>
                                                                                <span></span>
                                                                            <?php } ?>
                                                                        </div>
                                                                        ...
                                                                        <div class="dropdown d-inline">
                                                                            ...
                                                                            <div class="dropdown-menu">
                                                                                ...
                                                                                if($DocInfo)
                                                                                { ?>
                                                                                <a class="dropdown-item has-icon mail_preview_modal" memail_id="<?php echo e(@$mailreport->id); ?>" target="_blank"  href="<?php echo $DocInfo->myfile; ?>" ><i class="fas fa-eye"></i> Preview</a>
                                                                                <?php }?>
                                                                                <!--<a class="dropdown-item has-icon create_note" datamailid="" datasubject="" class="create_note" datatype="mailnote" ><i class="fas fa-file-alt"></i> Create Note</a>
                                                                                <a class="dropdown-item has-icon inbox_reassignemail_modal" memail_id="" user_mail="" uploaded_doc_id="" href="javascript:;"><i class="fas fa-shopping-bag"></i> Reassign</a>-->
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="email_info">
                                                                    ...
                                                                    <div class="email_content">
                                                                        ...
                                                                        <span class="span_desc">
                                                                            ...
                                                                            <span class="email_sentby" style="color: #000;"><i class="fa fa-angle-left"></i><?php echo e(@$mailreport->to_mail); ?><i class="fa fa-angle-right"></i></span>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="sent" role="tabpanel" aria-labelledby="sent-tab">
                                                <div class="row">
                                                    <div class="col-md-12" style="text-align: right;margin-bottom: 10px;">
                                                        <a class="btn btn-outline-primary btn-sm clientemail" data-id="<?php echo e(@$fetchedData->id); ?>" data-email="<?php echo e(@$fetchedData->email); ?>" data-name="<?php echo e(@$fetchedData->partner_name); ?>" id="email-tab" href="#email" role="tab" aria-controls="email" aria-selected="true">Compose Email</a>
                                                    ...
                                                    <div class="conversa_item">
                                                        <div class="ds_flex">
                                                            ...
                                                            <div class="conver_action">
                                                                ...
                                                                { ?>
                                                                    <div class="date">
                                                                        <?php if(isset($mailreport->created_at) && $mailreport->created_at != "") { ?>
                                                                            <span><?php echo e(@date('d/m/Y h:i A',strtotime($mailreport->created_at))); ?></span>
                                                                        <?php }  else {?>
                                                                            <span></span>
                                                                        <?php } ?>
                                                                    </div>
                                                                ...
                                                                <div class="dropdown d-inline">
																	<button class="btn btn-primary dropdown-toggle" style="width: 100px;margin:0px !important;" type="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
																	<div class="dropdown-menu">
                                                                        <!--<a target="_blank" class="dropdown-item"  href=""><i class="fas fa-eye"></i></a>-->
																		<?php
                                                                        if( isset($mailreport->uploaded_doc_id) && $mailreport->uploaded_doc_id != ""){
                                                                            ...
                                                                            <a class="dropdown-item has-icon sent_mail_preview_modal" memail_message="<?php echo e(@$mailreport->message); ?>" memail_subject="<?php echo e(@$mailreport->subject); ?>"><i class="fas fa-eye"></i> Preview Mail</a>
                                                                        <?php } ?>
																		...
																		<!--<a class="dropdown-item has-icon sent_reassignemail_modal" memail_id="" user_mail="" uploaded_doc_id="" href="javascript:;"><i class="fas fa-shopping-bag"></i> Reassign</a>-->
																		<?php //} ?>
																	</div>
																</div>
                                                            </div>
                                                        ...
                                                        <div class="email_info">
                                                            ...
                                                            <div class="email_content">
                                                                ...
                                                                <span class="email_sentby" style="color: #000;"><strong><?php echo e(@$mailreport->from_mail); ?></strong></span>
								...
								<div class="tab-pane fade" id="promotions" role="tabpanel" aria-labelledby="promotions-tab">
									...
									?>
										<div class="promotion_col" id="contact_<?php echo $promotion->id; ?>"> 
											...
											<?php endif; ?>
												<div class="" style="margin-top: 15px!important;">
													<h4><?php echo e($promotion->promotion_title); ?></h4>
													<p><?php echo e(@$promotion->promotion_desc == "" ? config('constants.empty') : str_limit(@$promotion->promotion_desc, '50', '...')); ?></p>
												</div>
												<div class="" style="margin-top: 15px!important;">
													<div class="row">
														<div class="col-md-6">
														...
														<div class="col-md-6">
														<span  class=""><?php echo e($countbranches); ?></span>
														</div>
													</div>
													<div class="row">
														<div class="col-md-6">
														...
														<div class="col-md-6">
														<span  class=""><?php echo e($countproducts); ?></span>
														</div>
													</div>
												</div>
												<div class="" style="margin-top: 15px!important;">
													<div class="row">
														...
														<p><?php echo e($promotion->promotion_start_date); ?></p>
														</div>
														<div class="col-md-6">
														<span ><b>Expiry Date</b></span>
														<p><?php echo e($promotion->promotion_end_date); ?></p>
														</div>
													</div>  
												</div>
											</div>
											<div class="extra_content">
												<div class="left">
													<div class="dropdown d-inline dropdown_ellipsis_icon">
														<a class="dropdown-toggle" type="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a class="dropdown-item openpromotonform" data-id="<?php echo e($promotion->id); ?>" href="javascript:;">Edit</a>
														</div>
													</div>	
												</div>  
												<div class="right">
													<div class="custom-switches">
														<label class="custom-switch">
															<input type="checkbox" data-status="<?php echo $promotion->status; ?>" data-id="<?php echo e($promotion->id); ?>" name="custom-switch-checkbox" class="custom-switch-input changepromotonstatus" <?php if($promotion->status == 1): ?> checked <?php endif; ?>>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            if($data->client_reference){
                                                                                ...
                                                                                echo $client_reference = '<a href="'.url('/admin/clients/detail/'.$client_encoded_id).'" class="activate-app-tab" data-tab="application" data-id="'.$data->id.'" target="_blank" >'.$data->client_reference.'</a>';
                                                                            } else {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        if($data1->client_reference){
                                                                           ...
                                                                           echo $client_reference1 = '<a href="'.url('/admin/clients/detail/'.$client_encoded_id1).'" class="activate-app-tab" data-tab="application" data-id="'.$data1->id.'" target="_blank" >'.$data1->client_reference.'</a>';
                                                                        } else {
                                    ...
                                    <div class="invoices_tabs">
                                        ...
                                        <div class="tab-content" id="invoicesContent">
											 ...
											 <div class="tab-pane fade show active" id="create_invoice" role="tabpanel" aria-labelledby="create_invoice-tab">
                                                <div class="row">
                                                    <div class="col-md-12 text-right">
                                                        <a class="btn btn-primary createpartnerstudentinvoice" href="javascript:;" data-partnerid="<?php echo e($fetchedData->id); ?>" role="button"  style="margin-right:5px !important;">Create Invoice</a>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="table-responsive">
                                                        ...
                                                        <tbody class="productitemList">
                                                            ...
                                                            <tr  id="TrRow_<?php echo $rec_val->invoice_id;?>">
                                                                ...
                                                                <td style="padding-top: 5px !important;padding-bottom: 5px !important;">
                                                                    ...
                                                                    <a target="_blank" class="link-primary" href="<?php echo e(URL::to('/admin/partners/printpreviewcreateinvoice')); ?>/<?php echo e($rec_val->invoice_id); ?>"><i class="fa fa-print" aria-hidden="true"></i></a>
                                            ...
                                            <div class="tab-pane fade" id="record_invoice" role="tabpanel" aria-labelledby="record_invoice-tab">
                                                <div class="row">
                                                    <div class="col-md-12 text-right">
                                                        <a class="btn btn-primary createrecordinvoice" href="javascript:;" data-partnerid="<?php echo e($fetchedData->id); ?>" role="button"  style="margin-right:5px !important;">Create Record Invoice</a>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="table-responsive">
                                                        ...
                                                        <tbody class="productitemList_invoice">
                                                            ...
                                                            <tr  id="TrRecordRow_<?php echo $inv_val->id;?>">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <!--<a target="_blank" class="link-primary" href="/"><i class="fa fa-print" aria-hidden="true"></i></a>
                                            ...
                                            <div class="tab-pane fade" id="record_payment" role="tabpanel" aria-labelledby="record_payment-tab">
                                                <div class="row">
                                                    <div class="col-md-12 text-right">
                                                        <a class="btn btn-primary createrecordpayment" href="javascript:;" data-partnerid="<?php echo e($fetchedData->id); ?>" role="button"  style="margin-right:5px !important;">Create Record Payment</a>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="table-responsive">
...
<?php echo $__env->make('Admin/partners/addpartnermodal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>  
<?php echo $__env->make('Admin/partners/editpartnermodal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>   
					...
					<div class="row">
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<?php echo Form::text('branch_name', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Name' )); ?>
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<?php echo Form::text('branch_email', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Email' )); ?>
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<?php echo Form::text('branch_city', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter City' )); ?>

								<?php if($errors->has('branch_city')): ?>
									<span class="custom-error" role="alert">
										<strong><?php echo e(@$errors->first('branch_city')); ?></strong>
									</span> 
								<?php endif; ?>
							</div>
						</div>
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group"> 
								...
								<?php echo Form::text('branch_state', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter State' )); ?>

								<?php if($errors->has('branch_state')): ?>
									<span class="custom-error" role="alert">
										<strong><?php echo e(@$errors->first('branch_state')); ?></strong>
									</span> 
								<?php endif; ?>
							</div>
						</div>
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group"> 
								...
								<?php echo Form::text('branch_address', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Street' )); ?>

								<?php if($errors->has('branch_address')): ?>
									<span class="custom-error" role="alert">
										<strong><?php echo e(@$errors->first('branch_address')); ?></strong>
									</span> 
								<?php endif; ?>
							</div>
						</div>
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group"> 
								...
								<?php echo Form::text('branch_zip', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Zip / Post Code' )); ?>

								<?php if($errors->has('branch_zip')): ?>
									<span class="custom-error" role="alert">
										<strong><?php echo e(@$errors->first('branch_zip')); ?></strong>
									</span> 
								<?php endif; ?>
							</div>
						</div>
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group"> 
								...
								<div class="cus_field_input"> 
									...
									<?php echo Form::text('branch_phone', '', array('class' => 'form-control tel_input', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Phone' )); ?>

									<?php if($errors->has('branch_phone')): ?>
										<span class="custom-error" role="alert">
											<strong><?php echo e(@$errors->first('branch_phone')); ?></strong>
										</span> 
									<?php endif; ?>
								</div> 
							</div>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('changeStatusForm').addEventListener('submit', function(e) {
        ...
        fetch('/admin/partners/update-student-status', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    document.getElementById('changeApplicationOverallStatusForm').addEventListener('submit', function(e) {
        e.preventDefault();
        const formData = new FormData(this);
        fetch('/admin/partners/update-student-application-overall-status', {
            method: 'POST',
            body: formData,
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
jQuery(document).ready(function($){
   ...
   //////////////////////////////
    ...
    $(document).delegate('.partnerUploadAndFetchMail','click', function(){
		$('#mapartner_id_fetch').val('<?php echo e($fetchedData->id); ?>');
        $('#partnerUploadAndFetchMail').modal('show');
	});

    $(document).delegate('.partnerUploadSentAndFetchMail','click', function(){
		$('#mapartner_id_fetch_sent').val('<?php echo e($fetchedData->id); ?>');
    ...
    $(document).delegate('.openproductrinfo', 'click', function(){
        ...
        $.ajax({
            type:'post',
            url: '<?php echo e(URL::to('/admin/partners/getEnrolledStudentList')); ?>',
            sync:true,
    ...
    function getTopReceiptValInDB(type) {
        $.ajax({
            type:'post',
            url: '<?php echo e(URL::to('/admin/partners/getTopReceiptValInDB')); ?>',
            sync:true,
            data: {type:type},
            success: function(response){
    ...
    function getTopInvoiceValInDB(type) {
        $.ajax({
            type:'post',
            url: '<?php echo e(URL::to('/admin/partners/getTopInvoiceValInDB')); ?>',
            sync:true,
            data: {type:type},
            success: function(response){
    ...
    $(document).delegate('.student_no_cls', 'change', function(){
        ...
        if(sel_student_id != ""){
            $.ajax({
                type:'post',
                url: '<?php echo e(URL::to('/admin/partners/getStudentInfo')); ?>',
                sync:true,
        ...
        if(sel_student_id != "")
        {
            ...
            $.ajax({
                type:'post',
                url: '<?php echo e(URL::to('/admin/partners/getStudentCourseInfo')); ?>',
                sync:true,
                    ...
                    confirm: {
                        ...
                        action: function () {
                            ...
                            if (sentDate) {
                                ...
                                $.ajax({
                                    type:'post',
                                    url: '<?php echo e(URL::to('/admin/partners/updateInvoiceSentOptionToYes')); ?>',
                                    sync:true,
    ...
    function getInfoByInvoiceId(invoiceid) {
        $.ajax({
            type:'post',
            url: '<?php echo e(URL::to('/admin/partners/getInfoByInvoiceId')); ?>',
            sync:true,
    ...
    $(document).delegate('.deletestudentinvoice', 'click', function(){
        ...
        if( invoiceid != "" && confirm('Are you sure you want to delete this invoice?') ) {
            $.ajax({
                type:'post',
                url: '<?php echo e(URL::to('/admin/partners/deleteStudentRecordByInvoiceId')); ?>',
                sync:true,
    ...
    function getEnrolledStudentListInEditMode(partnerid,uniqueRowId) {
        $.ajax({
            type:'post',
            url: '<?php echo e(URL::to('/admin/partners/getEnrolledStudentListInEditMode')); ?>',
            sync:true,
    ...
    $(document).delegate('.deletestudentrecordinvoice', 'click', function(){
        ...
        if( id != "" && confirm('Are you sure you want to delete this record invoice?') ) {
            $.ajax({
                type:'post',
                url: '<?php echo e(URL::to('/admin/partners/deleteStudentRecordInvoiceByInvoiceId')); ?>',
                sync:true,
    ...
    function getRecordedInvoiceList(partnerid) {
        ...
        $.ajax({
            type:'post',
            url: '<?php echo e(URL::to('/admin/partners/getRecordedInvoiceList')); ?>',
            sync:true,
            data: {partnerid:partnerid},
            success: function(response){
                var obj = $.parseJSON(response); //console.log('record_get=='+obj.record_get);
    ...
    $('#createrecordpaymentmodal').on('show.bs.modal', function() {
     ...
     $(document).delegate('.deletestudentpaymentinvoice', 'click', function(){
        ...
        if( id != "" && confirm('Are you sure you want to delete this payment invoice?') ) {
            $.ajax({
                type:'post',
                url: '<?php echo e(URL::to('/admin/partners/deleteStudentPaymentInvoiceByInvoiceId')); ?>',
                sync:true,
                data: {id:id,invoicetype:invoicetype,partnerid:partnerid},
                success: function(response){
                    var obj = $.parseJSON(response);
   ...
   $(document).delegate('input[name="apply_to"]', 'change', function () {
	...
	if(@$fetchedData->contract_expiry != ''){
		?>
		 $('#contract_expiry').val('<?php echo e(@$fetchedData->contract_expiry); ?>');
		<?php
	}else{
		?>
		 $('#contract_expiry').val('');
	...
	if(@$fetchedData->contract_start != ''){
		?>
		 $('#contract_start').val('<?php echo e(@$fetchedData->contract_start); ?>');
		<?php
	}else{
		?>
		 $('#contract_start').val('');
	...
	$.ajax({
		...
		type:'GET',
		data:{clientid:'<?php echo e($fetchedData->id); ?>',type:'partner'},
		success: function(responses){
			$('.popuploader').hide(); 
...
function getallactivities(){
    ...
    $('#noteType').on('change', function() {
        ...
        if(selectedValue === "Call") {
            ...
            $('.popuploader').show();
            $.ajax({
                url: "<?php echo e(URL::to('/admin/partners/fetchPartnerContactNo')); ?>",
                method: "POST",
  ...
  return repo.name || repo.text;
	...
	$(document).delegate('.opencontactform', 'click', function(){
		...
		$('#add_clientcontact input[name="contact_id"]').val(v);
			$('.popuploader').show(); 
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getcontactdetail')); ?>',
			type:'GET',
			datatype:'json',
			data:{note_id:v},
			success:function(response){
	...
	$(document).delegate('.openbranchform', 'click', function(){
		...
		$('#add_clientbranch input[name="branch_id"]').val(v);
			$('.popuploader').show(); 
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getbranchdetail')); ?>',
			type:'GET',
			datatype:'json',
			data:{note_id:v},
			success:function(response){
...
var formData = new FormData($('#upload_form')[0]);		
		$.ajax({
			url: site_url+'/admin/upload-partner-document-upload',
			type:'POST',
			datatype:'json',
			 data: formData,
			contentType: false,
...
$(document).delegate('#notes-tab', 'click', function(){
  ...
  $(document).delegate('.changepromotonstatus', 'change', function(){
	  ...
	  $.ajax({
			url: '<?php echo e(URL::to('/admin/change-promotion-status')); ?>',
			type:'GET',
  ...
  $(document).delegate('.changetaskstatus', 'click', function(){
	  ...
	  $('.popuploader').show();
	  $.ajax({
			url: '<?php echo e(URL::to('/admin/change-task-status')); ?>',
			type:'GET',
  ...
  $(document).delegate('.changeprioritystatus', 'click', function(){
	  ...
	  $('.popuploader').show();
	  $.ajax({
			url: '<?php echo e(URL::to('/admin/change-task-priority')); ?>',
			type:'GET',
  ...
  $(document).delegate('.savecomment', 'click', function(){
	  ...
	  if(!flag){
		  $('.popuploader').show();
		  $.ajax({
			url: '<?php echo e(URL::to('/admin/partner/savecomment')); ?>',
			type:'POST',
  ...
  $(document).delegate('.openpromotonform', 'click', function(){
		...
		$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getpromotioneditform')); ?>',
			type:'GET',
			data:{id:appliid},
			success:function(response){
				$('.popuploader').hide();
			...
			if(id == '') {
				...
				$.ajax({
					...
					success:function(resp) {
						...
						if(obj.status == 1) {
							window.location.href= '<?php echo e(URL::to('admin/partners')); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\partners\detail.blade.php ENDPATH**/ ?>