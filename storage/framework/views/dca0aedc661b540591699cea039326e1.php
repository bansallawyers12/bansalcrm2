				...
				<tbody>
					...
					<tr>
						<td colspan="2">
							...
							<p style="font-size: 13px;line-height: 16px;color: #000;font-weight: normal;margin: 10px 0px 5px;"><b><?php echo e(@$fetchedData->invoice->customer->first_name); ?> <?php echo e(@$fetchedData->invoice->customer->first_name); ?></b></p>
							<p style="font-size: 14px;line-height: 21px;color: #000;font-weight: bold;margin: 0px;"><?php echo e(@$fetchedData->invoice->customer->email); ?></p>
							<p style="font-size: 13px;line-height: 21px;color: #333;font-weight: normal;margin: 0px;"><?php echo e(@$fetchedData->invoice->customer->phone); ?></p>
						</td>
						<td>
...
<?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\emails\reciept.blade.php ENDPATH**/ ?>