	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/create-note')); ?>" name="editnotetermform" autocomplete="off" id="editnotetermform" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
...
<div class="modal fade edit_english_test custom_modal" tabindex="-1" role="dialog" aria-labelledby="editenglishModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content"> 
			...
			<div class="modal-body">
			<?php
				$testscores = \App\Models\TestScore::where('client_id', $fetchedData->id)->first();
				?>
				<form method="post" action="<?php echo e(URL::to('/admin/edit-test-scores')); ?>" name="testscoreform" autocomplete="off" id="testscoreform" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
...
<div class="modal fade edit_other_test custom_modal" tabindex="-1" role="dialog" aria-labelledby="editotherModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content"> 
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/other-test-scores')); ?>" name="othertestform" autocomplete="off" id="othertestform" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
					<div class="row">
						<div class="col-12 col-md-12 col-lg-12">
...
<!-- Interested Service Modal -->
<div class="modal fade  custom_modal" id="edit_promotion" tabindex="-1" role="dialog" aria-labelledby="create_interestModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body showpromotionedit">
...
<?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\partners\editpartnermodal.blade.php ENDPATH**/ ?>