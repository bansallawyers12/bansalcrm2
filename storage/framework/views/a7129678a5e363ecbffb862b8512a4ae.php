					...
					<div class="card">
						...
						<div class="card-body">
							<ul class="nav nav-pills" id="quotation_tabs" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active" id="archived-tab"  href="<?php echo e(URL::to('/admin/quotations/archived')); ?>" >Archived Quotations</a>
								</li>
							</ul>
												...
												<td>
													<div class="dropdown d-inline">
														...
														<div class="dropdown-menu">
															...
															<a class="dropdown-item has-icon" href="javascript:;" onClick="deleteAction(<?php echo e(@$list->id); ?>, 'quotations')">Delete</a>
														</div>
													</div>								  
												</td>
											</tr>	
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\quotations\archived.blade.php ENDPATH**/ ?>