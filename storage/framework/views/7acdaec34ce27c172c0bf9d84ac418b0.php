...
<?php $__env->startSection('title', 'Application Detail'); ?>
						...
						<div class="card-body">
							...
							<div class="tab-content" id="clientContent" style="padding-top:15px;">
																		...
																		<td>
																			<div class="dropdown d-inline">
																				...
																				<div class="dropdown-menu">
																					...
																					<a class="dropdown-item" href="javascript:;" onClick="deleteAction(<?php echo e(@$list->id); ?>, 'partners')">Delete</a>
																				</div>
																			</div>
																		</td>
																	</tr>
										...
										<div class="col-md-3">
											<div class="cus_sidebar">
												<div class="form-group">
													...
													<?php echo Form::text('applied_intake', '', array('class' => 'form-control datepicker', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>
											...
											<div class="content">
												...
												<div class="created_by">
													...
													<div class="appoint_avatar">
														...
														<span class="name">Arun<br/><small>arun@bansaleducation.com.au</small></span>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="tab-pane fade" id="quotations" role="tabpanel" aria-labelledby="quotations-tab">
									<div class="card-header-action text-right" style="padding-bottom:15px;">
										<a href="<?php echo e(URL::to('/admin/quotations/client/create/104')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
									</div>
									<div class="table-responsive"> 
										<table class="table text_wrap">
											<thead>
													...
													<div class="conversa_item">
														...
														<div class="email_info">
															...
															<div class="email_content">
																...
																<span class="email_sentby"><strong>Arun</strong> [arun@bansaleducation.com.au]</span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\applications\detail.blade.php ENDPATH**/ ?>