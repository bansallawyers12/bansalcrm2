...
<?php $__env->startSection('title', 'Assigned by me'); ?>
						...
						<div class="card-header">
                            ...
                            <ul class="nav nav-pills" id="client_tabs" role="tablist">
                                <li class="nav-item is_checked_clientn12">
									<a class="nav-link" id=""  href="<?php echo e(URL::to('/admin/activities')); ?>">Incomplete</a>
								</li>

                                <li class="nav-item is_checked_clientn11">
									<a class="nav-link" id="archived-tab"  href="<?php echo e(URL::to('/admin/activities_completed')); ?>">Completed</a>
								</li>
                            </ul>
						</div>
						<div class="card-body">
							<div class="tab-content" id="quotationContent">
                                <form action="<?php echo e(route('assignee.assigned_by_me')); ?>" method="get">
                                    <div class="row">
									...
									<div class="table-responsive common_table">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><input type="radio" class="complete_task" data-toggle="tooltip" title="Mark Complete!" data-id="<?php echo e($list->id); ?>"></td>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="<?php echo e(route('assignee.destroy_by_me',$list->id)); ?>" method="POST">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\assignee\assign_by_me.blade.php ENDPATH**/ ?>