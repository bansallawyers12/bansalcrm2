					...
					<div class="card">
						...
						<div class="card-body">
							<ul class="nav nav-pills" id="client_tabs" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" id="active-tab"  href="<?php echo e(URL::to('/admin/enquiries')); ?>" >Queries</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="inactive-tab"  href="<?php echo e(URL::to('/admin/enquiries/archived-enquiries')); ?>" >Archived</a>
								</li>
							</ul> 
										...
										<table class="table text_wrap table-2">
											...
											<tbody class="referredclienttdata">
												...
												<tr id="id_<?php echo e($enqlist->id); ?>">
													<td style="white-space: initial;"><?php echo e($enqlist->id); ?></td>
													<td style="white-space: initial;"><?php echo e($enqlist->first_name); ?> <?php echo e($enqlist->last_name); ?></td>
													<td style="white-space: initial;"><?php echo e($enqlist->email); ?></td>
													<td style="white-space: initial;"><?php echo e($enqlist->phone); ?></td>
													<td style="white-space: initial;"><?php echo e($enqlist->country); ?></td>
													<td style="white-space: initial;"><?php echo e($enqlist->city); ?></td>
                                                    <td style="white-space: initial;"><?php echo e($enqlist->subject); ?></td>
													<td style="white-space: initial;"><?php echo e($enqlist->message); ?></td>
													<td style="white-space: initial;"><?php echo e($enqlist->source); ?></td>
											        <td style="white-space: initial;"><?php echo e($enqlist->cur_visa); ?></td>
													...
													<td style="white-space: initial;">
														<div class="dropdown d-inline">
															...
															<div class="dropdown-menu">
																<a class="dropdown-item has-icon converttoclient" data-id="<?php echo e($enqlist->id); ?>" href="javascript:;"><i class="fas fa-edit"></i> Convert to Client</a>
																<a class="dropdown-item has-icon archivedrow" data-id="<?php echo e($enqlist->id); ?>" href="javascript:;"><i class="fas fa-trash"></i> Archived</a>
															</div>
														</div>
													</td>
												</tr>
...
$(document).ready(function(){
	...
	$(document).delegate('#confirnarchived .acceptarch', 'click', function(){
		...
		$('.popuploader').show(); 
		$.ajax({
			url: '<?php echo e(URL::to('/admin/')); ?>/enquiries/archived/'+v,
			type:'GET',
			datatype:'json',
	...
	$(document).delegate('#confirnconvert .accept', 'click', function(){
		...
		$('.popuploader').show(); 
		$.ajax({
			url: '<?php echo e(URL::to('/admin/')); ?>/enquiries/covertenquiry/'+v,
			type:'GET',
			datatype:'json',
			success:function(response){
				$('.popuploader').hide(); 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\enquire\index.blade.php ENDPATH**/ ?>