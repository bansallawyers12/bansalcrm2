					  ...
					  <!-- form start -->
						<div class="card-body">
							...
							<div class="float-right">
								<a href="<?php echo e(route('admin.taxrates.create')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> New Tax</a>
							</div>
						</div>
								  ...
								  <td>
									<div class="nav-item dropdown action_dropdown">
										...
										<div class="dropdown-menu">
											<a href="<?php echo e(URL::to('/admin/settings/taxes/taxrates/edit/'.base64_encode(convert_uuencode(@$list->id)))); ?>"><i class="fa fa-edit"></i> Edit</a>
											<a href="javascript:;" onClick="deleteAction(<?php echo e(@$list->id); ?>, 'tax_rates')"><i class="fa fa-trash"></i> Delete</a>
										</div>
									</div>
								  </td>
								</tr>	 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\settings\taxrates.blade.php ENDPATH**/ ?>