	...
	<li class="dropdown dropdown-list-toggle">
		...
		<li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
				...
				<a href="<?php echo e(route('agent.logout')); ?>" class="dropdown-item has-icon text-danger" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> <i class="fas fa-sign-out-alt"></i> Logout</a>
            </div>
		</li>
	</ul>
</nav>
<form id="logout-form" action="<?php echo e(route('agent.logout')); ?>" method="POST" style="display: none;">
	<?php echo csrf_field(); ?>
	<input type="hidden" name="id" value="<?php echo e(Auth::user()->id); ?>">
</form>
<?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Elements\Agent\header.blade.php ENDPATH**/ ?>