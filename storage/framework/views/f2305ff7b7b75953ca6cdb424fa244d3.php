...
<?php $__env->startSection('title', 'assignees'); ?>
						...
						<div class="card-header">
                            ...
                            <ul class="nav nav-pills" id="client_tabs" role="tablist">
								...
								<li class="nav-item is_checked_clientn11">
									<a class="nav-link active" id="archived-tab"  href="<?php echo e(URL::to('/admin/assignee-completed')); ?>">Completed</a>
								</li>
								...
								<div class="tab-pane fade show active" id="active_quotation" role="tabpanel" aria-labelledby="active_quotation-tab">
									...
									<table class="table table-bordered">
										<tr>
											...
											<th class="sort_col"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('followup_date','Follow-up DateTime'));?></th>
										...
										<?php $__currentLoopData = $assignees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										...
										<tr>
											...
											<td><?php echo e($user_name??'N/P'); ?></td>
											...
											<td><?php echo e(date('d/m/Y h:i:s',strtotime($list->followup_date)) ?? 'N/P'); ?> </td>
											...
											<td>
												...
												<form action="<?php echo e(route('assignee.destroy',$list->id)); ?>" method="POST">

													

													
                                                    <a class="btn btn-primary not_complete_task" data-id="<?php echo e($list->id); ?>" href="javascript:void(0)">Incomplete</a>
										...
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
   										 ...
   										 <?php echo $assignees->appends($_GET)->links(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\assignee\completed.blade.php ENDPATH**/ ?>