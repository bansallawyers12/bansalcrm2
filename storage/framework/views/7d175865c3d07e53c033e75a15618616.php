					...
					<div class="card">
						...
						<div class="card-body">
						    ...
						    <div class="filter_panel">
								...
								<form action="<?php echo e(URL::to('/admin/applications')); ?>" method="get">
									<div class="row">
										<div class="col-md-4">
									...
									<div class="row">
										<div class="col-md-12 text-center">
											...
											<a class="btn btn-info" href="<?php echo e(URL::to('/admin/applications')); ?>">Reset</a>
										</div>
									</div>
								</form>
							</div>	
								...
								<table class="table text_wrap">
									...
									<tbody class="tdata">	 
										<tr id="id_<?php echo e(@$list->id); ?>">
											...
											<td  style="white-space: initial;"><?php echo e($PartnerBranch->name ?? 'N/A'); ?></td>
										...
										<td>
											<div class="dropdown d-inline">
												...
												<div class="dropdown-menu">
													<a class="dropdown-item has-icon" href="<?php echo e(URL::to('/admin/applications/detail/'.base64_encode(convert_uuencode(@$list->id)))); ?>"><i class="far fa-eye"></i> View Detail</a>
													<a class="dropdown-item has-icon" href="javascript:;" onClick="deleteAction(<?php echo e(@$list->id); ?>, 'applications')"><i class="fas fa-trash"></i> Delete</a>
												</div>
											</div>								  
										</td>
										</tr>	
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\applications\index.blade.php ENDPATH**/ ?>