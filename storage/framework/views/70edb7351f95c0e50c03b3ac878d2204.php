			...
			<div class="row">
				<div class="col-12 col-md-12 col-lg-12">
					<div class="card">
						...
						<div class="card-body">
							<form class="search_form" action="<?php echo e(URL::to('/admin/services')); ?>">
									...
									<div class="row">
										<div class="col-md-3">
											<div class="form-group">
												...
												$catid = array();
												?>
													<?php $__currentLoopData = \App\Models\Category::whereIn('id', $servicecat)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<?php
														$catid[] = $clist->id;
														?>
														<option <?php if(isset($_GET['cat']) && $_GET['cat'] == $clist->id){ echo 'selected'; } ?> value="<?php echo e($clist->id); ?>"><?php echo e($clist->category_name); ?></option>
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												?>
													<?php $__currentLoopData = $serviceccat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cslist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<option <?php if(isset($_GET['sf']) && $_GET['sf'] == 1){ echo 'selected'; } ?> value="<?php echo e($cslist->sub_id); ?>"><?php echo e($cslist->name); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												</select>
											</div>
										</div>
										<div class="col-md-6">
											<div class="search_field">
												<input type="text" name="s" value="<?php echo e(@$_GET['s']); ?>" class="form-control" placeholder="Search" />
										...
										<div class="service_column">
												<div class="service_left">
													...
													<div class="service_content"> 
														<h4><a target="_blank" href="<?php echo e(URL::to('/admin/partners/detail/'.base64_encode(convert_uuencode(@$servlist->id)))); ?>"><?php echo @$servlist->partner_name; ?></a></h4>
														...
														<div class="course_details">
															<div class="course_row">
																<div class="course_column">
																	...
																	<span class="value"><?php echo e($PartnerType->name); ?></span>
																</div>
																<div class="course_column">
															...
															<div class="course_row">	
																...
																<div class="course_column">
																	...
																	<span class="value"><?php echo e($servlist->phone); ?></span>
																</div>
																<div class="course_column">
																	<span class="label">Website</span>
																	<span class="value"><?php echo e($servlist->website); ?></span>
																</div>
															</div>
												...
												<div class="service_right">
													...
													<div class="inner_serv_rgt">
														...
														?>
															<h5 class="text-info">Total <?php echo e(@$subcat->name); ?></h5>
															<h4><?php echo \App\Models\Product::where('partner', $servlist->id)->count(); ?></h4>
														</div>
														<div class="">
															<a href="<?php echo e(URL::to('/admin/partners/detail/'.base64_encode(convert_uuencode(@$servlist->id)))); ?>?tab=product">View All <?php echo e(@$subcat->name); ?></a>
														</div>
													</div>
												</div>
												<div class="clearfix"></div>
												<div class="service_actions">
													...
													<div class="serv_action_btns">
														<a target="_blank" href="<?php echo e(URL::to('/admin/partners/detail/'.base64_encode(convert_uuencode(@$servlist->id)))); ?>" class="btn btn-outline-secondary view_full_detail">View Full Details</a>
														<a servicetype="partner" data-partner-name="<?php echo e(@$servlist->partner_name); ?>" data-partner-id="<?php echo e(@$servlist->id); ?>" href="javascript:;" data-branch-name="<?php echo @$PartnerBranch->name; ?>" data-branch-id="<?php echo @$PartnerBranch->id; ?>" data-workflow-name="<?php echo @$workflow->name; ?>" data-workflow-id="<?php echo @$workflow->id; ?>" href="javascript:;" class="btn btn-outline-secondary interest_btn add_interested_service">Add To Interested Services</a>
								...
								?>
											<div class="service_column">
												<div class="service_left">
													...
													<div class="service_content"> 
														<h4><a target="_blank" href="<?php echo e(URL::to('/admin/products/detail/'.base64_encode(convert_uuencode(@$servlist->id)))); ?>"><?php echo @$servlist->name; ?></a></h4>
														<h5><a target="_blank" href="<?php echo e(URL::to('/admin/partners/detail/'.base64_encode(convert_uuencode(@$partnerdetail->id)))); ?>"><?php echo @$partnerdetail->partner_name; ?></a></h5>
														<span class="serv_office"><?php echo @$PartnerBranch->name; ?></span>
														<div class="course_details">
															<div class="course_row">
																<div class="course_column">
									...
									<?php $i++; } ?>
												...
												<div class="service_actions">
													...
													<div class="serv_action_btns">
														<a target="_blank" href="<?php echo e(URL::to('/admin/products/detail/'.base64_encode(convert_uuencode(@$servlist->id)))); ?>" class="btn btn-outline-secondary view_full_detail">View Full Details</a>
														<a servicetype="product" data-partner-name="<?php echo e(@$partnerdetail->partner_name); ?>" data-partner-id="<?php echo e(@$partnerdetail->id); ?>" href="javascript:;" data-product-name="<?php echo e(@$servlist->name); ?>" data-product-id="<?php echo e(@$servlist->id); ?>" data-branch-name="<?php echo @$PartnerBranch->name; ?>" data-branch-id="<?php echo @$PartnerBranch->id; ?>" data-workflow-name="<?php echo @$workflow->name; ?>" data-workflow-id="<?php echo @$workflow->id; ?>" href="javascript:;" class="btn btn-outline-secondary interest_btn add_interested_service">Add To Interested Services</a>
														<a data-partner-name="<?php echo e(@$partnerdetail->partner_name); ?>" data-partner-id="<?php echo e(@$partnerdetail->id); ?>" href="javascript:;" data-product-name="<?php echo e(@$servlist->name); ?>" data-product-id="<?php echo e($servlist->id); ?>" data-branch-name="<?php echo @$PartnerBranch->name; ?>" data-branch-id="<?php echo @$PartnerBranch->id; ?>" data-workflow-name="<?php echo @$workflow->name; ?>" data-workflow-id="<?php echo $workflow->id; ?>" href="javascript:;" class="btn btn-primary add_application">Add To Application</a>
	...
	<div class="modal-dialog">
		<div class="modal-content"> 
			...
			<div style="margin-bottom: 20px;" class="custom-error-popupmsg"></div>
				<form method="post" action="<?php echo e(URL::to('/admin/savetoapplication')); ?>" name="addtoapplicationform" id="addtoapplicationform" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<select data-valid="required" class="form-control contact contactselect2" id="contact" name="contact">
									...
									<?php $__currentLoopData = \App\Models\Admin::where('role',7)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($wlist->id); ?>"><?php echo e($wlist->first_name); ?> <?php echo e($wlist->last_name); ?>

											(<?php echo e($wlist->email); ?> <?php echo e($wlist->phone); ?>)</option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				 <div class="col-md-12">	
					<h5>Partners</h5>
					<a href="<?php echo e(URL::to('admin/partners/create')); ?>" style="background-color: transparent;color: #9c9c9c;fill: #9c9c9c;width: 48%;border: 1px solid #9c9c9c;display: inline-flex;" class="btn btn-info defaultButton ghostButton">Add New Partner</a>
				 </div>
				  <div class="col-md-12" style="margin-top: 20px!important;">
				  <h5>Products</h5>
					<a href="<?php echo e(URL::to('admin/products/create')); ?>" style="background-color: transparent;color: #9c9c9c;fill: #9c9c9c;width: 48%;border: 1px solid #9c9c9c;display: inline-flex;" class="btn btn-info defaultButton ghostButton">Add New Product</a>
				 </div>
			</div>
		</div>
	</div>
...
jQuery(document).ready(function($){
	...
	$(document).delegate('#getpartnertype','change', function(){	
		...
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getsubcategories')); ?>',
			type:'GET',
			data:{cat_id:v},
	...
	$(document).delegate('.productselect2','change', function(){	
		...
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getproductbranch')); ?>',
			type:'GET',
			data:{cat_id:v},
			success:function(response){
				$('.popuploader').hide();
	...
	$(document).delegate('.add_interested_service','click', function(){
		...
		$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getservicemodal')); ?>',
			type:'GET',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\services\index.blade.php ENDPATH**/ ?>