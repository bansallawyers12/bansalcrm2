...
<?php $__env->startSection('title', 'Completed Activities'); ?>
						...
						<div class="card-header">
                            ...
                            <ul class="nav nav-pills" id="client_tabs" role="tablist">
                                <li class="nav-item is_checked_clientn11">
									<a class="nav-link active" id="archived-tab"  href="<?php echo e(URL::to('/admin/activities')); ?>">Incomplete</a>
								</li>
                            </ul>
						</div>
						<div class="card-body">
							<div class="tab-content" id="quotationContent">
                                <form action="<?php echo e(route('assignee.activities_completed')); ?>" method="get">
                                    <div class="row">
                                        <div class="col-md-12 group_type_section">
                                            ...
                                            <?php //echo $task_group;?>
                                            <a href="<?php echo e(URL::to('/admin/activities_completed?group_type=All')); ?>" id="All" class="group_type <?php if($task_group == 'All') { echo 'active';}?>">All <span class="countAction"><?php echo e($assigneesCount_All_type); ?></span></a> | &nbsp;

                                            <button type="button" class="btn btn-light">
                                                <a href="<?php echo e(URL::to('/admin/activities_completed?group_type=Call')); ?>" id="Call" class="group_type <?php if($task_group == 'Call') { echo 'active';}?>"> <i class="fa fa-phone" aria-hidden="true"></i> Call <span class="countAction"><?php echo e($assigneesCount_call_type); ?></span></a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="<?php echo e(URL::to('/admin/activities_completed?group_type=Checklist')); ?>" id="Checklist" class="group_type <?php if($task_group == 'Checklist') { echo 'active';}?>"><i class="fa fa-bars" aria-hidden="true"></i> Checklist <span class="countAction"><?php echo e($assigneesCount_Checklist_type); ?></span></a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="<?php echo e(URL::to('/admin/activities_completed?group_type=Review')); ?>" id="Review" class="group_type <?php if($task_group == 'Review') { echo 'active';}?>"> <i class="fa fa-check" aria-hidden="true"></i> Review <span class="countAction"><?php echo e($assigneesCount_Review_type); ?></span></a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="<?php echo e(URL::to('/admin/activities_completed?group_type=Query')); ?>" id="Query" class="group_type <?php if($task_group == 'Query') { echo 'active';}?>"><i class="fa fa-question" aria-hidden="true"></i> Query <span class="countAction"><?php echo e($assigneesCount_Query_type); ?></span></a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="<?php echo e(URL::to('/admin/activities_completed?group_type=Urgent')); ?>" id="Urgent" class="group_type <?php if($task_group == 'Urgent') { echo 'active';}?>"> <i class="fa fa-flag" aria-hidden="true"></i> Urgent <span class="countAction"><?php echo e($assigneesCount_Urgent_type); ?></span></a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="<?php echo e(URL::to('/admin/activities_completed?group_type=Personal Task')); ?>" id="Personal Task" class="group_type <?php if($task_group == 'Personal Task') { echo 'active';}?>"> <i class="fa fa-tasks" aria-hidden="true"></i> Personal Task <span class="countAction"><?php echo e($assigneesCount_Personal_Task_type); ?></span></a> &nbsp;
                                            </button>
                                        </div>
                                    </div>
                                </form>
									...
									<div class="table-responsive common_table">
                                        ...
                                        <table class="table table-bordered">
                                            <tr>
                                                ...
                                                <th width="120px" class="sort_col"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('followup_date','Assign Date'));?></th>
                                                <th width="100px" class="sort_col"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('task_group','Type'));?></th>
                                                <th>Note</th>
                                            ...
                                            ?>
                                            <?php $__currentLoopData = $assignees_completed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><input type="radio" class="not_complete_task" data-toggle="tooltip" title="Mark Incomplete!" data-id="<?php echo e($list->id); ?>"></td>
                                                <td><?php echo e($full_name??'N/P'); ?></td>
                                                <td>
                                                    ...
                                                    if($list->noteClient)
                                                    { ?>
                                                        <a href="<?php echo e(URL::to('/admin/clients/detail/'.base64_encode(convert_uuencode(@$list->client_id)))); ?>" target="_blank" ><?php echo e($list->noteClient->client_id); ?></a>
                                                    <?php
                                                    } ?>
                                                </td>
                                                <td><?php echo e(date('d/m/Y',strtotime($list->followup_date)) ?? 'N/P'); ?> </td>
                                                <td><?php echo e($list->task_group??'N/P'); ?></td>
                                                <td>
                                                    <?php
                                                ...
                                                <td>
                                                    ...
                                                    <form action="<?php echo e(route('assignee.destroy_complete_activity',$list->id)); ?>" method="POST">

                                                        

                                                         <!--<a class="btn btn-primary" data-toggle="tooltip" title="" href="<?php echo e(url('/admin/clients/edit/'.base64_encode(convert_uuencode(@$list->client_id)).'')); ?>"> <i class="fa fa-edit" aria-hidden="true"></i> </a>-->

                                                         <?php if($list->task_group != 'Personal Task'){?>
                                                         <button type="button" data-noteid="<?php echo e($list->description); ?>" data-taskid="<?php echo e($list->id); ?>" data-taskgroupid=<?php echo e($list->task_group); ?>  data-followupdate=<?php echo e($list->followup_date); ?> data-toggle="tooltip" title="" class="btn btn-primary btn-block update_task" data-container="body" data-role="popover" data-placement="bottom" data-html="true" data-content="<div id=&quot;popover-content&quot;>
                                                            ...
                                                            <div class=&quot;form-group row&quot; style=&quot;margin-bottom:12px&quot; >
                                                                ...
                                                                <div class=&quot;col-sm-9&quot;>
                                                                    <select class=&quot;assigneeselect2 form-control selec_reg&quot; id=&quot;rem_cat&quot; name=&quot;rem_cat&quot; onchange=&quot;&quot;>
                                                                        ...
                                                                        <?php $__currentLoopData = \App\Models\Admin::where('role','!=',7)->where('status',1)->orderby('first_name','ASC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php
                                                        ...
                                                        <input id=&quot;assign_client_id&quot;  type=&quot;hidden&quot; value=&quot;<?php echo e(base64_encode(convert_uuencode(@$list->client_id))); ?>&quot;>
                                                        ...
                                                        <?php if($list->task_group != 'Personal Task'){?>
                                                        <button type="button" data-noteid="<?php echo e($list->description); ?>" data-toggle="tooltip" title="" class="btn btn-primary btn-block reassign_task" data-container="body" data-role="popover" data-placement="bottom" data-html="true" data-content="<div id=&quot;popover-content&quot;>
   										...
   										<?php echo $assignees_completed->appends($_GET)->links(); ?>
...
jQuery(document).ready(function($){
	...
	$(document).delegate('.not_complete_task', 'click', function(){
        ...
        if(row_id !=""){
            $.ajax({
				type:'post',
                url:"<?php echo e(URL::to('/')); ?>/admin/update-task-not-completed",
	...
	$(document).delegate('.complete_task', 'click', function(){
        ...
        if(row_id !=""){ //&& confirm('Are you sure want to complete the task?')
            $.ajax({
				type:'post',
                url:"<?php echo e(URL::to('/')); ?>/admin/update-task-completed",
                headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                data: {id:row_id },
                success: function(response){
                    //console.log(response);
    ...
    $(document).delegate('#assignUser','click', function(){
		...
		if(flag){
			$.ajax({
				type:'post',
					url:"<?php echo e(URL::to('/')); ?>/admin/clients/reassignfollowup/store",
					headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\assignee\activities_completed.blade.php ENDPATH**/ ?>