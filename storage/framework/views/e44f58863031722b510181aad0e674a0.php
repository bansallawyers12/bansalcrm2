...
<?php $__env->startSection('title', 'Add Checklist'); ?>
...
<div class="main-content">
    <section class="section">
        <div class="section-body">
            <?php echo Form::open(array('url' => 'admin/documentchecklist/store', 'name'=>"add-checklist", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group float-right">
                                    <?php echo Form::submit('Save Checklist', ['class'=>'btn btn-primary' ]); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\feature\documentchecklist\create.blade.php ENDPATH**/ ?>