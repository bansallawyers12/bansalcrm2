...
<?php $__env->startSection('title', 'Edit Workflow'); ?>
...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('url' => 'admin/workflow/edit', 'name'=>"add-visatype", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?> 
												...
												<div class="col-12 col-md-12 col-lg-12">
													<div class="form-group"> 
														...
														<div class="workflow_stges">
															<table class="table">
															<?php
															$stagesquery = \App\Models\WorkflowStage::where('w_id', @$fetchedData->id);
															...
															?>
																<tr>
																	<td>
																		<input data-valid="required" type="text" name="stage_name[]" placeholder="Stage Name" class="form-control" value="<?php echo e(@$stage->name); ?>" >
																	</td>
																	<td>
																	<?php
																	if($i == 0 || $i == 1){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\feature\workflow\edit.blade.php ENDPATH**/ ?>