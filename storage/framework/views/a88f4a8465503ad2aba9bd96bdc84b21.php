					...
					<div class="card">
						<div class="card-body p-0" style="display: block;">
							<ul class="nav nav-pills flex-column"> <!---->
								<li class="nav-item"> <a href="<?php echo e(route('admin.taxrates')); ?>" id="ember5167" class="nav-link ember-view"> Tax Rates </a> </li><!----><!----><!----><!----><li class="nav-item"> <a href="<?php echo e(route('admin.returnsetting')); ?>" id="ember5168" class="nav-link active ember-view"> GST Settings </a> </li> <!----><!----> </ul>
						</div>
					</div>
				</div>
				<div class="col-md-8">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  <?php echo Form::open(array('url' => 'admin/settings/taxes/savereturnsetting', 'name'=>"add-city", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
							...
							<div class="row">
								...
								<div class="col-sm-12 is_gst_yes">
									<div class="form-group"> 
										...
										<?php echo Form::text('gstin', @Auth::user()->gstin, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
								...
								<div class="col-sm-12 is_gst_yes ">
									<div class="form-group"> 
										...
										<?php echo Form::text('gst_date', @Auth::user()->gst_date, array('class' => 'form-control commodategst', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

										
										<?php if($errors->has('gst_date')): ?>
											<span class="custom-error" role="alert">
												<strong><?php echo e(@$errors->first('gst_date')); ?></strong>
											</span> 
										<?php endif; ?>
									</div>
								</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\settings\returnsetting.blade.php ENDPATH**/ ?>