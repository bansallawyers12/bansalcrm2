...
<?php $__env->startSection('title', 'Edit Roles and Permissions'); ?>
...
<div class="main-content">
	<section class="section">
		<div class="section-body"> 
			<?php echo Form::open(array('url' => 'admin/userrole/edit', 'name'=>"edit-userrole", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
						...
						<div class="card">
							<div class="card-header">
								...
								<div class="card-header-action">
									<a href="<?php echo e(route('admin.userrole.index')); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
								</div>
							</div>
						</div>
					</div>	
								...
								<div class="row">
									<div class="col-12 col-md-6 col-lg-6">
										<div class="form-group">
											...
											<?php echo Form::text('name', @$fetchedData->name, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Name' )); ?>
									...
									<div class="col-12 col-md-6 col-lg-6">
										<div class="form-group">
											...
											<textarea class="form-control" name="description"><?php echo e(@$fetchedData->description); ?></textarea>
										</div>
									</div>
								</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\userrole\edit.blade.php ENDPATH**/ ?>