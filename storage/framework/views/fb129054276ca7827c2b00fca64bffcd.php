...
<?php $__env->startSection('title', 'Edit Product Type'); ?>
...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('url' => 'admin/product-type/edit', 'name'=>"edit-producttype", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group float-right">
									<?php echo Form::submit('Update Product Type', ['class'=>'btn btn-primary' ]); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\feature\producttype\edit.blade.php ENDPATH**/ ?>