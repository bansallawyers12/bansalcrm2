					...
					<div class="card">
						...
						<div class="card-body">
							<ul class="nav nav-pills" id="checkin_tabs" role="tablist">
								<li class="nav-item">
									<a class="nav-link" id="forecast_application-tab"  href="<?php echo e(URL::to('/admin/report/sale-forecast/application')); ?>" >Application</a>
								</li>
								<li class="nav-item">
									<a class="nav-link active" id="interested_service-tab"  href="<?php echo e(URL::to('/admin/report/sale-forecast/interested-service')); ?>" >Interested Service</a>
								</li>								
							</ul> 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\reports\interested-service.blade.php ENDPATH**/ ?>