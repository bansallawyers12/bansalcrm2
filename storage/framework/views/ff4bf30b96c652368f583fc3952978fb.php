					...
					<div class="card">
						...
						<div class="card-body">
							<ul class="nav nav-pills" id="user_tabs" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active" id="invited-tab"  href="<?php echo e(URL::to('/admin/users/invited')); ?>" >Invited</a>
								</li>								
							</ul>
										...
										?>
											<tbody class="tdata">	
												<tr id="id_<?php echo e(@$list->id); ?>"> 
													<td><a href="<?php echo e(URL::to('/admin/users/view')); ?>/<?php echo e($b->id ?? '#'); ?>"><?php echo e(@$list->first_name); ?></a><br><?php echo e(@$list->email); ?></td> 
													<td></td> 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\users\invited.blade.php ENDPATH**/ ?>