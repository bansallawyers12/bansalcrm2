...
<div class="main-content">
	...
	<form method="POST" action="<?php echo e(url('admin/invoice/com-store')); ?>" name="invoiceform" autocomplete="off" enctype="multipart/form-data">
	<?php echo csrf_field(); ?>
					...
					<div class="col-12 col-md-4 col-lg-4">
						<div class="card">
							...
							<div class="card-body">
								...
								?>
									<ul>
										<li><span>Name:</span> <?php echo e(@$partnerdata->partner_name); ?></li>
										<li><span>Address:</span> <?php echo e(@$partnerdata->address); ?></li>
										<li><span>Contact:</span> <?php echo e(@$partnerdata->phone); ?></li>
							...
							<div class="card-body">
								<div class="invoice_info">
									<ul>
										...
										<li><span>DOB:</span> <?php echo e(date('d/m/Y', strtotime($clientdata->dob))); ?></li>
										<li><span>Client ID:</span> <?php echo e($clientdata->client_id); ?></li>
										<li><span>Partner:</span> <?php echo e(@$partnerdata->partner_name); ?></li>
										<li><span>Product:</span> <?php echo e(@$productdata->name); ?></li>
										<li><span>Branch:</span> <?php echo e(@$branchdata->name); ?></li>
										<li><span>Workflow:</span> <?php echo e(@$workflowdaa->name); ?></li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="card">							
							<div class="card-body">
								<div class="form-group"> 
									...
									<?php echo Form::date('invoice_date', $invoicedetail->invoice_date, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>
								...
								<div class="form-group"> 
									...
									<?php echo Form::date('invoice_due_date', $invoicedetail->due_date, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>
							...
							<div class="card-body">
									...
									?>
										...
										?>
											<tr class="clonedrow">
												...
												<td><input class="form-control" name="description[]" value="<?php echo e($invoiceitemdetail->description); ?>" type="text"  /></td>
												<td><span class="percentageinput">$
													<input class="form-control total_fee" value="<?php echo e($invoiceitemdetail->total_fee); ?>"  name="total_fee[]" type="number"  />
										</span>
												</td>
												<td>
												<span class="percentageinput">
													<input class="form-control comm_per" value="<?php echo e($invoiceitemdetail->comm_per); ?>"  type="number" name="comm_per[]"  />%</span>
												</td>
												<td>
												<span class="percentageinput">$
													<input class="form-control comm_amt" value="<?php echo e($invoiceitemdetail->comm_amt); ?>"  type="number" name="comm_amt[]" />
										</span>
												</td>
												<td>
												<span class="currencyinput">$
													<input class="form-control" type="number" name="bonus_amount[]" value="<?php echo e($invoiceitemdetail->bonus_amount); ?>"/>
												</span>
												</td>
												<td>
													<select name="tax[]" class="form-control tax_amt">
														...
														<?php $__currentLoopData = \App\Models\Tax::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<option <?php if($invoiceitemdetail->tax == $taxlist->amount){ echo 'selected'; } ?> value="<?php echo e($taxlist->amount); ?>"><?php echo e($taxlist->name); ?></option>
														<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
													</select>
												</td>
												<td>
												<span class="percentageinput">$
													<input class="form-control taxamount" name="tax_amount[]" value="<?php echo e($invoiceitemdetail->tax_amount); ?>"  type="text" value="0.00" readonly />
										</span>
												</td>
												<td>
												<span class="percentageinput">$
													<input class="form-control netamount" value="<?php echo e($invoiceitemdetail->netamount); ?>"  name="netamount[]" type="text" value="0.00" readonly />
										</span>
												</td>
												<td>
								...
								<div class="row bottom_aligned">
									<div class="col-md-7 cus_col_7">
										...
										<div class="col_half col_discount_field">
											<div class="form-group inline_field">
												...
												<span class="percentageinput">$
													<input class="form-control" name="discount" value="<?php echo e($invoicedetail->discount); ?>" type="text" id="discount" ></span>
											...
											<div class="form-group">
												<div class="field_col">
													<div class="input-group">
														...
														<input value="<?php echo e($invoicedetail->discount_date); ?>" type="date" name="discount_date" placeholder="" class=" form-control" />
													</div>
													<!-- <span class="span_note">Date must be in YYYY-MM-DD (2012-12-22) format.</span> -->
												</div> 
											</div>
									...
									if($invoicedetail->type == 2){
										...
										<div class="col-md-7 cus_col_7">
											<div class="invoiceNetResult"> 
												...
												<p id="totalFee" class="invoiceNetRevenue"><span class="feecurrencyinput">$</span><?php echo e($invoicedetail->net_fee_rec); ?></p>
												<input type="hidden" id="invoice_net_revenue" name="invoice_net_revenue" value="<?php echo e($invoicedetail->net_fee_rec); ?>" placeholder="" class="" />
											</div>
										</div>
										<?php
									}else{
									...
									<div class="col-md-7 cus_col_7">
										<div class="invoiceNetResult"> 
											...
											<p id="totalFee" class="invoiceNetAmount"><span class="feecurrencyinput">$<?php echo e($invoicedetail->net_fee_rec); ?></span></p>
											<input type="hidden" value="<?php echo e($invoicedetail->net_fee_rec); ?>" id="invoice_net_amount" name="invoice_net_amount" placeholder="" class="" />
										</div>
										<div class="invoiceNetResult">
											<span>Net Income</span>
											<p class="invoiceNetAmount_2"><span class="feecurrencyinput">$</span><?php echo e($invoicedetail->net_incone); ?></p>
									...
									if($invoicedetail->type == 2){
										...
										<div class="invoiceInformationDiv">
											...
											<div class="inline_field">
												...
												<div class="label_input">
													<input type="hidden" name="total" value="<?php echo e($coom_amt); ?>">
													<input type="text" id="commissionClaimed" value="<?php echo e($coom_amt); ?>" readonly="readonly">
													<div class="basic_label">AUD</div>
												</div> 
											</div>
											<div class="inline_field">
												...
												<div class="label_input">
													<input type="hidden" name="total_tax" value="<?php echo e($tax_amt); ?>">
													<input type="text" id="gst" readonly="readonly" value="<?php echo e($tax_amt); ?>"> <div class="basic_label">AUD</div>
												</div>
											</div>
											<div class="inline_field">
												...
												<span class="currencyinput">$</span>
												<div class="label_input">
													<input type="hidden" name="total_amt" value="<?php echo e($coom_amt); ?>">
													<input value="<?php echo e($coom_amt); ?>" type="text" id="total_amt" readonly="readonly"> <div class="basic_label">AUD</div>
												</div>
											</div>
											<div class="inline_field">
												...
												<span class="currencyinput">$</span>
												<div class="label_input">
													<input type="hidden" name="total_paid" value="<?php echo e($amount_rec); ?>">
													<input value="<?php echo e($amount_rec); ?>" type="text" id="total_paid" readonly="readonly"> <div class="basic_label">AUD</div>
												</div>
											</div>
											<?php
											...
											<div class="inline_field">
												...
												<span class="currencyinput">$</span>
												<div class="label_input">
													<input type="hidden" name="total_due" value="<?php echo e($totaldue); ?>">
													<input value="<?php echo e($totaldue); ?>" type="text" id="total_due" readonly="readonly"> <div class="basic_label">AUD</div>
												</div>
											</div>
										</div>
										<?php
										...
										<div class="invoiceInformationDiv">
											<div class="inline_field">
												...
												<span class="currencyinput">$</span>
												<div class="label_input">
													<input type="hidden" name="total" value="<?php echo e($total_fee); ?>">
													<input value="<?php echo e($total_fee); ?>" type="text" id="totalfee" readonly="readonly">
													<div class="basic_label">AUD</div>
												</div> 
											</div>
											<div class="inline_field">
												...
												<span class="currencyinput">$</span>
												<div class="label_input">
													<input value="<?php echo e($coom_amt); ?>" type="hidden" name="total" value="0">
													<input value="<?php echo e($coom_amt); ?>" type="text" id="commissionClaimed" readonly="readonly">
													<div class="basic_label">AUD</div>
												</div> 
											</div>
											<div class="inline_field">
											...
											<div class="inline_field">
												...
												<span class="currencyinput">$</span>
												<div class="label_input">
													<input type="hidden" name="invoice_amount" value="<?php echo e($feepaid); ?>">
													<input value="<?php echo e($feepaid); ?>" type="text" id="netFeePaid" readonly="readonly">
													<input type="hidden" name="total" value="<?php echo e($feepaid); ?>">
													<div class="basic_label">AUD</div>
												</div>
											</div>
								...
								<div class="row">
													...
													<div class="payment_field_col <?php if($ir == 0){ ?>payment_first_step<?php }else{?>payment_field_clone<?php } ?>">
														<div class="field_col">
															<div class="label_input"><span class="currencyinput">$
																<input type="number" name="payment_amount[]" value="<?php echo e($paymentdetail->amount_rec); ?>" placeholder="" class="paymentAmount" /></span>
																<div class="basic_label">AUD</div>
															</div>
														</div>
														<div class="field_col">
															<div class="input-group">
																...
																<input type="date" name="payment_date[]" value="<?php echo e($paymentdetail->payment_date); ?>" placeholder="Received Amount" class=" form-control" />
															</div>
															<!-- <span class="span_note">Date must be in YYYY-MM-DD (2012-12-22) format.</span> -->
														</div>
														<div class="field_col">
									...
									<div class="col-lg-3">
										<div class="add_notes">
											<h4>Add Notes</h4>
											<textarea class="form-control" name="notes"><?php echo e($invoicedetail->notes); ?></textarea>
										</div>
									</div>
										...
										<div class="attachment">
											...
											<div class="invoice_attach_file">
												...
												<?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													...
													<?php if(substr($image, -4) == '.pdf' || substr($image, -4) == 'docx'): ?>
													<iframe src="https://docs.google.com/viewer?url=<?php echo e(asset('img/invoice')); ?>/<?php echo e(@$image); ?>&embedded=true" style="width:50px;height:50px;" frameborder='0' ></iframe>
													<?php else: ?>
														<img src="<?php echo e(asset('img/invoice')); ?>/<?php echo e(@$image); ?>" style="width:50px;height:50px;"/>
													<?php endif; ?>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										...
										<div class="col-lg-8">
											<div class="income_field">
												<div class="income_col">
													...
													?>
														<option data-v="<?php echo e($branch->income_sharing); ?>" <?php if($IncomeSharing && $IncomeSharing->rec_id == $branch->id){ echo 'selected'; } ?> value="<?php echo e($branch->id); ?>"><?php echo e($branch->full_name); ?></option>
													<?php } ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\invoice\edit.blade.php ENDPATH**/ ?>