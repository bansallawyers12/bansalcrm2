				...
				<tbody>
					<tr>
						<td style="text-align: left;">
                            <!--<img width="80" style="height:auto;display:block;" src="<?php echo e(URL::to('public/img/profile_imgs/')); ?>/<?php echo e($admin->profile_img); ?>" alt="Logo"/>-->
                            <img width="80" style="height:auto;display:block;" src="<?php echo e(URL::to('public/img/')); ?>/logo.png" alt="Logo"/>
						...
						<td style="text-align: right;">
                            ...
                            <p style="font-size: 15px;line-height: 21px;color: #333;font-weight: normal;margin: 10px 0px 0px;">
                                Transaction Date: <?php echo e($record_get[0]->trans_date); ?> <br/>
                                Date Entered:    <?php echo e($record_get[0]->entry_date); ?> <br/>
                                Payment Method:  <?php echo e($record_get[0]->payment_method); ?> <br/>
                                Made Out By:     <?php echo e(Auth::user()->first_name); ?><br/>
							</p>

                            <p style="font-size: 15px;line-height: 21px;color: #333;font-weight: normal;margin: 10px 0px 0px;">
                                RECEIPT NO: <?php echo e($record_get[0]->receipt_id); ?><br/>
                                Trans NO: <?php echo e($record_get[0]->trans_no); ?><br/>
                            </p>
						</td>
					</tr>
                  	...
                  	<tr>
                        <td colspan="3">
                          <h5><u>Received From:</u>
                            ...
                            <span style="font-size: 15px;line-height: 18px;color: #333;font-weight: normal;"><?php echo e($clientname->first_name); ?></span>
                      	  	<?php } else {?>
                             <span style="font-size: 15px;line-height: 18px;color: #333;font-weight: normal;"><?php echo e($clientname->first_name); ?> (<?php echo e($clientname->dob); ?>)</span>
                                        ...
                                        <td style="padding:0px;">
                                            <table width="100%" border="0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td><?php echo e($record_get[0]->description); ?></td>
                                                        <td>$<?php echo e($record_get[0]->deposit_amount); ?></td>
                                                    </tr>
                                                  
                                                    <tr>
                                                        <td></td>
                                                      	<td style="text-align: right;">Receipt Total:</td>
                                                        <td style="border-top: 1px solid #000;">$<?php echo e($record_get[0]->deposit_amount); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
...
<?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\emails\printpreview.blade.php ENDPATH**/ ?>