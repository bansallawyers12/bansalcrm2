...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('url' => 'admin/partners/edit', 'method' => 'post', 'name'=>"edit-partner", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
						...
						<div class="card">
							<div class="card-header">
								...
								<div class="card-header-action">
									<a href="<?php echo e(route('admin.partners.index')); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-body">
													...
													<div class="form-group">
														...
														<div class="profile_upload">
															<div class="upload_content">
																<img id="output"/><?php if(@$fetchedData->profile_img != ''): ?>
														...
														<div class="show-uploded-img">
															<?php if(@$fetchedData->profile_img != ''): ?>
																<img width="70" src="<?php echo e(asset('img/profile_imgs')); ?>/<?php echo e(@$fetchedData->profile_img); ?>" class="img-avatar"/>
															<?php endif; ?>
														</div>
													...
													<div class="row">
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group">
																...
																?>
																<input type="text" class="form-control" disabled name="" value="<?php echo e(@$cat->category_name); ?>">
																<?php if($errors->has('master_category')): ?>
																	<span class="custom-error" role="alert">
																		<strong><?php echo e(@$errors->first('master_category')); ?></strong>
																	</span>
																<?php endif; ?>
															</div>
														</div>
														...
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group">
																...
																<option value="">Select a Partner Type</option>
																	<?php $__currentLoopData = $partner_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<option <?php if($clist->id == $fetchedData->partner_type){ echo 'selected'; } ?> value="<?php echo e($clist->id); ?>"><?php echo e($clist->name); ?></option>
														...
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group">
																...
																<?php echo Form::text('partner_name', @$fetchedData->partner_name, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Trading Name' )); ?>

																<?php if($errors->has('partner_name')): ?>
																	<span class="custom-error" role="alert">
																		<strong><?php echo e(@$errors->first('partner_name')); ?></strong>
																	</span>
																<?php endif; ?>
															</div>
														</div>
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group">
																...
																<?php echo Form::text('business_reg_no', @$fetchedData->business_reg_no, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter ABN' )); ?>

																<?php if($errors->has('business_reg_no')): ?>
																	<span class="custom-error" role="alert">
																		<strong><?php echo e(@$errors->first('business_reg_no')); ?></strong>
																	</span>
																<?php endif; ?>
															</div>
														</div>
															...
															<div class="form-group">
																...
																<option value="">Choose Service workflow</option>
																	<?php $__currentLoopData = \App\Models\Workflow::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		<option <?php if($wlist->id == $fetchedData->service_workflow){ echo 'selected'; } ?> value="<?php echo e($wlist->id); ?>"><?php echo e($wlist->name); ?></option>
																	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																</select>
																<?php if($errors->has('service_workflow')): ?>
																	<span class="custom-error" role="alert">
																		<strong><?php echo e(@$errors->first('service_workflow')); ?></strong>
																	</span>
																<?php endif; ?>
															</div>
														</div>
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group">
																...
																<div class="bfh-selectbox bfh-currencies" data-currency="<?php echo e(@$fetchedData->currency); ?>" data-flags="true" data-name="currency"></div>
                                                        ...
                                                        <div class="col-12 col-md-6 col-lg-6">
															<div class="form-group">
																...
																<?php echo Form::text('legal_name', @$fetchedData->legal_name, array('class' => 'form-control', 'autocomplete'=>'off','placeholder'=>'Enter Legal Name' )); ?>
													...
													<div class="form-group">
														...
														<?php
															foreach(\App\Models\Country::all() as $list){
																?>
																<option value="<?php echo e(@$list->name); ?>" <?php if($fetchedData->country == @$list->name){ echo 'selected'; } ?>><?php echo e(@$list->name); ?></option>
																<?php
															}
															?>
														</select>
										...
										<div class="accordion-body collapse show" id="contact_details" data-parent="#accordion" >
													...
													<div class="form-group">
														...
														<div class="cus_field_input">
															<div class="country_code">
																<input class="telephone" id="telephone" type="tel" name="country_code" readonly value="" >
															</div>
                                            ...
                                            <div class="partnerphonedata">
                                                ...
                                                if(count($partnerphones)>0) {
                                                    ...
                                                    <div class="col-12 col-md-12 col-lg-12">
                                                        <div class="row" id="metatag2_<?php echo e($iii); ?>">
                                                            <div class="col-3 col-md-3 col-lg-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="partner_phone_type[]" id="partner_phone_type" class="form-control">
                                                                        ...
                                                                        <option value="Personal" <?php if(@$partnerphone->partner_phone_type == "Personal"): ?> selected <?php endif; ?>>Personal</option>
                                                                        <option value="Secondary" <?php if(@$partnerphone->partner_phone_type == "Secondary"): ?> selected <?php endif; ?>>Secondary</option>
                                                                        <option value="Not In Use" <?php if(@$partnerphone->partner_phone_type == "Not In Use"): ?> selected <?php endif; ?>>Not In Use</option>
                                                                    </select>
                                                                    <?php if($errors->has('partner_phone_type')): ?>
                                                                        <span class="custom-error" role="alert">
                                                                            <strong><?php echo e(@$errors->first('partner_phone_type')); ?></strong>
                                                                        </span>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-3 col-md-3 col-lg-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="cus_field_input">
                                                                        ...
                                                                        <?php echo Form::text('partner_phone[]', $partnerphone->partner_phone, array('class' => 'form-control tel_input', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Phone')); ?>

                                                                    </div>
                                                                </div>
                                                                <input autocomplete="off" placeholder="" name="partnerphoneid[]" type="hidden" value="<?php echo e($partnerphone->id); ?>">
                                                            </div>
                                            ...
                                            <div class="partneremaildata">
                                                ...
                                                if(count($partneremails)>0) {
                                                    ...
                                                    <div class="col-12 col-md-12 col-lg-12">
                                                        <div class="row" id="metatag1_<?php echo e($ii); ?>">
                                                            <div class="col-3 col-md-3 col-lg-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="partner_email_type[]" id="partner_email_type" class="form-control">
                                                                        <option value="">Select</option>
                                                                        <option value="Personal" <?php if(@$partneremail->partner_email_type == "Personal"): ?> selected <?php endif; ?>>Personal</option>
                                                                        <option value="Secondary" <?php if(@$partneremail->partner_email_type == "Secondary"): ?> selected <?php endif; ?>>Secondary</option>
                                                                        <option value="Not In Use" <?php if(@$partneremail->partner_email_type == "Not In Use"): ?> selected <?php endif; ?>>Not In Use</option>
                                                                    </select>
                                                                    <?php if($errors->has('partner_email_type')): ?>
                                                                        <span class="custom-error" role="alert">
                                                                            <strong><?php echo e(@$errors->first('partner_email_type')); ?></strong>
                                                                        </span>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-4 col-md-4 col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control"  autocomplete="off" placeholder="" name="partner_email[]" type="text" value="<?php echo e($partneremail->partner_email); ?>">
                                                                </div>
                                                                <input autocomplete="off" placeholder="" name="partneremailid[]" type="hidden" value="<?php echo e($partneremail->id); ?>">
                                                            </div>
                                            ...
                                            <div class="row">
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<?php echo Form::text('fax', @$fetchedData->fax, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Fax' )); ?>
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<?php echo Form::text('website', @$fetchedData->website, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Website' )); ?>
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
														...
														<?php echo Form::text('level', @$fetchedData->level, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Level' )); ?>
										...
										<div class="accordion-body collapse show" id="branch" data-parent="#accordion">
                                            ...
                                            <div class="branchdata">
                                                ...
                                                if(count($branches)>0) {
                                                    ...
                                                    <div class="row" id="metatag_<?php echo e($i); ?>">
                                                        <div class="col-12 col-md-3 col-lg-3">
                                                            <div class="form-group">
                                                                <label for="bname">Name</label>
                                                                <input class="form-control" readonly autocomplete="off" placeholder="" name="branchname[]" type="text" value="<?php echo e($branch->name); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-md-3 col-lg-3">
                                                            <div class="form-group">
                                                                <label for="bemail">Email</label>
                                                                <input class="form-control" readonly autocomplete="off" placeholder="" name="branchemail[]" type="text" value="<?php echo e($branch->email); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-md-3 col-lg-3">
                                                            <div class="form-group">
                                                                <label for="bcountry">Country</label>
                                                                <input class="form-control" readonly autocomplete="off" placeholder="" name="branchcountry[]" type="text" value="<?php echo e($branch->country); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-md-2 col-lg-2">
                                                            <div class="form-group">
                                                                <label for="bcity">City</label>
                                                                <input class="form-control" readonly autocomplete="off" placeholder="" name="branchcity[]" type="text" value="<?php echo e($branch->city); ?>">
                                                            </div>
                                                                <input autocomplete="off" placeholder="" name="branchstate[]" type="hidden" value="<?php echo e($branch->state); ?>"><input autocomplete="off" placeholder="" name="branchaddress[]" type="hidden" value="<?php echo e($branch->street); ?>"><input autocomplete="off" placeholder="" name="branchzip[]" type="hidden" value="<?php echo e($branch->zip); ?>"><input autocomplete="off" placeholder="" name="branchreg[]" type="hidden" value="<?php echo e($branch->is_regional); ?>"><input autocomplete="off" placeholder="" name="branchcountry_code[]" type="hidden" value="<?php echo e($branch->country_code); ?>"><input autocomplete="off" placeholder="" name="branchphone[]" type="hidden" value="<?php echo e($branch->phone); ?>">
                                                                <input autocomplete="off" placeholder="" name="branchid[]" type="hidden" value="<?php echo e($branch->id); ?>">
                                                        </div>
                                                        <div class="col-12 col-md-1 col-lg-1">
                                                            <a href="javascript:;" dataid="<?php echo e($i); ?>" class="editbranch"><i class="fa fa-edit"></i></a>
                                                            <a href="javascript:;" dataid="<?php echo e($i); ?>" branchid="<?php echo e($branch->id); ?>" class="deletebranch"><i class="fa fa-times"></i></a>
                                                        </div>
                                                    </div>
                                                    <?php
                                                    $i++;
								...
								<div class="form-group float-right">
									...
									<?php echo Form::button('Update Partner', ['class'=>'btn btn-primary', 'onClick'=>'customValidate("edit-partner")' ]); ?>
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<select class="form-control branch_country select2" name="branch_country" >
									...
									foreach(\App\Models\Country::all() as $list){
										?>
										<option <?php if(@$list->name == 'Australia'): ?> selected <?php endif; ?> value="<?php echo e(@$list->name); ?>"><?php echo e(@$list->name); ?></option>
										<?php
									}
									?>
								</select>
					...
					<div class="row">
                        ...
                        <div class="col-4 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<?php echo Form::text('partner_email', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Email' )); ?>
                        ...
                        <div class="col-4 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<div class="cus_field_input">
									...
									<?php echo Form::text('partner_phone', '', array('class' => 'form-control tel_input', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Phone' )); ?>

									<?php if($errors->has('partner_phone')): ?>
										<span class="custom-error" role="alert">
											<strong><?php echo e(@$errors->first('partner_phone')); ?></strong>
										</span>
									<?php endif; ?>
								</div>
							</div>
...
jQuery(document).ready(function($){
	...
	$(document).delegate('#getpartnertype','change', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getpaymenttype')); ?>',
			type:'GET',
			data:{cat_id:v},
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\partners\edit.blade.php ENDPATH**/ ?>