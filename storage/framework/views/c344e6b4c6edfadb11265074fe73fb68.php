					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
								<a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-primary">Users</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-3 col-md-3 col-lg-3">
					<div class="card author-box">
						<div class="card-body">
							...
							<span class="author-avtar" style="background: rgb(68, 182, 174);"><b><?php echo e(substr($fetchedData->first_name, 0, 1)); ?></b></span>
								<div class="clearfix"></div>
								<div class="author-box-name">
									<a href="#"><?php echo e($fetchedData->first_name); ?></a>
								</div>
								<div class="author-mail_sms"> 
									<a href="<?php echo e(URL::to('/admin/users/edit/'.base64_encode(convert_uuencode(@$fetchedData->id)))); ?>" title="Edit"><i class="fa fa-edit"></i></a>
								</div>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div class="card-body">
							<p class="clearfix"> 
								...
								<?php echo e($branch->office_name); ?> <?php if($branch->id == $fetchedData->office_id): ?>(Primary) <?php endif; ?><br>
							...
							<p class="clearfix"> 
								...
								<span class="float-right text-muted"><?php echo e($fetchedData->usertype->name); ?></span>
							</p>
							<p class="clearfix"> 
								<span class="float-left">Position:</span>
								<span class="float-right text-muted"><?php echo e($fetchedData->position); ?></span>
							</p>
							...
							<p class="clearfix">
								...
								<span class="float-right text-muted"><?php echo e($teamname); ?></span>
							</p>
										...
										<table class="table text_wrap table-2">
											...
											$branchx = \App\Models\Branch::where('id', '=', $admin->office_id)->first();
												...
												<tr id="id_<?php echo e($alist->id); ?>">
													<td><a class="" data-id="<?php echo e($alist->id); ?>" href="<?php echo e(URL::to('/admin/clients/detail')); ?>/<?php echo e(base64_encode(convert_uuencode(@$alist->id))); ?>" style="display:block;"><?php echo e($alist->first_name); ?> <?php echo e($alist->last_name); ?></a> <?php echo e($alist->email); ?></td> 
													<td><?php echo e($alist->rating); ?></td>
													<td><?php echo e($alist->dob); ?></td>
													<td>
													<?php echo e($admin->first_name); ?> <?php echo e($admin->last_name); ?>

													</td> 
													<td><?php echo e($branchx->office_name); ?></td>
								...
								<div class="tab-pane fade" id="date" role="tabpanel" aria-labelledby="date-tab">
									<div class="card-header-action" style="padding-bottom:15px;">
										<?php
												...
												?>
												<form name="usertimezone" action="<?php echo e(URL::to('admin/users/savezone')); ?>" method="POST" enctype="multipart/form-data" id="">
											<?php echo csrf_field(); ?>
											<input type="hidden" name="user_id" value="<?php echo e($fetchedData->id); ?>">
											<div class="row">
												<div class="col-12 col-md-6 col-lg-6">
													<div class="form-group">
														<select class="form-control userselect2" name="timezone">
															...
															<option <?php if($l == $fetchedData->time_zone): ?> selected <?php endif; ?> value="<?php echo e($l); ?>"><?php echo e($l); ?></option>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
														</select>
													</div>
												</div>
                                    					...
                                    					<div class="card-statistic-4">
                                    						<div class="align-items-center justify-content-between">
                                    							...
                                    							<?php	$countclients = \App\Models\Admin::where('assignee', $fetchedData->id)->where('role', 7)->count(); ?>
                                    										...
                                    										<h2 class="mb-3 font-18"><?php echo e($countclients); ?></h2>
                                    							...
                                    							<div class="row ">
                                    								<div class="col-lg-12 col-md-12">
                                    									...
                                    									?>
                                    										...
                                    										<h2 class="mb-3 font-18"><?php echo e($countleads); ?></h2>
                                    							...
                                    							<div class="row ">
                                    								<div class="col-lg-12 col-md-12">
                                    									<div class="card-content">
                                    										...
                                    										<h2 class="mb-3 font-18"><?php echo e(count($userarray)); ?></h2>
                                    											<p class="mb-0"><span class="col-green"><?php echo e(count($userarray)); ?></span> <a href="<?php echo e(URL::to('/admin/leads/?followupdate='.date('Y-m-d'))); ?>">click here</a></p>
                                    							...
                                    							<div class="row ">
                                    								<div class="col-lg-12 col-md-12">
                                    									...
                                    									?>
                                    										...
                                    										<h2 class="mb-3 font-18"><?php echo e($countconver); ?></h2>
                                    							...
                                    							<div class="row ">
                                    								<div class="col-lg-12 col-md-12">
                                    									<div class="card-content">
                                    										...
                                    										<h2 class="mb-3 font-18"><?php echo e($todaycountconver); ?></h2>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<select data-valid="required" class="form-control primary_office select2" id="primary_office" name="primary_office">
									...
									<?php $__currentLoopData = \App\Models\Branch::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($wlist->id); ?>"><?php echo e($wlist->office_name); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\users\view.blade.php ENDPATH**/ ?>