...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('url' => 'admin/subject/edit', 'name'=>"add-visatype", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?> 
													...
													<div class="form-group"> 
														...
														<select class="form-control select2" name="subjectarea">
															...
															<?php $__currentLoopData = \App\Models\SubjectArea::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<option <?php if($alist->id == $fetchedData->subject_area): ?> selected <?php endif; ?> value="<?php echo e($alist->id); ?>"><?php echo e($alist->name); ?></option>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\feature\subject\edit.blade.php ENDPATH**/ ?>