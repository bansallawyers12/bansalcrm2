...
<div class="modal fade add_interested_service custom_modal" tabindex="-1" role="dialog" aria-labelledby="create_interestModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/agent/interested-service')); ?>" name="inter_servform" autocomplete="off" id="inter_servform" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
					<div class="row">
...
<div class="modal fade custom_modal" id="create_note" tabindex="-1" role="dialog" aria-labelledby="create_noteModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/agent/create-note')); ?>" name="notetermform" autocomplete="off" id="notetermform" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
...
<div class="modal fade create_task custom_modal" id="opentaskmodal" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/agent/tasks/store/')); ?>" name="taskform" autocomplete="off" id="tasktermform" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
...
</div><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Agent\clients\addclientmodal.blade.php ENDPATH**/ ?>