					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
							    <a href="<?php echo e(route('admin.clients.index')); ?>" class="btn btn-primary">Client List</a>
							</div>
                         ...
                         <div class="filter_panel">
                            <?php //echo $encodeId;?>
                            <form action="<?php echo e(URL::to('/admin/clients/detail/'.$encodeId)); ?>" method="get">
                                <div class="row" style="padding-left: 10px;">

                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="user" class="col-form-label">Search By User</label>
                                            <?php echo Form::text('user', Request::get('user'), array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter user', 'id' => 'user' )); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::text('keyword', Request::get('keyword'), array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter any keyword', 'id' => 'keyword' )); ?>
                                    ...
                                    <div class="col-md-4" style="padding-top: 35px;">
                                        ...
                                        <a class="btn btn-info" href="<?php echo e(URL::to('/admin/clients/detail/'.$encodeId)); ?>">Reset</a>
                                    </div>
                                </div>
                            </form>
                        </div>
				...
				<div class="col-4 col-md-4 col-lg-4 left_section">
					<div class="card author-box left_section_upper">
						<div class="card-body">
							...
							<span class="author-avtar" style="background: rgb(68, 182, 174);"><b><?php echo e(substr($fetchedData->first_name, 0, 1)); ?><?php echo e(substr($fetchedData->last_name, 0, 1)); ?></b></span>
								<div class="clearfix"></div>
								<div class="author-box-name">
									<a href="#"><?php echo e($fetchedData->first_name); ?> <?php echo e($fetchedData->last_name); ?></a>
										<span style="display:block;"><?php echo e($fetchedData->client_id); ?></span>
								</div>
							<?php /*	<div class="author-rating">
                                    ...
                                    <div class="author-mail_sms">
                                      ...
                                      <a href="javascript:;" data-id="<?php echo e(@$fetchedData->id); ?>" data-email="<?php echo e(@$fetchedData->email); ?>" data-name="<?php echo e(@$fetchedData->first_name); ?> <?php echo e(@$fetchedData->last_name); ?>" class="sendmsg" title="Send Message"><i class="fas fa-comment-alt"></i></a>

                                      <a href="javascript:;" data-id="<?php echo e(@$fetchedData->id); ?>" data-email="<?php echo e(@$fetchedData->email); ?>" data-name="<?php echo e(@$fetchedData->first_name); ?> <?php echo e(@$fetchedData->last_name); ?>" class="clientemail" title="Compose Mail"><i class="fa fa-envelope"></i></a>
                                      <a href="<?php echo e(URL::to('/admin/clients/edit/'.base64_encode(convert_uuencode(@$fetchedData->id)))); ?>" title="Edit"><i class="fa fa-edit"></i></a>
                                      <?php if($fetchedData->is_archived == 0): ?>
                                          <a class="arcivedval" href="javascript:;" onclick="arcivedAction(<?php echo e($fetchedData->id); ?>, 'admins')" title="Archive"><i class="fas fa-archive"></i></a>
                                      <?php else: ?>
                                          <a class="arcivedval" style="background-color:red;" href="javascript:;" onclick="arcivedAction(<?php echo e($fetchedData->id); ?>, 'admins')" title="UnArchive"><i style="color: #fff;" class="fas fa-archive"></i></a>
                                      <?php endif; ?>

                                      <?php if($fetchedData->is_greview_mail_sent == 1): ?>
                                          <span style="display: block;color:#4caf50;">Google review invitation already Sent</span>
                                      <?php else: ?>
                                          <a class="googleReviewBtn" href="javascript:;" data-is_greview_mail_sent="<?php echo e(@$fetchedData->is_greview_mail_sent); ?>" title="Google Review"><i class="fab fa-google"></i></a>
                                      <?php endif; ?>
                                  </div>
                              
                              
									<p>
									<a  onclick="return confirm('Are you sure?')" class="badge-outline col-greenf <?php if($fetchedData->type == 'client'){ echo 'active'; } ?>" href="<?php echo e(URL::to('/admin/clients/changetype/'.base64_encode(convert_uuencode($fetchedData->id)).'/client')); ?>">Client</a>
								    <a  onclick="return confirm('Are you sure?')" href="<?php echo e(URL::to('/admin/clients/changetype/'.base64_encode(convert_uuencode($fetchedData->id)).'/lead')); ?>" class="badge-outline col-greenf <?php if($fetchedData->type == 'lead'){ echo 'active'; } ?>">Lead</a>
								...
								<input id=&quot;assign_client_id&quot;  type=&quot;hidden&quot; value=&quot;<?php echo e(base64_encode(convert_uuencode(@$fetchedData->id))); ?>&quot;>
									...
									if($agent){
										...
										<div class="client_assign client_info_tags">
																...
																<div class="client_info">
																	<div class="cl_logo"><?php echo e(substr(@$agent->full_name, 0, 1)); ?></div>
																	<div class="cl_name">
																		<span class="name"><?php echo e(@$agent->full_name); ?></span>
																		<span class="email"><?php echo e(@$agent->email); ?></span>
																	</div>
																</div>
																<?php else: ?>
																	-
					...
					<div class="card left_section_lower">
						...
						<div class="card-body">
							...
							<p class="clearfix">
								...
								<span class="float-right text-muted"><?php echo e($fetchedData->visa_type); ?>
                            ...
                            <?php if( isset($fetchedData->email_verified_at) && $fetchedData->email_verified_at != "" ){ ?>
                                <p class="clearfix">
                                    ...
                                    <span class="float-right text-muted"><?php echo e(date('d/m/Y',strtotime($fetchedData->email_verified_at))); ?></span>
                                </p>
                            <?php } ?>

							<p class="clearfix">
								<span class="float-left">City:</span>
								<span class="float-right text-muted"><?php echo e($fetchedData->city); ?></span>
							</p>
							<p class="clearfix">
								<span class="float-left">Nominated Occupation:</span>
								<span class="float-right text-muted"><?php echo e($fetchedData->nomi_occupation); ?></span>
							</p>
							<p class="clearfix">
								<span class="float-left">Highest Qualification in Australia:</span>
								<span class="float-right text-muted"><?php echo e($fetchedData->high_quali_aus); ?></span>
							</p>
							<p class="clearfix">
								<span class="float-left">Highest Qualification Overseas:</span>
								<span class="float-right text-muted"><?php echo e($fetchedData->high_quali_overseas); ?></span>
							</p>
							<p class="clearfix">
								<span class="float-left">Work experience Australia:</span>
								<span class="float-right text-muted"><?php echo e($fetchedData->relevant_work_exp_aus); ?></span>
							</p>
								<p class="clearfix">
								<span class="float-left">Work experience Offshore:</span>
								<span class="float-right text-muted"><?php echo e($fetchedData->relevant_work_exp_over); ?></span>
							</p>
							<p class="clearfix">
								...
								?>
								<span class="float-right text-muted"><?php echo e(isset($fetchedData->married_partner) ? $fetchedData->married_partner : ''); ?>
							...
							<p class="clearfix">
								...
								<span class="float-right text-muted"><?php if($fetchedData->preferredIntake != ''){ ?><?php echo e(date('M Y', strtotime($fetchedData->preferredIntake))); ?><?php } ?></span>
							</p>
							 <p class="clearfix">
								<span class="float-left">Naati/PY</span>
								<span class="float-right text-muted"><?php if($fetchedData->naati_py != ''){ ?><?php echo e($fetchedData->naati_py); ?><?php } ?></span>
							</p>
							<div class="clearfix">
							...
							<div class="client_added client_info_tags">
								...
								<?php if($addedby): ?>
								<div class="client_info">
									<div class="cl_logo"><?php echo e(substr(@$addedby->first_name, 0, 1)); ?></div>
									<div class="cl_name">
										<span class="name"><?php echo e(@$addedby->first_name); ?></span>
										<span class="email"><?php echo e(@$addedby->email); ?></span>
									</div>
								</div>
								<?php else: ?>
									-
							...
							<div class="client_assign client_info_tags">
								...
								<span class="float-right text-muted">
								      <a href="javascript:;" data-id="<?php echo e($fetchedData->id); ?>" class="btn btn-primary openassigneeshow btn-sm"><i class="fa fa-plus"></i> Edit</a>
								    </span>
								    <div class="clearfix"></div>
                                ...
                                <div class="client_info">
                                    <div class="cl_logo"><?php echo e(substr(@$assignee->first_name, 0, 1)); ?></div>
                                    <div class="cl_name">
                                        <span class="name"><?php echo e(@$assignee->first_name); ?></span>
							...
							<div class="client_assign client_info_tags">
								<p class="clearfix">
                                    ...
                                    <!--<span class="float-right text-muted">
                                        <a href="javascript:;" data-id="" class="btn btn-primary serviceTaken btn-sm"><i class="fa fa-plus"></i> Add</a>
                                    </span>-->
                                </p>
                             ...
                             <div class="">
								...
								<div class="client_info">
								    <ul >
										...
										?>
											<li><a target="_blank" href="<?php echo e(URL::to('/admin/clients/detail/'.base64_encode(convert_uuencode(@$relatedclients->id)))); ?>"><?php echo e($relatedclients->first_name); ?> <?php echo e($relatedclients->last_name); ?></a></li>
										<?php } ?>
										<?php } ?>
									</ul>
								</div>
							...
							<p class="clearfix">
								...
								<span class="float-right text-muted">
									<a href="javascript:;" data-id="<?php echo e($fetchedData->id); ?>" class="btn btn-primary opentagspopup btn-sm"><i class="fa fa-plus"></i> Add</a>
								</span>
							</p>
							<p>
								<?php $tags = '';
										...
										foreach($rs as $key=>$r){
											...
											?>
												<span class="ui label ag-flex ag-align-center ag-space-between" style="display: inline-flex;">
													<span class="col-hr-1" style="font-size: 12px;"><?php echo e(@$stagd->name); ?> <!--<a href="" class="removetag" ><i class="fa fa-times"></i></a>--></span>
												</span>
											<?php
											}
										}
							...
							<div class="tab-content" id="clientContent" style="padding-top:15px;">
								<div class="tab-pane fade <?php if(!isset($_GET['tab']) ){ echo 'show active'; } ?>" id="activities" role="tabpanel" aria-labelledby="activities-tab">
									<div class="activities">
                                        ...
                                        foreach($activities as $activit){
											...
											?>
											<div class="activity" id="activity_<?php echo e($activit->id); ?>">
												<div class="activity-icon bg-primary text-white">
													<span><?php echo e(substr($admin->first_name, 0, 1)); ?></span>
												</div>
												<div class="activity-detail" style="border: 1px solid #dbdbdb;background-color: #dbdbdb;">
												    <div class="activity-head">
												    	<div class="activity-title">
															<p><b><?php echo e($admin->first_name); ?></b>  <?php echo @$activit->subject; ?></p>
                                                    	</div>

                                                     	<div class="activity-date">
                                                          <span class="text-job"><?php echo e(date('d M Y, H:i A', strtotime($activit->created_at))); ?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="right" style="float: right;margin-top: -40px;">
                                                        ...
                                                        <div class="dropdown d-inline dropdown_ellipsis_icon">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a data-id="<?php echo e($activit->id); ?>" data-href="deleteactivitylog" class="dropdown-item deleteactivitylog" href="javascript:;" >Delete</a>
                                                               <?php endif; ?>
                                                                <?php if($activit->pin == 1){ ?>
													...
													<?php if(!empty($activit->description)): ?>
                                                        <?php
                                                            $description = $activit->description;
                                                        ?>

                                                        <?php if(strpos($description, '<xml>') !== false || strpos($description, '<o:OfficeDocumentSettings>') !== false): ?>
                                                    ...
                                                    <?php if(isset($activit->task_status) && $activit->task_status == '1'): ?>
														<p style="color:#4caf50;"><b>Completed</b></p>
													<?php endif; ?>

                                                    <?php if($activit->followup_date != ''): ?>
														<p><?php echo $activit->followup_date; ?></p>
													<?php endif; ?>

                                                    <?php if($activit->task_group != ''): ?>
														<p><?php echo $activit->task_group; ?></p>
													<?php endif; ?>
												</div>
											</div>
											<?php
										...
										<table class="table text_wrap table-2">
											...
											foreach($application_data as $alist){
												...
												<tr id="id_<?php echo e($alist->id); ?>">
													<td>
                                                      <a class="openapplicationdetail" data-id="<?php echo e($alist->id); ?>" href="javascript:;" style="display:block;">
                                                        <?php echo e(@$productdetail->name); ?>


                                                        <?php if( $application_assign_count > 0 ) { ?>
                                                           <span class="countTotalActivityAction" style="background: #1f1655;padding: 0px 5px;border-radius: 50%;color: #fff;margin-left: 5px;"><?php echo e($application_assign_count); ?></span>
                                                        <?php } ?>
                                                      </a>
                                                      <small><?php echo e(@$partnerdetail->partner_name); ?> (<?php echo e(@$PartnerBranch->name); ?>)</small>
                                                    </td>
													<td><?php echo e(@$workflow->name); ?></td>
													<td><?php echo e(@$alist->stage); ?></td>
													<td>
													...
													<td>
														<div class="dropdown d-inline">
															...
															<div class="dropdown-menu">
																...
																<a class="dropdown-item has-icon" href="javascript:;" onClick="deleteAction(<?php echo e(@$alist->id); ?>, 'applications')"><i class="fas fa-trash"></i> Delete</a>
															</div>
														</div>
													</td>
									...
									?>
										<div class="interest_column">
											...
											<div class="interest_serv_info">
												<h4><?php echo e(@$workflowdetail->name); ?></h4>
												<h6><?php echo e(@$productdetail->name); ?></h6>
												<p><?php echo e(@$partnerdetail->partner_name); ?></p>
												<p><?php echo e(@$PartnerBranch->name); ?></p>
											</div>
											...
											<div class="interest_serv_date">
												<div class="date_col cus_col">
													...
													<span class="cus_value"><?php echo e($inteservice->start_date); ?></span>
												</div>
												<div class="fees_col cus_col">
													<span class="cus_label">Expected Win Date</span>
													<span class="cus_value"><?php echo e($inteservice->exp_date); ?></span>
												</div>
											</div>
											<div class="interest_serv_row">
												<div class="serv_user_data">
													...
													<div class="serv_user_info">
														<span class="serv_name"><?php echo e($admin->first_name); ?></span>
														<span class="serv_create"><?php echo e(date('Y-m-d', strtotime($inteservice->exp_date))); ?></span>
													</div>
												</div>
												<div class="serv_user_action">
													<a href="javascript:;" data-id="<?php echo e($inteservice->id); ?>" class="btn btn-primary interest_service_view">View</a>
													<div class="dropdown d-inline dropdown_ellipsis_icon" style="margin-left:10px;">
														<a class="dropdown-toggle" type="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
														<?php if($inteservice->status == 0){ ?>
															<a class="dropdown-item converttoapplication" data-id="<?php echo e($inteservice->id); ?>" href="javascript:;">Create Appliation</a>
														<?php } ?>
															<a data-id="<?php echo e($inteservice->id); ?>" data-href="deleteservices" class="dropdown-item deletenote" href="javascript:;">Delete</a>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="tab-pane fade" id="documents" role="tabpanel" aria-labelledby="documents-tab">
									...
									<div class="list_data col-6 col-md-6 col-lg-6" style="display:inline-block;vertical-align: top;">
										...
										?>
													<tr class="drow" id="id_<?php echo e($fetch->id); ?>">
													<td  style="white-space: initial;">
														<div data-id="<?php echo e($fetch->id); ?>" data-name="<?php echo $fetch->file_name; ?>" class="doc-row">
													...
													<td>
														<div class="dropdown d-inline">
															...
															<div class="dropdown-menu">
																...
																<a target="_blank" class="dropdown-item" href="<?php echo e(asset('img/documents')); ?>/<?php echo $fetch->myfile; ?>">Preview</a>
																<?php
																$explodeimg = explode('.',$fetch->myfile);
                                          						if($explodeimg[1] == 'jpg'|| $explodeimg[1] == 'png'|| $explodeimg[1] == 'jpeg'){
																?>
																	<a target="_blank" class="dropdown-item" href="<?php echo e(URL::to('/admin/document/download/pdf')); ?>/<?php echo $fetch->id; ?>">PDF</a>
																	<?php } ?>
																<a download class="dropdown-item" href="<?php echo e(asset('img/documents')); ?>/<?php echo $fetch->myfile; ?>">Download</a>
																<a data-id="<?php echo e($fetch->id); ?>" class="dropdown-item deletenote" data-href="deletedocs" href="javascript:;">Delete</a>
															</div>
														</div>
													</td>
												</tr>
                                                                ...
                                                                {?>
                                                                    <div class="allupload_document" style="display:inline-block;">
                                                                        <form method="POST" enctype="multipart/form-data" id="upload_form_<?php echo $fetch->id;?>">
                                                                            <?php echo csrf_field(); ?>
                                                                            <input type="hidden" name="clientid" value="<?php echo e($fetchedData->id); ?>">
                                                                            <input type="hidden" name="fileid" value="<?php echo e($fetch->id); ?>">
                                                                            <input type="hidden" name="type" value="client">
                                                                ...
                                                                { ?>
                                                                    <div class="dropdown d-inline">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            <a data-id="<?php echo e($fetch->id); ?>" class="dropdown-item deletenote" data-href="deletealldocs" href="javascript:;">Delete</a>
                                                                            <?php } ?>
                                                                            <a data-id="<?php echo e($fetch->id); ?>" class="dropdown-item verifydoc" data-doctype="documents" data-href="verifydoc" href="javascript:;">Verify</a>
                                                                            <a data-id="<?php echo e($fetch->id); ?>" class="dropdown-item notuseddoc" data-doctype="documents" data-href="notuseddoc" href="javascript:;">Not Used</a>
                                                                        </div>
                                                                    </div>
                                                                <?php
                                                                }?>
                                                            ...
                                                            <td>
                                                                <div class="dropdown d-inline">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        <a data-id="<?php echo e($fetch->id); ?>" class="dropdown-item backtodoc" data-doctype="documents" data-href="backtodoc" href="javascript:;">Back To Document</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
								...
								<div class="tab-pane fade" id="noteterm" role="tabpanel" aria-labelledby="noteterm-tab">
									...
									?>
										<div class="note_col" id="note_id_<?php echo e($list->id); ?>">
                                            <div class="note_content">
											    <h4><a <?php if($color){ ?>style="color: #fff!important;"<?php } ?> class="viewnote" data-id="<?php echo e($list->id); ?>" href="javascript:;"><?php echo e(@$list->title == "" ? config('constants.empty') : str_limit(@$list->title, '19', '...')); ?></a></h4>
											<?php if($list->pin == 1){
									?><div class="pined_note"><i class="fa fa-thumbtack"></i></i></div><?php } ?>
											...
											<div class="extra_content">
                                                ...
                                                <?php if( isset($list->mobile_number) && $list->mobile_number != ""){ ?>
                                                    <p><?php echo e(@$list->mobile_number); ?></p>
                                                <?php }?>

												<div class="left">
													<div class="author">
														<a href="<?php echo e(URL::to('/admin/users/view/'.$admin->id)); ?>"><?php echo e(substr($admin->first_name, 0, 1)); ?></a>
													</div>
													<div class="note_modify">
														<small>Last Modified <span><?php echo e(date('d/m/Y h:i A', strtotime($list->updated_at))); ?></span></small>
												...
												<div class="right">
													<div class="dropdown d-inline dropdown_ellipsis_icon">
														<a class="dropdown-toggle" type="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a class="dropdown-item opennoteform" data-id="<?php echo e($list->id); ?>" href="javascript:;">Edit</a>
                                                            <?php if(Auth::user()->role == 1): ?>
															<a data-id="<?php echo e($list->id); ?>" data-href="deletenote" class="dropdown-item deletenote" href="javascript:;" >Delete</a>
                                                            <?php endif; ?>
															<?php if($list->pin == 1){
                                                            ?>
								...
								<div class="tab-pane fade" id="quotations" role="tabpanel" aria-labelledby="quotations-tab">
									<div class="card-header-action text-right" style="padding-bottom:15px;">
										<a href="<?php echo e(URL::to('/admin/quotations/client/create/'.$fetchedData->id)); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
									</div>
									...
									foreach($getq as $q){
										...
										$totfare += $exgrw;
												...
												<?php } ?>
													...
													<td><?php echo e(number_format($totfare,2,'.','')); ?> <?php echo e($qlist->currency); ?></td>
													<td><?php echo e($qlist->due_date); ?></td>
													<td><?php echo e(date('Y-m-d', strtotime($qlist->created_at))); ?></td>
													<td><?php echo e($createdby->first_name); ?></td>
													<td>
														<div class="dropdown d-inline">
															<button class="btn btn-primary dropdown-toggle" type="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
														<div class="dropdown-menu">
															<a class="dropdown-item has-icon clientemail" href="javascript:;" data-q-id="<?php echo e(@$qlist->id); ?>" data-id="<?php echo e(@$client->id); ?>" data-email="<?php echo e(@$client->email); ?>" data-name="<?php echo e(@$client->first_name); ?> <?php echo e(@$client->last_name); ?>">Send Email</a>
															<?php if($qlist->status == 0){?>
															<a class="dropdown-item has-icon ifdeclined" onClick="approveAction(<?php echo e(@$qlist->id); ?>, 'quotations')" href="javascript:;"><i class="far fa-mail"></i> Approve</a>
															<a class="dropdown-item has-icon ifdeclined" onClick="declineAction(<?php echo e(@$qlist->id); ?>, 'quotations')" href="javascript:;"><i class="far fa-mail"></i> Decline</a>
															<?php } ?>
															<a class="dropdown-item has-icon" href="javascript:;" onClick="archiveAction(<?php echo e(@$qlist->id); ?>, 'quotations')">Archive</a>
														</div>
														</div>
													</td>
												</tr>
									...
									<div class="table-responsive">
                                            ...
                                            <tbody class="productitemList">
                                                ...
                                                <tr  id="TrRow_<?php echo $rec_val->id;?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a target="_blank" class="link-primary" href="<?php echo e(URL::to('/admin/clients/printpreview')); ?>/<?php echo e($rec_val->id); ?>"><i class="fa fa-print" aria-hidden="true"></i></a>
                                                       <?php
										...
										<table class="table invoicetable text_wrap">
											...
											<tbody class="tdata invoicedatalist">
												...
												?>
												<tr id="iid_<?php echo e($invoicelist->id); ?>">
													<td><?php echo e($invoicelist->id); ?></td>
													<td><?php echo e($invoicelist->invoice_date); ?>
													...
													<span title="<?php echo e($rtype); ?>" class="ui label zippyLabel"><?php echo e($rtype); ?></span></td>
													<td><?php echo e(@$workflowdaa->name); ?><br><?php echo e(@$partnerdata->partner_name); ?></td>
													<td>AUD <?php echo e($invoicelist->net_fee_rec); ?></td>
													<td><?php echo e($invoicelist->discount); ?></td>
													<td>-</td>
													<td>
													...
													<td>
														<div class="dropdown d-inline">
															...
															<div class="dropdown-menu">
																...
																<a target="_blank" class="dropdown-item has-icon" href="<?php echo e(URL::to('admin/invoice/view/')); ?>/<?php echo e($invoicelist->id); ?>">View</a>
																<?php if($invoicelist->status == 0){ ?>
																<a target="_blank" class="dropdown-item has-icon" href="<?php echo e(URL::to('admin/invoice/edit/')); ?>/<?php echo e($invoicelist->id); ?>">Edit</a>
																<a data-netamount="<?php echo e($netamount); ?>" data-dueamount="<?php echo e($totaldue); ?>" data-invoiceid="<?php echo e($invoicelist->id); ?>" class="dropdown-item has-icon addpaymentmodal" href="javascript:;"> Make Payment</a>
																<?php } ?>
															</div>
														</div>
													</td>
											...
											?>
												<div class="conversation_list" style="max-height: 200px;overflow-y: auto;overflow-x: hidden;margin-bottom: 10px;border-bottom: 1px solid rgba(34, 36, 38, .15);">
													<div class="conversa_item">
														<div class="ds_flex">
															<div class="title">
																<span><?php echo e(@$mailreport->subject); ?></span>
															</div>
															<div class="conver_action">
																<div class="date">
																	<span><?php echo e(date('h:i A', strtotime(@$mailreport->created_at))); ?></span>
																</div>
														...
														<div class="email_info">
															<div class="avatar_img">
																<span><?php echo e(substr(@$mailreport->from_mail, 0, 1)); ?></span>
															</div>
															<div class="email_content">
																<span class="email_label">Sent by:</span>
																<span class="email_sentby"><strong><?php echo e(@$mailreport->from_mail); ?></strong> </span>
																<span class="label success">Delivered</span>
																<span class="span_desc">
																	<span class="email_label">Sent To</span>
																	<span class="email_sentby"><i class="fa fa-angle-left"></i><?php echo e(@$mailreport->to_mail); ?><i class="fa fa-angle-right"></i></span>
																</span>
															</div>
														</div>
														<div class="divider"></div>
														<div class="email_desc">
														 <?php if(@$mailreport->attachments != ''): ?>
														 <?php
										...
										<div class="tab-pane fade  show active" id="sent" role="tabpanel" aria-labelledby="sent-tab" style="/*max-height: 1443px;*/overflow-y: auto;overflow-x: hidden;">
													...
													<div class="conversa_item">
														<div class="ds_flex">
															...
															<div class="conver_action">
																...
																<div class="conver_link">
																	<a datamailid="<?php echo e($mailreport->id); ?>" datasubject="<?php echo e($subject); ?>" class="create_note" datatype="mailnote" href="javascript:;" ><i class="fas fa-file-alt"></i></a>
																	<a datamailid="<?php echo e($mailreport->id); ?>" datasubject="<?php echo e($subject); ?>" href="javascript:;" class="opentaskmodal"><i class="fas fa-shopping-bag"></i></a>
																</div>
															</div>
														</div>
														<div class="email_info">
															...
															<div class="email_content">
																<span class="email_label">Sent by:</span>
																<span class="email_sentby"><strong><?php echo e(@$admin->first_name); ?></strong> [<?php echo e($mailreport->from_mail); ?>]</span>
																<span class="label success">Delivered</span>
																<span class="span_desc">
																	<span class="email_label">Sent To</span>
																	<span class="email_sentby"><i class="fa fa-angle-left"></i><?php echo e($client->email); ?><i class="fa fa-angle-right"></i></span>
																</span>
															</div>
														</div>
														<div class="divider"></div>
														<div class="email_desc">
														 ...
														 ?>
														    <div class="attachments">
														        <ul style="list-style: none;">
											<?php $__currentLoopData = $decodeatta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attaa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<li style="display:inline-block;padding: 0px 11px;
												border-radius: 4px;
												box-shadow: 0 3px 8px 0 rgb(0 0 0 / 8%), 0 1px 2px 0 rgb(0 0 0 / 10%);"><a href="<?php echo asset('checklists/'.$attaa->file_url); ?>" target="_blank"><?php echo e($attaa->file_name); ?></a></li>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</ul>
														    </div>
														    	<?php } ?>
											<?php endif; ?>
														...
														<div class="email_attachment">
															...
															<div class="attach_file_list">
																<div class="attach_col">
																	<a href="<?php echo e(URL::to('admin/payment/view/')); ?>/<?php echo e(base64_encode(convert_uuencode(@$invpayment->id))); ?>">receipt_<?php echo e($invpayment->id); ?>.pdf</a>
																</div>
															</div>
														</div>
														<?php } ?>
										...
										<table id="my-datatable" class="table-2 table text_wrap">
											...
											foreach(\App\Models\Task::where('client_id', $fetchedData->id)->orderby('created_at','Desc')->get() as $alist){
												...
												<tr class="opentaskview" style="cursor:pointer;" id="<?php echo e($alist->id); ?>">
													...
													<td><b><?php echo e($alist->category); ?></b>: <?php echo e($alist->title); ?></td>
													...
													<td><?php echo e($alist->priority); ?></td>
													<td><i class="fa fa-clock"></i> <?php echo e($alist->due_date); ?> <?php echo e($alist->due_time); ?></td>
													<td><?php
													if($alist->status == 1){
										...
										<div class="row">
											<div class="col-md-5">
												<div class="title_desc">
													<h6><?php echo e(@$edulist->degree_title); ?></h6>
													<p><?php echo e(@$edulist->institution); ?></p>
												</div>
											</div>
											<div class="col-md-7">
												<div class="education_info">
													...
													<div class="edu_score"><span>Score: <?php echo e(@$edulist->score); ?> <?php echo e(@$edulist->ac_score); ?> </span></div>
													<div class="edu_study_area">
														<span><?php echo e(@$edulist->degree_level); ?></span>
														<span><?php echo e(@$subjectareadetail->name); ?></span>
														<span><?php echo e(@$subjectdetail->name); ?></span>
													</div>
												</div>
								...
								<div class="tab-pane fade" id="checkinlogs" role="tabpanel" aria-labelledby="checkinlogs-tab">
									<div class="table-responsive">
										<table class="table text_wrap">
											...
											?>
												<tr did="<?php echo e(@$checkin->id); ?>" id="id_<?php echo e($checkin->id); ?>">
													<td><a id="<?php echo e(@$checkin->id); ?>" href="javascript:;" class="opencheckindetail">#<?php echo e($checkin->id); ?></a></td>
													<td><?php echo e(date('l',strtotime($checkin->date))); ?><br><?php echo e($checkin->date); ?></td>
													...
													<td><?php echo e($checkin->attend_time); ?></td>
													<td><?php echo e($checkin->visit_purpose); ?></td>
													<td>
													<?php
								...
								<div class="tab-pane fade" id="prevvisa" role="tabpanel" aria-labelledby="prevvisa-tab">
									<div class="agreement_info">
										...
										<form method="post"  action="<?php echo e(URL::to('/admin/saveprevvisa')); ?>" autocomplete="off" name="saveprevvisa" id="saveprevvisa" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										<?php
										$prev_visa = array();
										...
										<?php if(empty($prev_visa)): ?>
									<div class="multiplevisa">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label for="contract_expiry">Visa</label>
													<?php echo Form::text('prev_visa[name][]', '', array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Visa' )); ?>
												...
												<div class="col-md-4">
													...
													<?php echo Form::text('prev_visa[place][]', '', array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Place of Apply' )); ?>
												...
												<div class="col-md-4 lastfiledcol">
													...
													<?php echo Form::text('prev_visa[person][]', '', array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Person who applies' )); ?>
											...
											<?php else: ?>
											<?php $visai = 0; ?>
												<?php $__currentLoopData = $prev_visa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<div class="multiplevisa">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label for="contract_expiry">Visa</label>
													<?php echo Form::text('prev_visa[name][]', @$prev->name, array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Visa' )); ?>
												...
												<div class="col-md-4">
													...
													<input type="date" name="prev_visa[start_date][]" data-valid="required" class="form-control visadatesse" autocomplete="off" value="<?php echo e(@$prev->start_date); ?>" placeholder="">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
													...
													<input type="date" name="prev_visa[end_date][]" data-valid="required" class="form-control visadatesse" autocomplete="off" value="<?php echo e(@$prev->end_date); ?>" placeholder="">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label for="place_apply">Place of Apply</label>
													<?php echo Form::text('prev_visa[place][]', @$prev->place, array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Place of Apply' )); ?>
												...
												<div class="col-md-4 lastfiledcol">
													<div class="form-group">
														<label for="person_applies">Person who applies</label>
													<?php echo Form::text('prev_visa[person][]', @$prev->person, array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Person who applies' )); ?>
								...
								<div class="tab-pane fade" id="clientinfoform" role="tabpanel" aria-labelledby="clientinfoform-tab">
									<div class="agreement_info">
										...
										<div class="tab-content " id="clientContent" style="padding-top:15px;">
											...
											<form method="post"  action="<?php echo e(URL::to('/admin/saveonlineprimaryform')); ?>" autocomplete="off" name="saveonlineprimaryform" id="saveonlineprimaryform" enctype="multipart/form-data">
											<?php echo csrf_field(); ?>
											<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
											...
											<div class="row">
												<div class="col-md-12">
													...
													<?php echo Form::text('info_name', @$primarydetail->info_name, array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Name' )); ?>
												...
												<div class="col-md-12">
													...
													<?php echo Form::text('mobile', @$primarydetail->mobile, array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Mobile' )); ?>
												...
												<div class="col-md-12">
													...
													<?php echo Form::text('curr_address', @$primarydetail->curr_address, array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Current Address' )); ?>
												...
												<div class="col-md-12">
													...
													<?php echo Form::text('email', @$primarydetail->email, array('class' => 'form-control ', 'data-valid'=>'required email', 'autocomplete'=>'off','placeholder'=>'Email' )); ?>
													...
													<div class="row">
														<div class="col-md-6" style="border-right:1px solid #98a6ad;">
															<div class="form-group">
																...
																<?php echo Form::text('parent_name', @$primarydetail->parent_name, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
															...
															<div class="form-group">
																...
																<?php echo Form::text('parent_dob', $parent_dob, array('class' => 'form-control dobdatepickers', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

															</div>
															<div class="form-group">
																<label for="parent_occ">Occupation</label>
																<?php echo Form::text('parent_occ', @$primarydetail->parent_occ, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

															</div>
															<div class="form-group">
																<label for="parent_country">Country of Residence</label>
																<?php echo Form::text('parent_country', @$primarydetail->parent_country, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
														...
														<div class="col-md-6">
															<div class="form-group">
																...
																<?php echo Form::text('parent_name_2', @$primarydetail->parent_name_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
															...
															<div class="form-group">
																...
																<?php echo Form::text('parent_dob_2', $parent_dob_2, array('class' => 'form-control dobdatepickers', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

															</div>
															<div class="form-group">
																<label for="parent_occ_2">Occupation</label>
																<?php echo Form::text('parent_occ_2', @$primarydetail->parent_occ_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

															</div>
															<div class="form-group">
																<label for="parent_country_2">Country of Residence</label>
																<?php echo Form::text('parent_country_2', @$primarydetail->parent_country_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
											...
											<div class="row">
												<div class="col-md-6" style="border-right:1px solid #98a6ad;">
													<div class="form-group">
														...
														<?php echo Form::text('sibling_name', @$primarydetail->sibling_name, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
													...
													<div class="form-group">
														...
														<?php echo Form::text('sibling_dob', $sibling_dob, array('class' => 'form-control dobdatepickers', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_occ">Occupation</label>
														<?php echo Form::text('sibling_occ', @$primarydetail->sibling_occ, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_gender">Gender</label>
														<?php echo Form::text('sibling_gender', @$primarydetail->sibling_gender, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_country">Country of Residence</label>
														<?php echo Form::text('sibling_country', @$primarydetail->sibling_country, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_marital">Marital Status</label>
														<?php echo Form::text('sibling_marital', @$primarydetail->sibling_marital, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<?php echo Form::text('sibling_name_2', @$primarydetail->sibling_name_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
													...
													<div class="form-group">
														...
														<?php echo Form::text('sibling_dob_2', $sibling_dob_2, array('class' => 'form-control dobdatepickers', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_occ_2">Occupation</label>
														<?php echo Form::text('sibling_occ_2', @$primarydetail->sibling_occ_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_gender_2">Gender</label>
														<?php echo Form::text('sibling_gender_2', @$primarydetail->sibling_gender_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_country_2">Country of Residence</label>
														<?php echo Form::text('sibling_country_2', @$primarydetail->sibling_country_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_marital_2">Marital Status</label>
														<?php echo Form::text('sibling_marital_2', @$primarydetail->sibling_marital_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												...
												<textarea class="form-control" name="held_visa"><?php echo e(@$primarydetail->held_visa); ?></textarea>
											</div>
										</div>
										<div class="col-md-12">
											...
											<div class="form-group">
												...
												<textarea class="form-control" name="visa_refused"><?php echo e(@$primarydetail->visa_refused); ?></textarea>
											</div>
										</div>
										<div class="col-md-12">
											...
											<div class="form-group">
												...
												<textarea class="form-control" name="traveled"><?php echo e(@$primarydetail->traveled); ?></textarea>
											</div>
										</div>
										<div class="col-12 col-md-12 col-lg-12">
											<div class="form-group float-right">
									...
									<form method="post"  action="<?php echo e(URL::to('/admin/saveonlinesecform')); ?>" autocomplete="off" name="saveonlinesecform" id="saveonlinesecform" enctype="multipart/form-data">
									<?php echo csrf_field(); ?>
									<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label for="contract_expiry">Name</label>
											<?php echo Form::text('info_name', @$secdetail->info_name, array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Name' )); ?>
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<label for="mobile">Mobile</label>
											<?php echo Form::text('mobile', @$secdetail->mobile, array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Mobile' )); ?>
										...
										<div class="col-md-12">
											<div class="form-group">
												<label for="curr_address">Current Address</label>
											<?php echo Form::text('curr_address', @$secdetail->curr_address, array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Current Address' )); ?>
										...
										<div class="col-md-12">
											<div class="form-group">
												<label for="email">Email</label>
											<?php echo Form::text('email', @$secdetail->email, array('class' => 'form-control ', 'data-valid'=>'required email', 'autocomplete'=>'off','placeholder'=>'Email' )); ?>
										...
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-6" style="border-right:1px solid #98a6ad;">
													<div class="form-group">
														<label for="parent_name">Name</label>
														<?php echo Form::text('parent_name', @$secdetail->parent_name, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
													...
													<div class="form-group">
														<label for="parent_occ">Occupation</label>
														<?php echo Form::text('parent_occ', @$secdetail->parent_occ, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="parent_country">Country of Residence</label>
														<?php echo Form::text('parent_country', @$secdetail->parent_country, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="parent_name_2">Name</label>
														<?php echo Form::text('parent_name_2', @$secdetail->parent_name_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
													...
													<div class="form-group">
														<label for="parent_occ_2">Occupation</label>
														<?php echo Form::text('parent_occ_2', @$secdetail->parent_occ_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="parent_country_2">Country of Residence</label>
														<?php echo Form::text('parent_country_2', @$secdetail->parent_country_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
										...
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-6" style="border-right:1px solid #98a6ad;">
													<div class="form-group">
														<label for="sibling_name">Name</label>
														<?php echo Form::text('sibling_name', @$secdetail->sibling_name, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
													...
													<div class="form-group">
														<label for="sibling_occ">Occupation</label>
														<?php echo Form::text('sibling_occ', @$secdetail->sibling_occ, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_gender">Gender</label>
														<?php echo Form::text('sibling_gender', @$secdetail->sibling_gender, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_country">Country of Residence</label>
														<?php echo Form::text('sibling_country', @$secdetail->sibling_country, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_marital">Marital Status</label>
														<?php echo Form::text('sibling_marital', @$secdetail->sibling_marital, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="sibling_name_2">Name</label>
														<?php echo Form::text('sibling_name_2', @$secdetail->sibling_name_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
													...
													<div class="form-group">
														<label for="sibling_occ_2">Occupation</label>
														<?php echo Form::text('sibling_occ_2', @$secdetail->sibling_occ_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_gender_2">Gender</label>
														<?php echo Form::text('sibling_gender_2', @$secdetail->sibling_gender_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_country_2">Country of Residence</label>
														<?php echo Form::text('sibling_country_2', @$secdetail->sibling_country_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_marital_2">Marital Status</label>
														<?php echo Form::text('sibling_marital_2', @$secdetail->sibling_marital_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<label for="held_visa">If Yes Mention Visa Subclass, Country Name, Year (all current and previous)</label>
												<label for="held_visa">If no Mention "No"</label>
												<textarea class="form-control" name="held_visa"><?php echo e(@$secdetail->held_visa); ?></textarea>
											</div>
										</div>
										<div class="col-md-12">
											<h5>Do you have any visa refused (Australia or any other country)</h5>
											<div class="form-group">
												<label for="visa_refused">If Yes Mention Visa Subclass, Country Name, Year (all visa refusals)</label>
												<label for="visa_refused">If no Mention "No"</label>
												<textarea class="form-control" name="visa_refused"><?php echo e(@$secdetail->visa_refused); ?></textarea>
											</div>
										</div>
										<div class="col-md-12">
											<h5>Have you travelled to any other country including Australia in last 10 years</h5>
											<div class="form-group">
												<label for="traveled">If Yes Mention Visa Subclass, Country Name, Departure Date, Arrival Date, type of visa</label>
												<textarea class="form-control" name="traveled"><?php echo e(@$secdetail->traveled); ?></textarea>
											</div>
										</div>
										<div class="col-12 col-md-12 col-lg-12">
											<div class="form-group float-right">
									...
									<form method="post"  action="<?php echo e(URL::to('/admin/saveonlinechildform')); ?>" autocomplete="off" name="saveonlinechildform" id="saveonlinechildform" enctype="multipart/form-data">
									<?php echo csrf_field(); ?>
									<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label for="contract_expiry">Name</label>
											<?php echo Form::text('info_name', @$childdetail->info_name, array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Name' )); ?>
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<label for="mobile">Mobile</label>
											<?php echo Form::text('mobile', @$childdetail->mobile, array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Mobile' )); ?>
										...
										<div class="col-md-12">
											<div class="form-group">
												<label for="curr_address">Current Address</label>
											<?php echo Form::text('curr_address', @$childdetail->curr_address, array('class' => 'form-control ', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Current Address' )); ?>
										...
										<div class="col-md-12">
											<div class="form-group">
												<label for="email">Email</label>
											<?php echo Form::text('email', @$childdetail->email, array('class' => 'form-control ', 'data-valid'=>'required email', 'autocomplete'=>'off','placeholder'=>'Email' )); ?>
										...
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-6" style="border-right:1px solid #98a6ad;">
													<div class="form-group">
														<label for="parent_name">Name</label>
														<?php echo Form::text('parent_name', @$childdetail->parent_name, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
													...
													<div class="form-group">
														<label for="parent_occ">Occupation</label>
														<?php echo Form::text('parent_occ', @$childdetail->parent_occ, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="parent_country">Country of Residence</label>
														<?php echo Form::text('parent_country', @$childdetail->parent_country, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="parent_name_2">Name</label>
														<?php echo Form::text('parent_name_2', @$childdetail->parent_name_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
													...
													<div class="form-group">
														<label for="parent_occ_2">Occupation</label>
														<?php echo Form::text('parent_occ_2', @$childdetail->parent_occ_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="parent_country_2">Country of Residence</label>
														<?php echo Form::text('parent_country_2', @$childdetail->parent_country_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
										...
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-6" style="border-right:1px solid #98a6ad;">
													<div class="form-group">
														<label for="sibling_name">Name</label>
														<?php echo Form::text('sibling_name', @$childdetail->sibling_name, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
													...
													<div class="form-group">
														<label for="sibling_occ">Occupation</label>
														<?php echo Form::text('sibling_occ', @$childdetail->sibling_occ, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_gender">Gender</label>
														<?php echo Form::text('sibling_gender', @$childdetail->sibling_gender, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_country">Country of Residence</label>
														<?php echo Form::text('sibling_country', @$childdetail->sibling_country, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_marital">Marital Status</label>
														<?php echo Form::text('sibling_marital', @$childdetail->sibling_marital, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="sibling_name_2">Name</label>
														<?php echo Form::text('sibling_name_2', @$childdetail->sibling_name_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
													...
													<div class="form-group">
														<label for="sibling_occ_2">Occupation</label>
														<?php echo Form::text('sibling_occ_2', @$childdetail->sibling_occ_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_gender_2">Gender</label>
														<?php echo Form::text('sibling_gender_2', @$childdetail->sibling_gender_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_country_2">Country of Residence</label>
														<?php echo Form::text('sibling_country_2', @$childdetail->sibling_country_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>

													</div>
													<div class="form-group">
														<label for="sibling_marital_2">Marital Status</label>
														<?php echo Form::text('sibling_marital_2', @$childdetail->sibling_marital_2, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'' )); ?>
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<label for="held_visa">If Yes Mention Visa Subclass, Country Name, Year (all current and previous)</label>
												<label for="held_visa">If no Mention "No"</label>
												<textarea class="form-control" name="held_visa"><?php echo e(@$childdetail->held_visa); ?></textarea>
											</div>
										</div>
										<div class="col-md-12">
											<h5>Do you have any visa refused (Australia or any other country)</h5>
											<div class="form-group">
												<label for="visa_refused">If Yes Mention Visa Subclass, Country Name, Year (all visa refusals)</label>
												<label for="visa_refused">If no Mention "No"</label>
												<textarea class="form-control" name="visa_refused"><?php echo e(@$childdetail->visa_refused); ?></textarea>
											</div>
										</div>
										<div class="col-md-12">
											<h5>Have you travelled to any other country including Australia in last 10 years</h5>
											<div class="form-group">
												<label for="traveled">If Yes Mention Visa Subclass, Country Name, Departure Date, Arrival Date, type of visa</label>
												<textarea class="form-control" name="traveled"><?php echo e(@$childdetail->traveled); ?></textarea>
											</div>
										</div>
										<div class="col-12 col-md-12 col-lg-12">
											<div class="form-group float-right">
...
<?php echo $__env->make('Admin/clients/addclientmodal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('Admin/clients/editclientmodal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
					...
					<div class="row">
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
                                ...
                                ?>
								<select data-valid="" class="form-control select2 selecttemplate" name="template" data-clientid="<?php echo e(@$fetchedData->id); ?>" data-clientfirstname="<?php echo e(@$fetchedData->first_name); ?>" data-clientvisaExpiry="<?php echo e(@$fetchedData->visaExpiry); ?>" data-clientreference_number="<?php echo e(@$fetchedData->client_id); ?>" data-clientassignee_name="<?php echo e(@$clientAssigneeName); ?>">
									<option value="">Select</option>
									<?php $__currentLoopData = \App\Models\CrmEmailTemplate::orderBy('id', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<?php echo Form::text('subject', '', array('id'=>'compose_email_subject','class' => 'form-control selectedsubject', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Subject' )); ?>
                                ...
                                <div class="tab-content" id="composeemailContent">
                                    <div class="tab-pane fade show active" id="composechecklist" role="tabpanel" aria-labelledby="composechecklist-tab">
                                        <div class="table-responsive uploadchecklists">
                                            ...
                                            <table id="mychecklist-datatable" class="table text_wrap table-2">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = \App\Models\UploadChecklist::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uclist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><input type="checkbox" name="checklistfile[]" value="<?php echo e($uclist->id); ?>" <?php echo e(old('checklistfile') && in_array($uclist->id, old('checklistfile', [])) ? 'checked' : ''); ?>></td>
                                                        <td style="white-space: initial;"><?php echo e($uclist->name); ?></td>
                                                        <td style="white-space: initial;"><a target="_blank" href="<?php echo e(asset('checklists/'.$uclist->file)); ?>"><?php echo e($uclist->name); ?></a></td>
                                                    </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="tab-pane fade" id="composedocument" role="tabpanel" aria-labelledby="composedocument-tab">
                                        ...
                                        <table id="mydocumentlist-datatable" class="table text_wrap table-2">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = \App\Models\Document::where('client_id',$fetchedData->id)->where('type','client')->whereIn('doc_type', ['education', 'migration', 'documents'])->whereNull('not_used_doc')->orderby('created_at', 'DESC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $composedoclist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><input type="checkbox" name="checklistfile_document[]" value="<?php echo e($composedoclist->id); ?>" <?php echo e(old('checklistfile_document') && in_array($composedoclist->id, old('checklistfile_document', [])) ? 'checked' : ''); ?>></td>
                                                    <td style="white-space: initial;"><?php echo e($composedoclist->file_name); ?></td>
                                                    <td>
                                                        <?php
                                                        $docTypes = [
                                                            'education' => 'Education',
                                                    ...
                                                    <td style="white-space: initial;">
                                                        ...
                                                        if( isset($composedoclist->doc_type) && $composedoclist->doc_type != "" )
                                                        {
                                                            if( $composedoclist->doc_type == "education" || $composedoclist->doc_type == "migration" ){ ?>
                                                                <a target="_blank" class="dropdown-item" href="<?php echo e(asset('img/documents')); ?>/<?php echo e($composedoclist->myfile); ?>"><?php echo e($composedoclist->file_name); ?></a>
                                                            <?php
                                                            }
                                                            else if( $composedoclist->doc_type == "documents")
                                                            {
                                                                ...
                                                                { ?>
                                                                    <a target="_blank" href="<?php echo $composedoclist->myfile;?>"><?php echo e($composedoclist->file_name); ?></a>
                                                                <?php
                                                                }
                                                                else
                                                                {
...
<div id="sendmsgmodal"  data-backdrop="static" data-keyboard="false" class="modal fade custom_modal" tabindex="-1" role="dialog" aria-labelledby="messageModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" name="sendmsg" id="sendmsg" action="<?php echo e(URL::to('/admin/sendmsg')); ?>" autocomplete="off" enctype="multipart/form-data">
				    <?php echo csrf_field(); ?>
...
<div class="modal fade custom_modal" id="application_opensaleforcast" tabindex="-1" role="dialog" aria-labelledby="applicationModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/application/saleforcast')); ?>" name="saleforcast" id="saleforcast" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
...
<div class="modal fade custom_modal" id="application_ownership" tabindex="-1" role="dialog" aria-labelledby="applicationModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/application/application_ownership')); ?>" name="xapplication_ownership" id="xapplication_ownership" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
...
<div class="modal fade custom_modal" id="superagent_application" tabindex="-1" role="dialog" aria-labelledby="applicationModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/application/spagent_application')); ?>" name="spagent_application" id="spagent_application" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<select data-valid="required" class="form-control super_agent" id="super_agent" name="super_agent">
									...
									<?php $__currentLoopData = $sagents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($sa->id); ?>"><?php echo e($sa->full_name); ?> <?php echo e($sa->email); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
								<span class="custom-error workflow_error" role="alert">
									<strong></strong>
...
<div class="modal fade custom_modal" id="subagent_application" tabindex="-1" role="dialog" aria-labelledby="applicationModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/application/sbagent_application')); ?>" name="sbagent_application" id="sbagent_application" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
...
<div class="modal fade custom_modal" id="tags_clients" tabindex="-1" role="dialog" aria-labelledby="applicationModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/save_tag')); ?>" name="stags_application" id="stags_application" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
								...
								<label for="super_agent">Tags <span class="span_req">*</span></label>
                                  ...
                                  <select data-valid="required" multiple  id="tag" class="tagsselec form-control super_tag" name="tag[]">
									...
									<?php //$stagd = \App\Models\Tag::where('id','!=','')->paginate(5); ?>
										...
										<!--<option <?php //if(in_array($sa->id, $r)){ echo 'selected'; } ?> value=""></option>-->
...
<div class="modal fade custom_modal" id="application_opensaleforcastservice" tabindex="-1" role="dialog" aria-labelledby="applicationModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/application/saleforcastservice')); ?>" name="saleforcastservice" id="saleforcastservice" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				<input type="hidden" name="fapp_id" id="fapp_id" value="">
					<div class="row">
						<div class="col-4 col-md-4 col-lg-4">
...
<div class="modal fade custom_modal" id="serviceTaken" tabindex="-1" role="dialog" aria-labelledby="create_interestModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
                <form method="post" action="<?php echo e(URL::to('/admin/client/createservicetaken')); ?>" name="createservicetaken" id="createservicetaken" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        document.addEventListener('click', function (e) {
            ...
            form.method = 'POST';
            form.action = '<?php echo e(url("/admin/download-document")); ?>';
            form.target = '_blank';
    ...
    if (enhanceMessageBtn) {
        enhanceMessageBtn.addEventListener('click', function() {
            ...
            fetch("<?php echo e(route('admin.mail.enhance')); ?>", {  // Use Laravel's route helper
                method: "POST",
                headers: {
...
jQuery(document).ready(function($){
    ...
    $(document).delegate('.googleReviewBtn', 'click', function(e){
	    ...
	    if(conf && is_greview_mail_sent != 1 ){
            $.ajax({
                url: '<?php echo e(URL::to('/admin/is_greview_mail_sent')); ?>',
                headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:'POST',
                datatype:'json',
                data:{id:'<?php echo e($fetchedData->id); ?>',is_greview_mail_sent:is_greview_mail_sent},
    ...
    function getTopReceiptValInDB(type) {
        $.ajax({
            type:'post',
            url: '<?php echo e(URL::to('/admin/clients/getTopReceiptValInDB')); ?>',
            sync:true,
            data: {type:type},
            success: function(response){
    ...
    $('#tag').select2({
        ajax: {
            url: '<?php echo e(URL::to('/admin/gettagdata')); ?>',
			headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            dataType: 'json',
            delay: 250,
    ...
    /*$(document).delegate('.not_picked_call', 'click', function(e){
	    ...
	    if(conf){
            ...
            $.ajax({
                url: '<?php echo e(URL::to('/admin/not-picked-call')); ?>',
                headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:'POST',
                datatype:'json',
                data:{id:'<?php echo e($fetchedData->id); ?>',not_picked_call:not_picked_call},
                success: function(response){
                    var obj = $.parseJSON(response);
    ...
    $(document).delegate('.not_picked_call', 'click', function (e) {
        var clientName = '<?php echo e($fetchedData->first_name ?? 'user'); ?>';
        clientName = clientName.charAt(0).toUpperCase() + clientName.slice(1).toLowerCase(); //alert(clientName);

        /*var loggedInUserId = '<?php echo e(Auth::user()->id); ?>';  //alert(loggedInUserId);
...
Bansal Immigration`;
    ...
    $(document).on('change', '.inperson_address', function() {
        ...
        if(id != ""){
            ...
            $.ajax({
                url:'<?php echo e(URL::to('/getdatetimebackend')); ?>',
                headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:'POST',
                ...
                success:function(res){
                    ...
                    if(obj.success){
                        ...
                        $('#datetimepicker').datepicker({
                            ...
                            $.ajax({
                                url:'<?php echo e(URL::to('/getdisableddatetime')); ?>',
                                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                                type:'POST',
    ...
    $(document).delegate('.uploadmail','click', function(){
		$('#maclient_id').val('<?php echo e($fetchedData->id); ?>');
    ...
    $(document).delegate('#assignUser','click', function(){
		...
		if(flag){
			$.ajax({
				type:'post',
					url:"<?php echo e(URL::to('/')); ?>/admin/clients/followup/store",
					headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
...
function getallnotes(){
	$.ajax({
		...
		type:'GET',
		data:{clientid:'<?php echo e($fetchedData->id); ?>',type:'client'},
		success: function(responses){
			$('.popuploader').hide();
...
function getallactivities(){
	$.ajax({
      ...
      type:'GET',
      datatype:'json',
      data:{id:'<?php echo e($fetchedData->id); ?>'},
      success: function(responses){
...
$(document).delegate('#confirmpublishdocModal .acceptpublishdoc', 'click', function(){
	$('.popuploader').show();
	$.ajax({
		url: '<?php echo e(URL::to('/admin/')); ?>/'+'application/publishdoc',
		type:'GET',
		datatype:'json',
	...
	$(document).delegate('#confirmDocModal .accept', 'click', function(){
        $('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/')); ?>/'+verify_doc_href,
			type:'POST',
			datatype:'json',
	...
	$(document).delegate('#confirmNotUseDocModal .accept', 'click', function(){
        $('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/')); ?>/'+notuse_doc_href,
			type:'POST',
			datatype:'json',
	...
	$(document).delegate('#confirmBackToDocModal .accept', 'click', function(){
        $('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/')); ?>/'+backto_doc_href,
			type:'POST',
			datatype:'json',
	...
	$(document).delegate('#confirmModal .accept', 'click', function(){
		...
		$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/')); ?>/'+delhref,
			type:'GET',
			datatype:'json',
			data:{note_id:notid},
			success:function(response){
				...
				if(res.status){
					...
					if(delhref == 'deleteservices'){
						...
						type:'GET',
						data:{clientid:'<?php echo e($fetchedData->id); ?>'},
						success: function(responses){
						...
						type:'GET',
						data:{client_id:'<?php echo e($fetchedData->id); ?>',appid:res.application_id},
						success: function(responses){
	...
	$(document).delegate('#confirmLogModal .accept', 'click', function(){
        $('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/')); ?>/'+delloghref,
			type:'GET',
			datatype:'json',
	...
	$(document).delegate('.pinnote', 'click', function(){
		$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/pinnote')); ?>/',
			type:'GET',
			datatype:'json',
    ...
    $(document).delegate('.pinactivitylog', 'click', function(){
        $('.popuploader').show();
        $.ajax({
            url: '<?php echo e(URL::to('/admin/pinactivitylog')); ?>/',
            type:'GET',
            datatype:'json',
    ...
    $('#noteType').on('change', function() {
        ...
        if(selectedValue === "Call") {
            ...
            $('.popuploader').show();
            $.ajax({
                url: "<?php echo e(URL::to('/admin/clients/fetchClientContactNo')); ?>",
                method: "POST",
...
$(document).delegate('.complete_session', 'click', function(){
    ...
    if(client_id !=""){
        $.ajax({
            type:'POST',
            url:"<?php echo e(URL::to('/')); ?>/admin/clients/update-session-completed",
            headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            data: {client_id:client_id },
            success: function(response){
  ...
  return repo.name || repo.text;
	...
	$(document).delegate('.opennoteform', 'click', function(){
		...
		$('#create_note input[name="noteid"]').val(v);
			$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getnotedetail')); ?>',
			type:'GET',
			datatype:'json',
			data:{note_id:v},
			success:function(response){
	...
	$(document).delegate('.viewnote', 'click', function(){
		...
		$('#view_note input[name="noteid"]').val(v);
			$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/viewnotedetail')); ?>',
			type:'GET',
			datatype:'json',
			data:{note_id:v},
			success:function(response){
	...
	$(document).delegate('.viewapplicationnote', 'click', function(){
		...
		$('#view_application_note input[name="noteid"]').val(v);
			$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/viewapplicationnote')); ?>',
			type:'GET',
			datatype:'json',
			data:{note_id:v},
			success:function(response){
	...
	$(document).delegate('.add_appliation #workflow', 'change', function(){
				...
				if(v != ''){
						$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getpartnerbranch')); ?>',
			type:'GET',
			data:{cat_id:v},
			success:function(response){
				$('.popuploader').hide();
	...
	$(document).delegate('.add_appliation #partner','change', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getbranchproduct')); ?>',
			type:'GET',
...
$(document).delegate('.change_client_status', 'click', function(e){
	...
	$(this).addClass('active');
	 ...
	 $.ajax({
		url: '<?php echo e(URL::to('/admin/change-client-status')); ?>',
		type:'GET',
		datatype:'json',
		data:{id:'<?php echo e($fetchedData->id); ?>',rating:v},
		success: function(response){
			var res = JSON.parse(response);
			if(res.status){
...
$(document).delegate('#intrested_workflow', 'change', function(){
				...
				if(v != ''){
						$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getpartner')); ?>',
			type:'GET',
			data:{cat_id:v},
			success:function(response){
				$('.popuploader').hide();
	...
	$(document).delegate('#intrested_partner','change', function(){
				...
				if(v != ''){
					$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getproduct')); ?>',
			type:'GET',
			data:{cat_id:v},
			success:function(response){
				$('.popuploader').hide();
	...
	$(document).delegate('#intrested_product','change', function(){
				...
				if(v != ''){
					$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getbranch')); ?>',
			type:'GET',
			data:{cat_id:v},
			success:function(response){
				$('.popuploader').hide();
  ...
  //All Document Upload
	...
	$(document).delegate('.converttoapplication','click', function(){
				...
				if(v != ''){
					$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/convertapplication')); ?>',
			type:'GET',
			data:{cat_id:v,clientid:'<?php echo e($fetchedData->id); ?>'},
			success:function(response){
...
$(document).on('click', '#application-tab', function () {
	...
	$(document).delegate('.documnetlist .drow .btn-primary', 'click', function () {
			...
			$.ajax({
			   ...
			   url: '<?php echo e(URL::to('/admin/renamedoc')); ?>',
    ...
    $(document).delegate('.alldocumnetlist .drow .btn-primary', 'click', function () {
        ...
        $.ajax({
            type: "POST",
            data: {"_token": $('meta[name="csrf-token"]').attr('content'),"filename": opentime, "id": parent.data('id')},
            url: '<?php echo e(URL::to('/admin/renamealldoc')); ?>',
            success: function(result){
                var obj = JSON.parse(result);
                if (obj.status) {
                    parent.empty()
    ...
    $(document).delegate('.alldocumnetlist .drow .btn-personalprimary', 'click', function () {
        ...
        $.ajax({
            ...
            url: '<?php echo e(URL::to('/admin/renamechecklistdoc')); ?>',
            success: function(result){
                var obj = JSON.parse(result);
                if (obj.status) {
                    parent.empty()
...
$(document).delegate('.opencreate_task', 'click', function () {
	...
	$(document).delegate('#confirmEducationModal .accepteducation', 'click', function(){
		...
		$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/')); ?>/delete-education',
			type:'GET',
			datatype:'json',
			data:{edu_id:eduid},
			success:function(response){
    ...
    $(document).delegate('#educationform #subjectlist', 'change', function(){
				...
				if(v != ''){
						$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getsubjects')); ?>',
			type:'GET',
			data:{cat_id:v},
			success:function(response){
				$('.popuploader').hide();
	...
	// 	$.ajax({
	// 		url: '<?php echo e(URL::to('/admin/getAppointmentdetail')); ?>',
	// 		type:'GET',
	// 		data:{id:v},
	// 		success:function(response){
	// 			$('.popuploader').hide();
  ...
  $(".branchselect2").select2({
	...
	$(document).delegate('.editeducation', 'click', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getEducationdetail')); ?>',
			type:'GET',
			data:{id:v},
			success:function(response){
				$('.popuploader').hide();
	...
	$(document).delegate('.interest_service_view', 'click', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getintrestedservice')); ?>',
			type:'GET',
			data:{id:v},
			success:function(response){
				$('.popuploader').hide();
	...
	$(document).delegate('.openeditservices', 'click', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getintrestedserviceedit')); ?>',
			type:'GET',
			data:{id:v},
			success:function(response){
				$('.popuploader').hide();
  ...
  $(".branchselect2").select2({
    ...
    function getClientReceiptInfoById(id) {
        $.ajax({
            type:'post',
            url: '<?php echo e(URL::to('/admin/clients/getClientReceiptInfoById')); ?>',
            sync:true,
            data: {id:id},
            success: function(response){
...
$(document).delegate('.paymentAmount','keyup', function(){
	...
	if(isset($_GET['tab']) && $_GET['tab'] == 'application' && isset($_GET['appid']) && $_GET['appid'] != ''){
		?>
		var appliid = '<?php echo e(@$_GET['appid']); ?>';
		$('.if_applicationdetail').hide();
		$('.ifapplicationdetailnot').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getapplicationdetail')); ?>',
			type:'GET',
			data:{id:appliid},
			success:function(response){
				$('.popuploader').hide();
				...
				locale: { format: "YYYY-MM-DD",cancelLabel: 'Clear' },
					...
					$('#popuploader').show();
					$.ajax({
						url:"<?php echo e(URL::to('/admin/application/updateintake')); ?>",
						method: "GET", // or POST
						dataType: "json",
				...
				locale: { format: "YYYY-MM-DD",cancelLabel: 'Clear' },
					...
					$('#popuploader').show();
					$.ajax({
						url:"<?php echo e(URL::to('/admin/application/updateexpectwin')); ?>",
						method: "GET", // or POST
						dataType: "json",
						data: {from: start.format('YYYY-MM-DD'), appid: appliid},
						success:function(result) {
				...
				locale: { format: "YYYY-MM-DD",cancelLabel: 'Clear' },
					...
					$('#popuploader').show();
					$.ajax({
						url:"<?php echo e(URL::to('/admin/application/updatedates')); ?>",
						method: "GET", // or POST
						dataType: "json",
...
$(document).delegate('.openpaymentschedule', 'click', function(){
	...
	$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/addscheduleinvoicedetail')); ?>',
			type: 'GET',
...
$(document).delegate('.nextstage', 'click', function(){
	...
	$('.popuploader').show();
	$.ajax({
		url: '<?php echo e(URL::to('/admin/updatestage')); ?>',
		type:'GET',
		datatype:'json',
		data:{id:appliid, client_id:'<?php echo e($fetchedData->id); ?>'},
		success:function(response){
			$('.popuploader').hide();
			var obj = $.parseJSON(response);
			if(obj.status){
				...
				$.ajax({
					url: site_url+'/admin/get-applications-logs',
					type:'GET',
					data:{clientid:'<?php echo e($fetchedData->id); ?>',id: appliid},
					success: function(responses){
...
$(document).delegate('.acceptapplication', 'click', function(){
	...
	$('.popuploader').show();
	$.ajax({
		url: '<?php echo e(URL::to('/admin/completestage')); ?>',
		type:'GET',
		datatype:'json',
		data:{id:appliid, client_id:'<?php echo e($fetchedData->id); ?>'},
		success:function(response){
...
$(document).delegate('.backstage', 'click', function(){
	...
	if(stage == 'Application'){
		...
		$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/updatebackstage')); ?>',
			type:'GET',
			datatype:'json',
			data:{id:appliid, client_id:'<?php echo e($fetchedData->id); ?>'},
			success:function(response){
...
$(document).delegate('#notes-tab', 'click', function(){
		...
		$('.ifapplicationdetailnot').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/getapplicationnotes')); ?>',
			type:'GET',
			data:{id:appliid},
			success:function(response){
				$('.popuploader').hide();
  ...
  $('#attachments').on('change',function(){
	...
	$(document).delegate('.openpaymentfee', 'click', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to('/admin/showproductfee')); ?>',
			type:'GET',
    ...
    $(document).delegate('.openpaymentfeeLatest', 'click', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to('/admin/showproductfeelatest')); ?>',
			type:'GET',
			data:{id:appliid},
			success:function(response){
				$('.popuploader').hide();
	...
	$(document).delegate('.openpaymentfeeserv', 'click', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to('/admin/showproductfeeserv')); ?>',
			type:'GET',
			data:{id:appliid},
			success:function(response){
				$('.popuploader').hide();
  ...
  $(document).delegate('#new_fee_option_latest .fee_option_addbtn_latest a', 'click', function(){
	...
	$(document).delegate('.editpaymentschedule', 'click', function(){
		...
		$('.popuploader').show();
		$.ajax({
			url: '<?php echo e(URL::to('/admin/scheduleinvoicedetail')); ?>',
			type: 'GET',
...
$(document).ready(function() {
    ...
    $(document).delegate('#student_id','blur', function(){
        ...
        $('.popuploader').show();
        $.ajax({
            url: "<?php echo e(URL::to('/admin/application/updateStudentId')); ?>",
            method: "POST",
    ...
    //////////////////////////////////////////////////////
       ...
       function uploadFormData(form_data) {
            $('.popuploader').show();
            $.ajax({
                url: "<?php echo e(URL::to('/admin/application/checklistupload')); ?>",
                method: "POST",
                data: form_data,
                datatype: 'json',
                contentType: false,
		...
		if(conf){
			if(id == '') {
				...
				$.ajax({
					type:'post',
					headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
					url:'<?php echo e(URL::to('/')); ?>/admin/delete_action',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views/Admin/clients/detail.blade.php ENDPATH**/ ?>