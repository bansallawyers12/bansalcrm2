					...
					<div class="card">
						...
						<div class="card-body">
							...
							<ul class="nav nav-pills" id="checkin_tabs" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active" id="all-tab"  href="<?php echo e(URL::to('/admin/office-visits')); ?>" >All <span class="countAction"><?php echo e($InPersonCount_All_type); ?></span></a>
								</li>
							</ul>
							<div class="tab-content" id="checkinContent">
								<div class="mydropdown" style="margin-top:10px;">
								  ...
								  <a href="<?php echo e(URL::to('/admin/office-visits/')); ?>">All Branches</a>
								  <?php
								  $branchs = \App\Models\Branch::all();
								  foreach($branchs as $branch){
									?>
									<a href="<?php echo e(URL::to('/admin/office-visits/')); ?>?office=<?php echo e($branch->id); ?>&office_name=<?php echo e($branch->office_name); ?>"><?php echo e($branch->office_name); ?></a>
								  <?php } ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\officevisits\index.blade.php ENDPATH**/ ?>