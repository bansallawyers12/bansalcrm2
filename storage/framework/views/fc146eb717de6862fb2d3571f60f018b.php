...
<?php $__env->startSection('title', 'Add Clients'); ?>
...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('url' => 'agent/clients/store', 'method' => 'post', 'name'=>"add-clients", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
						...
						<div class="card">
							<div class="card-body">
													...
													<div class="row">
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group"> 
																...
																<?php echo Form::text('first_name', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter First Name' )); ?>
														...
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group"> 
																...
																<?php echo Form::text('last_name', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Last Name' )); ?>
														...
														<div class="col-12 col-md-6 col-lg-6">
															<div class="form-group"> 
																...
																<div class="input-group">
																	...
																	<?php echo Form::text('dob', '', array('class' => 'form-control datepicker', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>
											...
											<div class="row">
												<div class="col-12 col-md-6 col-lg-6">
													<div class="form-group"> 
														...
														<?php echo Form::text('att_email', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter att_email' )); ?>
												...
												<div class="col-12 col-md-6 col-lg-6">
													<div class="form-group"> 
														...
														<div class="cus_field_input">
															...
															<?php echo Form::text('att_phone', '', array('class' => 'form-control tel_input', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Phone' )); ?>
											...
											<div class="row">
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<div class="input-group">
															...
															<?php echo Form::text('preferredIntake', '', array('class' => 'form-control datepicker', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<?php echo Form::text('passport_number', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Passport Number' )); ?>
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<div class="input-group">
															...
															<?php echo Form::text('visaExpiry', '', array('class' => 'form-control datepicker', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>
													...
													<div class="form-group"> 
														...
														<select class="form-control select2" name="source">
															...
															<?php $__currentLoopData = \App\Models\Source::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sourcelist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<option value="<?php echo e($sourcelist->id); ?>"><?php echo e($sourcelist->name); ?></option>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
														</select>
								...
								<div class="form-group float-right">
									<?php echo Form::button('Save Clients', ['class'=>'btn btn-primary', 'onClick'=>'customValidate("add-clients")']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.agent', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Agent\clients\create.blade.php ENDPATH**/ ?>