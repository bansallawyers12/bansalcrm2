...
<?php $__env->startSection('title', 'Unpaid Group Invoice'); ?>
						...
						<div class="card-body">							
							<ul class="nav nav-pills" id="client_tabs" role="tablist">
								<li class="nav-item is_checked_clientn">
									<a class="nav-link active" id="unpaid-tab"  href="<?php echo e(URL::to('/admin/group-invoice/unpaid')); ?>" >Unpaid</a>
								</li>
								<li class="nav-item is_checked_clientn">
									<a class="nav-link " id="paid-tab"  href="<?php echo e(URL::to('/admin/group-invoice/paid')); ?>" >Paid</a>
								</li>							
							</ul> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\invoice\unpaidgroupinvoice.blade.php ENDPATH**/ ?>