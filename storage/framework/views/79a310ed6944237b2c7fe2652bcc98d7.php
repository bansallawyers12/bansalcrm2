							...
							<div class="tab-content" id="payableContent">
								<div class="tab-pane fade show active" id="payables" role="tabpanel" aria-labelledby="payables-tab">
									<ul class="nav nav-pills" id="paypaid_tabs" role="tablist">
										<li class="nav-item is_checked_clientn">
											<a class="nav-link active" id="unpaid-tab"  href="<?php echo e(URL::to('/admin/income-sharing/receivables/unpaid')); ?>" >Unpaid</a>
										</li> 
										<li class="nav-item is_checked_clientn">
											<a class="nav-link" id="paid-tab"  href="<?php echo e(URL::to('/admin/income-sharing/receivables/paid')); ?>" >Received</a>
										</li> 	
									</ul>
									<div class="tab-content" id="payableContent">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\account\receivableunpaid.blade.php ENDPATH**/ ?>