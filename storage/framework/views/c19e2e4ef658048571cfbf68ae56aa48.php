											...
											<table width="100%" border="0">
												<thead>
													<tr style="background-color:#03a9f4;color:#fff;">
														<th><?php echo e(@$cleintname->first_name); ?> <?php echo e(@$cleintname->last_name); ?></th>
														<th></th>
														<th></th>
														<th></th>
														<th></th>
												...
												?>
													<tr>
														<td><b>DOB:</b></td>
														<td><?php echo e(@$cleintname->dob); ?></td>
														<td></td>
														<td><b>Assignee:</b></td>
													...
													<tr>
														<td><b>City:</b></td>
														<td><?php echo e(@$cleintname->city); ?></td>
														<td></td>
														<td><b>Branch:</b></td>
														<td></td>
														<td></td>
													...
													<tr style="background-color:rgba(0,0,0,0.04)">
														...
														<td><?php echo e(date('Y-m-d', strtotime(@$applications->created_at))); ?></td>
														<td></td>
													</tr>
													<tr style="background-color:rgba(0,0,0,0.04)">
														<td><b>Partner:</b></td>
				...
				<tbody>
					...
					?>
						<tr style="font-size:12px;line-height:18px;margin-top:50px;">
							...
							<span ><?php echo e($admin->first_name); ?> <?php echo $applicationlist->comment; ?></span></span></td>
						</tr>
					<?php } ?>
				</tbody>
			</table>
...
<?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\emails\application.blade.php ENDPATH**/ ?>