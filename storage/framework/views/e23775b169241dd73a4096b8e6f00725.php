						...
						<div class="card-header">
                            ...
                            <ul class="nav nav-pills" id="client_tabs" role="tablist">
                                <li class="nav-item is_checked_clientn">
									<a class="nav-link active" id="clients-tab"  href="<?php echo e(URL::to('/admin/assignee')); ?>">Incomplete</a>
								</li>
										...
										<tr>
											...
											<td>
												...
												<form action="<?php echo e(route('assignee.destroy',$list->id)); ?>" method="POST">
                                                    ...
                                                    <a class="btn btn-primary complete_task" data-id="<?php echo e($list->id); ?>" href="javascript:void(0)">Complete</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\assignee\index.blade.php ENDPATH**/ ?>