...
<div class="card-header-action" style="padding-bottom:15px;">
	...
	<div class="float-right">
		<div class="application_btns">
			<a target="_blank" href="<?php echo e(URL::to('/agent/application/export/pdf/')); ?>/<?php echo e($fetchData->id); ?>" class="btn btn-primary"><i class="fa fa-print"></i></a>
	...
	<div class="col-md-3">
		<div class="cus_sidebar">
			<div class="form-group">
				...
				<?php echo Form::text('applied_intake', $fetchData->intakedate, array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','readonly'=>true )); ?>
			...
			<div class="app_date_sec">
				<div class="app_start_date common_apply_date">
					...
					<div class="date_col">
						...
						<input type="text" value="<?php echo e(@$fetchData->start_date); ?>" class="" />
						<div class="apply_val">
			...
			<div class="setup_payment_sche">
				<?php
			$appfeeoption = \App\Models\ApplicationFeeOption::where('app_id', $fetchData->id)->first();
			$totl = 0.00;
			$discount = 0.00;
			if($appfeeoption){
			...
			<p class="clearfix"> 
				...
				<span class="float-right text-muted product_totalfee"><?php echo e($totl); ?></span>
			</p>
			<p class="clearfix" style="color:#ff0000;"> 
				<span class="float-left">Discount</span>
				<span class="float-right text-muted product_discount"><?php echo e($discount); ?></span>
			</p>
			<p class="clearfix" style="color:#6777ef;"> 
				<span class="float-left">Net Fee</span>
				<span class="float-right text-muted product_net_fee"><?php echo e($net); ?></span>
			</p>
			<div class="divider"></div>
			<div class="cus_prod_fees ">
			...
			<p class="clearfix appsaleforcast"> 
				...
				<span class="float-right text-muted partner_revenue"><?php echo e($partner_revenue); ?></span>
			</p>
			<p class="clearfix appsaleforcast"> 
				<span class="float-left">Client Revenue</span>
				<span class="float-right text-muted client_revenue"><?php echo e($client_revenue); ?></span>
			</p>
			<p class="clearfix appsaleforcast" style="color:#ff0000;"> 
				<span class="float-left">Discount</span>
				<span class="float-right text-muted discounts"><?php echo e($discounts); ?></span>
			</p>
			<p class="clearfix appsaleforcast" style="color:#6777ef;"> 
				<span class="float-left">Net Revenue</span>
				<span class="float-right text-muted netrevenue"><?php echo e(number_format($nettotal,2,'.','')); ?></span>
			</p>
			<div class="form-group">
				<label for="expect_win_date">Expected Win Date:</label>
				<?php echo Form::text('expect_win_date', $fetchData->expect_win_date, array('class' => 'form-control ', 'data-valid'=>'', 'autocomplete'=>'off','readonly'=>true )); ?>
...
<?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Agent\clients\applicationdetail.blade.php ENDPATH**/ ?>