...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('url' => 'admin/quotations/template/store', 'name'=>"add-quotations", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>

				<div class="row">
					<div class="col-12 col-md-12 col-lg-12">
						<div class="card">
							<div class="card-header">
								<h4>Create Quotations Template</h4>
								...
								<div class="row">
									<div class="col-12 col-md-4 col-lg-4">
										<div class="form-group"> 
											...
											<?php echo Form::text('template_name', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Template Name' )); ?>
									...
									<div class="col-12 col-md-4 col-lg-4">
										<div class="form-group"> 
											...
											<div class="bfh-selectbox bfh-currencies" data-currency="AUD" data-flags="true" data-name="quotation_currency"></div>
								...
								<div class="row">
									...
									<div class="col-lg-4 text-right">
										<div class="invoice-detail-item">
											...
											<div class="invoice-detail-value invoice-detail-value-lg">$<span  class="grandtotal">0.00</span></div>
										</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\quotations\template\create.blade.php ENDPATH**/ ?>