...
<?php $__env->startSection('title', 'Paid Group Invoice'); ?>
						...
						<div class="card-body">							
							<ul class="nav nav-pills" id="invoice_tabs" role="tablist">
								<li class="nav-item is_checked_clientn">
									<a class="nav-link" id="unpaid-tab"  href="<?php echo e(URL::to('/admin/group-invoice/unpaid')); ?>" >Unpaid</a>
								</li> 
								<li class="nav-item is_checked_clientn">
									<a class="nav-link active" id="paid-tab"  href="<?php echo e(URL::to('/admin/group-invoice/paid')); ?>" >Paid</a>
								</li>							
							</ul> 
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="post" action="<?php echo e(URL::to('/admin/addgroupinvoice')); ?>" name="addgroupinvoice" id="addgroupinvoice" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\invoice\paidgroupinvoice.blade.php ENDPATH**/ ?>