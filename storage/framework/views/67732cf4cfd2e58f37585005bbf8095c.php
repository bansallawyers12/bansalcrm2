...
<?php $__env->startSection('title', 'Create Roles and Permissions'); ?>
...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('url' => 'admin/userrole/store', 'name'=>"add-userrole", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
								...
								<div class="row">
									<div class="col-12 col-md-6 col-lg-6">
										<div class="form-group">
											...
											<?php echo Form::text('name', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Name' )); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\userrole\create.blade.php ENDPATH**/ ?>