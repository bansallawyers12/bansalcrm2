			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="card card-primary">
					  ...
					  <!-- /.card-header -->
					  <!-- form start -->
					  <?php echo Form::open(array('url' => 'admin/settings/taxes/taxrates/edit', 'name'=>"add-city", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
							...
							<div class="row">
								...
								<div class="col-sm-12 is_gst_yes ">
									<div class="form-group"> 
										...
										<input type="text" name="rate" value="<?php echo e(@$fetchedData->rate); ?>" onkeyup="this.value=this.value.replace(/[^0-9\.]/g,'')" autocomplete="off" class="form-control" data-valid="required">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\settings\edit.blade.php ENDPATH**/ ?>