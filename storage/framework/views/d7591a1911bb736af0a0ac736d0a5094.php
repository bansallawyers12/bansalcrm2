...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('url' => 'admin/quotations/edit', 'name'=>"add-quotations", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?>
				...
				<div class="row">
					...
					<div class="col-12 col-md-6 col-lg-6">
						<div class="card">
							...
							<div class="card-body">
								<p><?php echo e($client->first_name); ?> <?php echo e($client->last_name); ?><br><?php echo e($client->email); ?></p>
						...
						<div class="card">							
							<div class="card-body">
								<div class="form-group"> 
									...
									<?php echo Form::text('due_date', @$fetchedData->due_date, array('class' => 'form-control datepicker', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\quotations\edit.blade.php ENDPATH**/ ?>