...
<?php $__env->startSection('title', 'Add Lead Service'); ?>
...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<?php echo Form::open(array('url' => 'admin/lead-service/store', 'name'=>"add-leadservice", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")); ?> 
				<div class="row">   
					<div class="col-12 col-md-12 col-lg-12">
						<div class="card">
							<div class="card-header">
								<h4>Add Lead Service</h4>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group float-right">
									<?php echo Form::submit('Save Lead Service', ['class'=>'btn btn-primary' ]); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\feature\leadservice\create.blade.php ENDPATH**/ ?>