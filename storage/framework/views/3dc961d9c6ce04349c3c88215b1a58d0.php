...
<!-- Appointment Modal -->
<div class="modal fade add_appointment custom_modal" id="create_appoint" tabindex="-1" role="dialog" aria-labelledby="create_appointModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/add-partner-appointment')); ?>" name="partnerappointform" id="partnerappointform" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
					<div class="row">
						<div class="col-12 col-md-6 col-lg-6">
						...
						?>
							<div class="form-group">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" id="client" value="Client" name="related_to">
									<label class="form-check-label" for="client">Client</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" id="partner" value="Partner" name="related_to" checked>
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<?php echo Form::text('partner_name', @$fetchedData->partner_name, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Partner Name','readonly'=>'readonly' )); ?> 
							</div>
						</div>
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
						...
						<div class="col-12 col-md-5 col-lg-5">
							<div class="form-group"> 
								...
								<div class="input-group">
									...
									<?php echo Form::text('appoint_time', '', array('class' => 'form-control timepicker', 'data-valid'=>'required', 'autocomplete'=>'off',  'placeholder'=>'Select Time', 'readonly')); ?>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<button onclick="customValidate('partnerappointform')" type="button" class="btn btn-primary">Save</button>
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						</div>
					</div>
				</form>  
...
<div class="modal fade custom_modal" id="create_note" tabindex="-1" role="dialog" aria-labelledby="create_noteModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/create-note')); ?>" name="clientnotetermform" autocomplete="off" id="clientnotetermform" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" id= "partner_id" value="<?php echo e($fetchedData->id); ?>">
				<input type="hidden" name="noteid" value="">
				<input type="hidden" name="mailid" value="0">
				<input type="hidden" name="type" id="type" value="">
				<input type="hidden" name="vtype"  value="partner">
					<div class="row">
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								<label for="title">Title <span class="span_req">*</span></label>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<button onclick="customValidate('clientnotetermform')" type="button" class="btn btn-primary">Submit</button>
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						</div>
					</div>
				</form> 
...
<!-- Contact Modal -->
<div class="modal fade custom_modal" id="add_clientcontact" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="appliationModalLabel">Add new Contact</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/partner/create-contact')); ?>" name="clientcontact" autocomplete="off" id="clientcontact" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
				<input type="hidden" name="contact_id" id="contact_id" value="">
				
					<div class="row allinputfields">
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<span class="custom-error name_error" role="alert">
									<strong></strong>
								</span> 
							</div>
						</div>
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<span class="custom-error email_error" role="alert">
									<strong></strong>
								</span> 
							</div>
						</div>
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<select name="branch" id="branch" class="form-control" data-valid="required">
									...
									<?php $__currentLoopData = \App\Models\PartnerBranch::where('partner_id', $fetchedData->id)->orderby('created_at','DESC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partnerbranch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($partnerbranch->id); ?>"><?php echo e($partnerbranch->name); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
								<span class="custom-error branch_error" role="alert">
									<strong></strong>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<?php echo Form::text('fax', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Fax' )); ?>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<?php echo Form::text('department', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Department' )); ?>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<?php echo Form::text('position', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Position' )); ?>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								<label for="position"> Primary Contact</label>
								<input type="checkbox" id="primary_contact" value="1" name="primary_contact" class="checkbox">
								<span class="custom-error name_error" role="alert">
									<strong></strong>
								</span> 
							</div>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<button onclick="customValidate('clientcontact')" type="button" class="btn btn-primary">Submit</button>
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						</div>
					</div>
				</form> 
...
<!-- Contact Modal -->
<div class="modal fade custom_modal" id="add_clientbranch" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="appliationModalLabel">Add new branch</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/partner/create-branch')); ?>" name="clientbranch" autocomplete="off" id="clientbranch" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
					...
					<div class="row allinputfields">
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<?php echo Form::text('zip_code', '', array('class' => 'form-control', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Zip Code' )); ?>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<input type="checkbox" id="head_office" value="1" name="head_office" class="checkbox">
								<span class="custom-error name_error" role="alert">
									<strong></strong>
								</span> 
							</div>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<button onclick="customValidate('clientbranch')" type="button" class="btn btn-primary">Submit</button>
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						</div>
					</div>
				</form> 
...
<div class="modal fade create_task custom_modal" id="opentaskmodal" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/partner/addtask/')); ?>" name="tasktermclientform" autocomplete="off" id="tasktermclientform" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="partnerid" value="<?php echo e($fetchedData->id); ?>">
					...
					<div class="row">
							...
							<div class="form-group">
								...
								<select data-valid="" class="form-control assignee select2" name="assignee">
									...
									foreach($headoffice as $holist){
										?>
										<option value="<?php echo e($holist->id); ?>"><?php echo e($holist->first_name); ?> (<?php echo e($holist->primary_email); ?>)</option>
										<?php
									}
									?>
								</select> 
						...
						<div class="col-12 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<?php echo Form::text('due_time', '', array('class' => 'form-control timepicker', 'data-valid'=>'', 'autocomplete'=>'off', 'placeholder'=>'Select Time', 'readonly' )); ?> 
								</div> 
						...
						<div class="col-12 col-md-12 col-lg-12">
						<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
							<button onclick="customValidate('tasktermclientform')" type="button" class="btn btn-primary">Create</button>
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						</div>
					</div>
				</form> 
					...
					<div class="row">
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group"> 
								...
								<?php echo Form::number('academic_score', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','step'=>'0.01' )); ?>
...
<div id="addpaymentmodal" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="false" class="modal fade" >
	...
	<input type="hidden" value="<?php echo e($fetchedData->id); ?>" name="client_id" id="">
		<div class="modal-content ">
			<div class="modal-header">
...
<div class="modal fade custom_modal" id="create_applicationnote" tabindex="-1" role="dialog" aria-labelledby="create_noteModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/create-app-note')); ?>" name="clientAPPnotetermform" autocomplete="off" id="clientAPPnotetermform" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
				...
				<input type="hidden" name="type" id="type" value="partner">
					<div class="row">
						...
						<div class="col-12 col-md-12 col-lg-12">
							<button onclick="customValidate('clientAPPnotetermform')" type="button" class="btn btn-primary">Submit</button>
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						</div>
					</div>
				</form> 
						...
						<div class="col-12 col-md-5 col-lg-5">
							<div class="form-group"> 
								...
								<div class="input-group">
									...
									<?php echo Form::text('appoint_time', '', array('class' => 'form-control timepicker', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Select Time' )); ?>
...
<div class="modal fade custom_modal" id="create_checklist" tabindex="-1" role="dialog" aria-labelledby="create_checklistModalLabel" aria-hidden="true">
	<div class="modal-dialog"> 
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/add-appointment')); ?>" name="checklistform" id="checklistform" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
					<div class="row">						
						<div class="col-12 col-md-12 col-lg-12">
...
<!-- Promotion Modal -->
<div class="modal fade add_promotion custom_modal" id="create_promotion" tabindex="-1" role="dialog" aria-labelledby="create_promotionModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="create_promotionModalLabel">Add New Promotion</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/promotion/store')); ?>" id="promotionform" name="promotionform" id="promotionform" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?> 
				<input type="hidden" name="client_id" value="<?php echo e($fetchedData->id); ?>">
					<div class="row">
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<?php echo Form::text('promotion_title', '', array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Promotion Title')); ?> 
							</div>
						</div>
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
								<label for="promotion_desc">Description</label>
								<textarea class="form-control" name="promotion_desc" placeholder="Description"></textarea>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group"> 
								...
								<div class="input-group">
									...
									<?php echo Form::text('promotion_start_date', '', array('class' => 'form-control datepicker', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group"> 
								...
								<div class="input-group">
									...
									<?php echo Form::text('promotion_end_date', '', array('class' => 'form-control datepicker', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Select Date' )); ?>
						...
						?>
							<div class="form-group">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" id="all_product" value="All Products" name="apply_to" checked>
									<label class="form-check-label" for="all_product">All Products</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" id="select_products" value="Select Products" name="apply_to">
						...
						<div class="col-12 col-md-12 col-lg-12 ifselectproducts" multiple style="display:none;">
							<div class="form-group">
								<select  class="form-control productselect2"  name="selectproduct[]">
										 <option></option>
									<?php $__currentLoopData = \App\Models\Product::where('partner', $fetchedData->id)->orderby('created_at','DESC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($plist->id); ?>"><?php echo e($plist->name); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
							</div>
						</div>
						<div class="col-12 col-md-12 col-lg-12">
							<button onclick="customValidate('promotionform')" type="button" class="btn btn-primary">Save</button>
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						</div>
					</div>
				</form>  
						...
						<div class="extra_content">
							<div class="left">
								...
								<div class="note_modify">
									<small>Last Modified <span class="lastdate"></span></small>
								</div>
							</div>  
						</div>
					</div>
...
<!-- Partner Student Invoice Modal -->
<div class="modal fade custom_modal" id="createpartnerstudentinvoicemodal" tabindex="-1" role="dialog" aria-labelledby="create_noteModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="appliationModalLabel">Create Student Invoice</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				...
				<form method="post" action="<?php echo e(URL::to('/admin/partners/savepartnerstudentinvoice')); ?>" name="create_student_invoice" autocomplete="off" id="create_student_invoice" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				<input type="hidden" name="partner_id" id="partner_id" value="<?php echo e($fetchedData->id); ?>">
                ...
                <input type="hidden" name="invoice_id" id="invoice_id_val" value="">
					<div class="row">
						<div class="col-3 col-md-3 col-lg-3">
							<div class="form-group">
								<label for="partner">Partner <span class="span_req">*</span></label>
								<?php echo Form::text('partner', @$fetchedData->partner_name, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'' )); ?>
                        ...
                        <div class="col-3 col-md-3 col-lg-3">
							<div class="form-group">
								<label for="invoice_date">Invoice Date <span class="span_req">*</span></label>
								<input data-valid="required"  class="form-control invoice_date_fields" name="invoice_date" type="text" value="" />
                                <span class="custom-error invoice_date_error" role="alert">
									<strong></strong>
								</span>
							</div>
						</div>
                        ...
                        <div class="col-3 col-md-3 col-lg-3">
							<div class="form-group">
								<label for="invoice_no">Invoice Number <span class="span_req">*</span></label>
                                <input class="form-control unique_trans_no" type="text" value="" readonly/>
                                <input class="unique_trans_no_hidden" name="invoice_no" type="hidden" value="" />
                                <span class="custom-error invoice_no_error" role="alert">
									<strong></strong>
								</span>
							</div>
						</div>
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
                                <table border="1" style="margin-bottom:0rem !important;" class="table text_wrap table-striped table-hover table-md vertical_align">
                                    <thead>
                                        <tr>
                                            <th style="width:10%;">Student Enrolled</th>
                                            <th style="width:15%;">DOB</th>
                                            <th style="width:15%;">Course Name</th>
                                            <th style="width:15%;">Student Id</th>
                                            <th style="width:15%;">Description</th>
                                            <th style="width:5%;">Amount(Incl GST)</th>
                                            <th style="width:1%;"></th>
                                        </tr>
                                    </thead>
						...
						<div class="col-9 col-md-9 col-lg-9 text-right">
                            ...
                            <!--<button onclick="customValidate('create_student_invoice')" type="button" class="btn btn-primary">Save</button>-->
                            <button onclick="customValidate('create_student_invoice','draft')" type="button" class="btn btn-primary">Save Draft</button>
							<!--<button onclick="customValidate('create_student_invoice','final')" type="button" class="btn btn-primary">Save and Finalised</button>-->
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						</div>
                    </div>
				</form>
...
<div class="modal fade custom_modal" id="createrecordinvoicemodal" tabindex="-1" role="dialog" aria-labelledby="create_noteModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="appliationModalLabel">Create Record Invoice</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
                <input type="hidden"  id="top_value_db_invoice" value="">
				<form method="post" action="<?php echo e(URL::to('/admin/partners/savepartnerrecordinvoice')); ?>" name="create_record_invoice" autocomplete="off" id="create_record_invoice" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				<input type="hidden" name="partner_id" value="<?php echo e($fetchedData->id); ?>">
                <input type="hidden" name="loggedin_userid" value="<?php echo e(@Auth::user()->id); ?>">
                <input type="hidden" name="invoice_type" value="2">
                <input type="hidden" name="function_type" id="function_type_invoice" value="">
					<div class="row">
						<div class="col-3 col-md-3 col-lg-3">
							<div class="form-group">
								<label for="partner">Partner <span class="span_req">*</span></label>
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
                                <table border="1" style="margin-bottom:0rem !important;" class="table text_wrap table-striped table-hover table-md vertical_align">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:11%;">Sent Date</th>
                                    ...
                                    <tbody class="productitem_invoice">
                                        <tr class="clonedrow_invoice">
                                            <td>
                                                <input data-valid="required"  class="form-control record_invoice_date_fields" name="invoice_date[]" type="text" value="" />
                                            </td>
                                            <td>
                                                <input data-valid="required"  class="form-control record_sent_date_fields" name="sent_date[]" type="text" value="" />
                                            </td>
                                            <td>
                                                <input class="form-control" data-valid="required" name="invoice_no[]" type="text" value="" />
                                                <!--<input class="unique_record_invoice_trans_no_hidden" type="hidden" value="" />-->
                                            </td>
                                            <td>
                                                <span class="currencyinput" style="display: inline-block;">$</span>
                                ...
                                <table border="1" class="table text_wrap table-striped table-hover table-md vertical_align">
                                    <tbody>
                                        <tr>
                                            <td colspan="3" style="width:83.6%;text-align:right;">Totals</td>
                                            <td colspan="1">
                                                <span class="total_deposit_amount_all_rows_invoice"></span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
						...
						<div class="col-9 col-md-9 col-lg-9 text-right">
                            ...
                            <button onclick="customValidate('create_record_invoice')" type="button" class="btn btn-primary">Save</button>
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						</div>
                    </div>
				</form>
...
<div class="modal fade custom_modal" id="createrecordpaymentmodal" tabindex="-1" role="dialog" aria-labelledby="create_noteModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="appliationModalLabel">Create Record Payment</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
                <input type="hidden"  id="top_value_db_payment" value="">
				<form method="post" action="<?php echo e(URL::to('/admin/partners/savepartnerrecordpayment')); ?>" name="create_record_payment" autocomplete="off" id="create_record_payment" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				<input type="hidden" name="partner_id" value="<?php echo e($fetchedData->id); ?>">
                <input type="hidden" name="loggedin_userid" value="<?php echo e(@Auth::user()->id); ?>">
                <input type="hidden" name="invoice_type" value="3">
                <input type="hidden" name="function_type" id="function_type_payment" value="">
					<div class="row">
						<div class="col-3 col-md-3 col-lg-3">
							<div class="form-group">
								<label for="partner">Partner <span class="span_req">*</span></label>
							...
							<div class="form-group">
                                <table border="1" style="margin-bottom:0rem !important;" class="table text_wrap table-striped table-hover table-md vertical_align">
                                    <thead>
                                        <tr>
                                            <th style="width:10%;">Invoice Number</th>
                                            <th style="width:11%;">Method Received</th>
                                            <th style="width:11%;">Verified By</th>
                                            <th style="width:11%;">Verified Date</th>
                                            <th style="width:10%;">Amount Received</th>
                                            <th style="width:1%;"></th>
                                        </tr>
                                    </thead>
                                    <tbody class="productitem_payment">
                                        <tr class="clonedrow_payment">
                                            <td>
                                                <select data-valid="required" class="form-control invoice_no_cls" name="invoice_no[]">
                                                </select>
                                            </td>
                                            <td>
                                                <select data-valid="required" class="form-control" name="method_received[]">
                                                    <option value="">Select</option>
                                            ...
                                            <td>
                                                <input data-valid="required"  class="form-control" name="verified_by[]" type="text" value="" />
                                            </td>
                                            <td>
                                                <input data-valid="required"  class="form-control record_payment_date_fields" name="verified_date[]" type="text" value="" />
                                            </td>
                                            <td>
                                                <span class="currencyinput" style="display: inline-block;">$</span>
                                                <input style="display: inline-block;" data-valid="required" class="form-control deposit_payment_amount_per_row" name="amount_aud[]" type="text" value=""/>
                                            </td>
                                            <!--<td>
                                                <input class="form-control unique_record_payment_trans_no" type="text" value="" readonly/>
                                                <input class="unique_record_payment_trans_no_hidden" name="invoice_no[]" type="hidden" value="" />
                                            </td>-->
                                ...
                                <table border="1" class="table text_wrap table-striped table-hover table-md vertical_align">
                                    <tbody>
                                        <tr>
                                            <td colspan="3" style="width:83.6%;text-align:right;">Totals</td>
                                            <td colspan="1">
                                                <span class="total_deposit_amount_all_rows_payment"></span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
						...
						<div class="col-9 col-md-9 col-lg-9 text-right">
                            ...
                            <button onclick="customValidate('create_record_payment')" type="button" class="btn btn-primary">Save</button>
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						</div>
                    </div>
				</form>
...
<!-- Partner Upload inbox email Modal -->
<div class="modal fade custom_modal" id="partnerUploadAndFetchMail" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
			<form method="post" action="<?php echo e(URL::to('/admin/upload-partner-fetch-mail')); ?>" name="partner_upload_inbox_mail" id="partner_upload_inbox_mail" autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				<input type="hidden" name="partner_id" id="mapartner_id_fetch">
                <input type="hidden" name="type" value="partner">
					<div class="row">
						<div class="col-12 col-md-12 col-lg-12">
                            <div class="form-group">
                               <label>Upload Outlook Email (.msg)</label>
                               <input type="file" name="email_file[]" class="form-control" accept=".msg" data-valid="required" multiple>
                            </div>
                       </div>

						<div class="col-4 col-md-4 col-lg-4">
							<div class="form-group">
								<button onclick="customValidate('partner_upload_inbox_mail')" class="btn btn-info" type="button">Save</button>
							</div>
						</div>
					</div>
				</form>
...
<!-- Partner upload sent email Modal -->
<div class="modal fade custom_modal" id="partnerUploadSentAndFetchMail" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
			<form method="post" action="<?php echo e(URL::to('/admin/upload-partner-sent-fetch-mail')); ?>" name="partner_upload_sent_mail" id="partner_upload_sent_mail"  autocomplete="off" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				<input type="hidden" name="partner_id" id="mapartner_id_fetch_sent" value="">
                <input type="hidden" name="type" value="partner">
					<div class="row">
						<div class="col-12 col-md-12 col-lg-12">
                            <div class="form-group">
						...
						<div class="col-4 col-md-4 col-lg-4">
							<div class="form-group">
								<button onclick="customValidate('partner_upload_sent_mail')" class="btn btn-info" type="button">Save</button>
							</div>
						</div>
					</div>
				</form>
...
<div class="modal fade add_appointment custom_modal" id="create_partneraction" tabindex="-1" role="dialog" aria-labelledby="create_appointModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/partners/followup_partner/store_partner')); ?>" name="partnerassignform" id="partnerassignform" autocomplete="off" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="partner_id" value="<?php echo e($fetchedData->id); ?>">
                    <input type="hidden" name="type" value="partner">
                    <!--<input type="hidden" name="task_group" value="partner">-->
                    ...
                    <div class="row">
                        <div class="col-3 col-md-3 col-lg-3">
							<div class="form-group">
								<label for="inputEmail3">Date<span class="span_req">*</span></label>
					            <input type="text" class="form-control f13" placeholder="dd/mm/yyyy" id="popoverdatetime" value="" name="popoverdate">
                            </div>
						</div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-3 col-md-3 col-lg-3">
							<div class="form-group">
					            ...
					            <select class="assigneeselect2 form-control selec_reg" id="task_group" name="task_group" data-valid="required">
                                    <option value="">Select</option>
                                    <option value="Call">Call</option>
                    ...
                    <div class="row">
                        <div class="col-3 col-md-3 col-lg-3">
							<div class="form-group">
					            ...
					            <input type="text" class="form-control f13" placeholder="dd/mm/yyyy" id="note_deadline" value="<?php echo date('d/m/Y');?>" name="note_deadline" disabled>
                            </div>
						</div>
                    </div>
                  
                  
                    <div class="row" id="recurring_type_section" style="display: none;">
                        <div class="col-3 col-md-3 col-lg-3">
                            <div class="form-group">
                                <label for="task_group">Recurring Type</label>
                                <div>
                                    <!-- Radio buttons for Recurring Type -->
                                    <label class="me-2">
                                        <input type="radio" name="recurring_type" value="yes"> Yes
                                    </label>
                                    <label>
                                        <input type="radio" name="recurring_type" value="no" checked> No
                                    </label>
                                </div>
                            </div>
                        </div>
...
<!-- At Partner Detail Page in Student Tab Create Note Modal -->
<div class="modal fade custom_modal" id="create_student_note" tabindex="-1" role="dialog" aria-labelledby="create_student_noteModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="studentappliationModalLabel">Add Note To Student</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<form method="post" action="<?php echo e(URL::to('/admin/add-student-note')); ?>" name="studentnotetermform" autocomplete="off" id="studentnotetermform" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				<input type="hidden" name="partner_id" id="partner_id" value="<?php echo e($fetchedData->id); ?>">
                <input type="hidden" name="college_name" id="college_name" value="">
				<input type="hidden" name="student_id" id="student_id" value="">
				<input type="hidden" name="student_ref_no" id="student_ref_no" value="">
				<input type="hidden" name="noteid" value="">
				<input type="hidden" name="mailid" value="0">
				<input type="hidden" name="type" id="type" value="">
				<input type="hidden" name="vtype"  value="partner">
					<div class="row">
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group">
                                ...
                                <select name="title" class="form-control" data-valid="required" id="studentNoteType">
								    <option value="">Please Select Note</option>
								    <option value="Call">Call</option>
								    <option value="Email">Email</option>
								    <option value="In-Person">In-Person</option>
                                ...
                                <!-- Container for additional inputs -->
						        <div id="additionalStudentNoteFields"></div>
                                <span class="custom-error title_error" role="alert">
									<strong></strong>
								</span>
							</div>
						...
						<div class="col-12 col-md-12 col-lg-12">
							<button onclick="customValidate('studentnotetermform')" type="button" class="btn btn-primary">Submit</button>
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						</div>
					</div>
				</form>
...
<?php /**PATH C:\xampp\htdocs\bansalcrm2\resources\views\Admin\partners\addpartnermodal.blade.php ENDPATH**/ ?>