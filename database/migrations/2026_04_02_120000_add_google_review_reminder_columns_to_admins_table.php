    ...
    public function up(): void
    {
        ...
        Schema::table('admins', function (Blueprint $table) {
            if (! Schema::hasColumn('admins', 'google_review_reminder_status')) {
                $table->string('google_review_reminder_status', 64)->nullable()->after('tagname');
            }
            if (! Schema::hasColumn('admins', 'google_review_reminder_snooze_until')) {
                $table->timestamp('google_review_reminder_snooze_until')->nullable()->after('google_review_reminder_status');
            }
        });
    }
