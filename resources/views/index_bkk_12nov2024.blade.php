					...
					<div class="section-heading">
                      ...
                      <!--<p><?php //echo @\App\HomeContent::where('meta_key','meet_description')->first()->meta_value; ?></p>-->
                        ...
                        <p style="padding-bottom: 1em;box-sizing: border-box;font-size: 15px;Merienda, cursive;font-optical-sizing: auto;font-style: normal;">
                            ...
                            <p style="padding-bottom: 1em;box-sizing: border-box;font-size: 15px;Merienda, cursive;font-optical-sizing: auto;font-style: normal;">With <strong>over a decade of experience</strong>, our expert MARN Agent Mr. Arun Bansal has helped countless clients transform their Australian dreams into reality. Whether you're seeking general skilled migration, education consultation, or other visa solutions, our team is committed to delivering tailored services with unmatched professionalism and care.</p>
                            <p style="box-sizing: border-box;font-size: 15px; Merienda, cursive;font-optical-sizing: auto;font-style: normal;">As<strong> Melbourne's trusted experts</strong>, located on Collins Street, we offer you guidance, clarity, and unwavering support every step of the way. Trust us to navigate the complexities of migration and education in Australia with you, ensuring your success, just as we have for so many others.</p>
