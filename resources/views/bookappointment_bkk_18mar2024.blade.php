...
@media (max-width: 480px) {
    ...
    .services_item_title_span {margin-left: 13px;padding-top: 10px;display:block;}
    .services_item_price {float:left;padding-left: 20px;}
    #loading-image {position: absolute;top:0;left: 45px;z-index: 100;}
}
                        ...
                        <div class="cus_tab_form">
                            ...
                            <div id="confirm_div" class="col-12 col-md-6 col-lg-6" style="margin-left: 15px;width: 90%;">
                                ...
                                <div class="row confirm_row" id="confirm" style="display: none;">
                                    <div class="tab_header">
										<h4 style="margin: 15px 0px 15px;">Confirm Details</h4>
									</div>
									<div class="tab_body">
                                        <div class="row">
											<div class="col-md-12">
                                ...
                                var obj = JSON.parse(res);
                                 if(obj.success){
                                    ...
                                    for(var i = start_time; i<end_time; i = i+interval){
                                        ...
                                        //console.log('timetoString12hr='+timetoString12hr);
                                        ...
                                        //console.log('len=='+objdisable.length);
