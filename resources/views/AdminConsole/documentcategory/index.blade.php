										...
										<td>
											<div class="dropdown d-inline">
												...
												<div class="dropdown-menu">
													<a class="dropdown-item has-icon" href="{{route('adminconsole.documentcategory.edit', $category->id)}}">@icon('edit', 'regular') Edit</a>
													@if(!$category->is_default || $category->name !== 'General')
														<a class="dropdown-item has-icon" href="javascript:;" onClick="deleteAction({{$category->id}}, 'document_categories')">@icon('trash') Delete</a>
													@endif
												</div>
											</div>
										</td>
