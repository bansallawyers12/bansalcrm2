...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			{!! Form::open(array('url' => 'adminconsole/workflow/store', 'name'=>"add-workflow", 'autocomplete'=>'off', "enctype"=>"multipart/form-data"))  !!} 
				<div class="row">   
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group float-end">
									{!! Form::submit('Save Workflow', ['class'=>'btn btn-primary' ])  !!}
								</div> 
							</div>
						</div>	
					</div>
