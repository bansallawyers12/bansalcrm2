...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			{!! Form::open(array('url' => 'adminconsole/visa-type/edit', 'name'=>"edit-visatype", 'autocomplete'=>'off', "enctype"=>"multipart/form-data"))  !!}
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group float-end">
									{!! Form::submit('Update Visa Type', ['class'=>'btn btn-primary' ])  !!}
								</div>
							</div>
						</div>
					</div>
