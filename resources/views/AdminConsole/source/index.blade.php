					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
								<a href="{{route('adminconsole.source.create')}}" class="btn btn-primary">Create Source</a>
							</div>
						</div>
						<div class="card-body">
										...
										<td>
											<div class="dropdown d-inline">
												...
												<div class="dropdown-menu">
													<a class="dropdown-item has-icon" href="{{URL::to('/adminconsole/source/edit/'.base64_encode(convert_uuencode(@$list->id)))}}">@icon('edit', 'regular') Edit</a>
													<a class="dropdown-item has-icon" href="javascript:;" onClick="deleteAction({{@$list->id}}, 'sources')">@icon('trash') Delete</a>
												</div>
											</div>								  
										</td>
									</tr>	
