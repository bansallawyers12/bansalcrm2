                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <p><span class="badge badge-{{ $smsLog->status === 'sent' ? 'success' : ($smsLog->status === 'failed' ? 'danger' : 'warning') }}">{{ ucfirst($smsLog->status) }}</span></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong>Provider:</strong></label>
                                        <p><span class="badge badge-{{ $smsLog->provider === 'cellcast' ? 'danger' : 'info' }}">{{ strtoupper($smsLog->provider) }}</span></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
