                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($template->category)<span class="badge badge-info">{{ $template->category }}</span>@else<span class="text-muted">-</span>@endif
                                            </td>
                                            <td><div style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $template->message }}</div></td>
