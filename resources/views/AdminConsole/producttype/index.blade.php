					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
								<a href="{{route('adminconsole.producttype.create')}}" class="btn btn-primary">Create Product Type</a>
							</div>
						</div>
						<div class="card-body">
										...
										<td>
											<div class="dropdown d-inline">
												...
												<div class="dropdown-menu">
													<a class="dropdown-item has-icon" href="{{URL::to('/adminconsole/product-type/edit/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="far fa-edit"></i> Edit</a>
													<a class="dropdown-item has-icon" href="javascript:;" onClick="deleteAction({{@$list->id}}, 'product_types')"><i class="fas fa-trash"></i> Delete</a>
												</div>
											</div>								  
										</td>
									</tr>	
