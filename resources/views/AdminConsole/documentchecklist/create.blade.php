...
<div class="main-content">
    <section class="section">
        <div class="section-body">
            {!! Form::open(array('url' => 'adminconsole/documentchecklist/store', 'name'=>"add-checklist", 'autocomplete'=>'off', "enctype"=>"multipart/form-data"))  !!}
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="{{route('adminconsole.documentchecklist.index')}}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
