...
@section('title', 'Add Partner Type')
...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			{!! Form::open(array('url' => 'adminconsole/partner-type/store', 'name'=>"add-partnertype", 'autocomplete'=>'off', "enctype"=>"multipart/form-data"))  !!} 
				<div class="row">   
						...
						<div class="card">
							<div class="card-header"> 
								...
								<div class="card-header-action">
									<a href="{{route('adminconsole.partnertype.index')}}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="card-body">
								<div id="accordion"> 
									<div class="accordion">
										...
										<option value="{{$clists->id}}">{{$clists->category_name}}</option>
										@endforeach
													</select>
														@if ($errors->has('name'))
															<span class="custom-error" role="alert">
								...
								<div class="form-group float-end">
									{!! Form::submit('Save Partner Type', ['class'=>'btn btn-primary' ])  !!}
								</div> 
							</div>
						</div>	
					</div>
