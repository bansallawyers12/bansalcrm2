...
@media (max-width: 480px) {
    ...
    .confirmTblCls {width: 480px !important;}
}
...
@media (min-width: 768px) and (max-width: 1024px){
    .datePickerCls {height: 230px;width:200px;}
    .timeslotDivCls { width:65%;margin-top: 25px;}
    .confirmTblCls {width: 768px !important;}
}
 ...
 @media (min-width: 1025px) and (max-width: 1280px){
    ...
    .confirmTblCls {width: 830px !important;}
}
					...
					<form class="contact_form" id="appintment_form" action="<?php echo URL::to('/'); ?>/book-an-appointment/store" method="post" enctype="multipart/form-data">
                        ...
                        <div class="cus_tab_form">
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link disabled" id="info-tab" onclick="goto('info')" data-toggle="tab" href="#info" role="tab" aria-controls="info" aria-selected="true">Information</a>
								</li>
								<!--<li class="nav-item">
								...
								<li class="nav-item">
									<a class="nav-link disabled" id="confirm-tab" onclick="goto('confirm')" data-toggle="tab" href="#confirm" role="tab" aria-controls="confirm" aria-selected="false">Confirmation</a>
								</li>
							</ul>


                            <div id="confirm_div" class="col-12 col-md-6 col-lg-6" style="margin-left: 10px;width: 90%;">
                                <div class="row" id="nature_of_enquiry">
...
jQuery(document).ready(function($){
    ...
    /*var screenwidth = $(window).width(); console.log('screenwidth-load='+screenwidth);
    if(screenwidth<=1300){
        screenwidth = screenwidth+'px !important';
        $(".confirmTblCls").css("width",screenwidth);
    }
    
    $( window ).bind("resize", function(){
        var screenwidthresize = $(window).width(); console.log('screenwidth-resize='+screenwidthresize);
        if(screenwidthresize<=1300){
            screenwidthresize = screenwidthresize+'px !important';
            $(".confirmTblCls").css("width",screenwidthresize);
        }
