			...
			<div class="col-12 col-md-12">
				<div class="cus_inner_content">
					...
					<ol>
						...
						<li><span style="font-size: 15px;">Migration Advice: our charges are $110 for most type of migration advice. Please select this option, if your matter is complicated and will require more than 15 mins or you want PR advice over the phone.</span></li>
					</ol>
...
jQuery(document).ready(function($){
    ...
    $(document).delegate('.timeslot_col', 'click', function(){
        ...
        //var service_id_val = service_id_val;
        ...
        */
        /*if( enquiry_item == 1 || enquiry_item == 6  || enquiry_item == 7 || enquiry_item == 8 ) {
            if( service_id_val  == 1) {
                var final_service_id = 1;
            }  if( service_id_val  == 2) {
                var final_service_id = 2;
            }
        }
