...
@section('seoinfo')
    ...
    <?php }  else { ?>
     <title>Bansal Immigration-Your Future, Our Priority</title>
    <?php } ?>
    ...
    <?php }  else { ?>
     <meta name="description" content="Bansal Immigration-Your Future, Our Priority" />
    <?php } ?>
	...
	<?php }  else { ?>
     <meta property="og:title" content="Bansal Immigration-Your Future, Our Priority" />
	<?php } ?>

    <?php if( isset($blogdetailists->meta_description) && $blogdetailists->meta_description != "") { ?>
     <meta property="og:description" content="{{@$blogdetailists->meta_description}}" />
	<?php }  else { ?>
     <meta property="og:description" content="Bansal Immigration-Your Future, Our Priority" />
	<?php } ?>
			...
			<div class="row"> 
				<div class="col-12">
					<div class="inner_blog">
						...
						<!--<a href="<?php echo URL::to('/'); ?>/{{@$list->slug}}"><img src="https://bansalcrm.com/public/img/blog/{{@$blogdetailists->image}}"></img></a>--> 
						{{--@endif--}}
