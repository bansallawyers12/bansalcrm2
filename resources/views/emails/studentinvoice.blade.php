                        ...
                        <td style="text-align: left;">
                            ...
                            <p style="font-size: 15px;line-height: 21px;color: #333;font-weight: normal;margin: 55px 0px 0px;">
                                <?php if( !empty($record_get) ) { ?>
                                    Invoice Date: {{$record_get[0]->invoice_date}}
                                <?php } ?>
                            </p>
                        </td>
					...
					<tr>
                        <td style="text-align: left;">
							<p style="font-size: 15px;line-height: 21px;color: #333;font-weight: normal;margin: 10px 0px 0px;">
                                ...
                                Trading AS: <br> {{ $partnerInfo->partner_name }} <br/>
                                <?php } ?>

                                <?php if( isset($partnerInfo->business_reg_no) && $partnerInfo->business_reg_no != ""){ ?>
                                ABN: {{ $partnerInfo->business_reg_no }} <br/>
                                <?php } ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    if( !empty($record_get) )
                                                    {
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td>{{ ($record_key+1) }}</td>
                                                                <td>{{ strtoupper($record_value->student_name).' ('.$record_value->student_ref_no.')  '.$record_value->student_info_id }}</td>
