				...
				<tbody>
					<tr>
                        <td style="text-align: left;">
							<h2 style="font-size:18px;line-height:21px;color:#000;">TAX INVOICE</h2>
                            <p style="font-size: 15px;line-height: 21px;color: #333;font-weight: normal;margin: 10px 0px 0px;">
                                ...
                                {{$partnerInfo->city.' '.$partnerInfo->state }} <br/>
                                <?php } ?>

                                <?php if( isset($partnerInfo->country) && $partnerInfo->country != ""){ ?>
                                {{ $partnerInfo->country }} <br/>
                                <?php } ?>
                            </p>
                        </td>
                        ...
                        { ?>
                            <td style="text-align: center;">
                                <p style="font-size:18px;line-height:21px;color:#000;">Invoice Date <br/> {{$record_get[0]->invoice_date}}</p>
                                <p style="font-size:18px;line-height:21px;color:#000;">Invoice Number <br/> {{$record_get[0]->invoice_no}}</p>
                            </td>
                        <?php
                        } ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    if( !empty($record_get) )
                                                    {
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td>{{ ($record_key+1) }}</td>
                                                                <td>{{ $record_value->student_ref_no.' '.$record_value->student_name }}</td>
                                                                <td>${{ $record_value->amount_aud }}</td>
                                                            </tr>
                                                        <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="border-top: 1px solid #000;">${{$total_amount_aud}}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
