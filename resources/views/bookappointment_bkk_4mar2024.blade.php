...
@media (max-width: 480px) {
    ...
    /*.table-responsive {width: 42% !important;}*/
}
...
@media (min-width: 768px) and (max-width: 1024px){
    .datePickerCls {height: 230px;width:200px;}
    .timeslotDivCls { width:65%;margin-top: 25px;}
    .confirmTblCls {width: 468px !important;}
}
				...
				<div class="appointment_form_tabs">
					<form class="contact_form" id="appintment_form" action="<?php echo URL::to('/'); ?>/book-an-appointment/store" method="post" enctype="multipart/form-data">
                        ...
                        <div class="cus_tab_form">
                            ...
                            <div id="confirm_div" class="col-12 col-md-6 col-lg-6" style="margin-left: 10px;width: 90%;">

                                <div class="row nature_of_enquiry_row" id="nature_of_enquiry">
                                    <div class="form-group">
                                        <label for="noe_id" style="margin-top: 10px;">Nature of Enquiry </label>
...
jQuery(document).ready(function($){
    ...
    /*var screenwidth = $(window).width(); //alert('screenwidth-load='+screenwidth);
    if(screenwidth<=1300){
        screenwidth = screenwidth-20;
        screenwidth = screenwidth+'px'; console.log('screenwidth-load='+screenwidth);
        $(".confirmTblCls").css("width",screenwidth+" !important");
    }
    
    $( window ).bind("resize", function(){
        var screenwidthresize = $(window).width(); //console.log('screenwidth-resize='+screenwidthresize);
        if(screenwidthresize<=1300){
            screenwidthresize = screenwidthresize-20;
            screenwidthresize = screenwidthresize+'px'; console.log('screenwidth-resize='+screenwidthresize);
            $(".confirmTblCls").css("width",screenwidthresize+" !important");
        }
