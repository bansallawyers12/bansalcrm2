			...
			<div class="row justify-content-center">
				<div class="col-12 col-lg-8">
					<div class="d-flex justify-content-between align-items-center mb-3">
						<h4 class="mb-0">Create blocked time</h4>
						<a href="{{ followups_console_route('blocked-times.index') }}" class="btn btn-outline-secondary btn-sm">Back to list</a>
					</div>
					<div class="card">
						<div class="card-body">
							<form method="post" action="{{ followups_console_route('blocked-times.store') }}">
								@csrf
								@include('Admin.followups.blocked-times._form', ['block' => null])
