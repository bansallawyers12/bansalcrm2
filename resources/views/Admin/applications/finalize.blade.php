					...
					<div class="card">
						...
						<div class="card-body">
						    ...
						    <div class="filter_panel">
								...
								<form action="{{URL::to('/admin/applications-finalize')}}" method="get">
									<div class="row">
										<div class="col-md-4">
										...
										<div class="col-md-4">
											<div class="form-group">
                                                ...
                                                <select class="form-control" name="partner">
                                                    ...
                                                    <option @if(Request::get('partner') == $allpartner->id) selected @endif value="{{$allpartner->id}}">{{$allpartner->partner_name}}</option>
                                                    @endforeach
												</select>
                                            </div>
										</div>
									...
									<div class="row">
										<div class="col-md-12 text-center">
											...
											<a class="btn btn-info" href="{{URL::to('/admin/applications-finalize')}}">Reset</a>
										</div>
									</div>
								</form>
							</div>
