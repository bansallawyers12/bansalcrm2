                ...
                <div class="col-9 col-md-9 col-lg-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button type="button" id="add-more" class="btn btn-primary add-more">Add More Dates and slots</button>
                            ...
                            <div id="time-slots-container">
                                ...
                                <div class="row" style="margin-top:70px;">
                                    <div class="col-3 col-md-3 col-lg-3">
                                        <div class="form-group">
                                            <label for="time-slot-1" class="timeSlotCls">Date And Time Slot <?php echo $diskey+1;?>:</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <select id="select-box-container_1" name="slots[<?php echo $diskey;?>][]" multiple>
                                            <?php
                                ...
                                <div class="row" style="margin-top:70px;">
                                    <div class="col-3 col-md-3 col-lg-3">
                                        <div class="form-group">
                                            <label for="time-slot-1" class="timeSlotCls">Date And Time Slot 1:</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3 col-md-3 col-lg-3">
                                        <div class="form-group">
                                            <label for=""></label>
                                            <input type="text" class="form-control date" name="disabledates[0][]"/>
                                            @if ($errors->has('disabledates'))
                                                <span class="custom-error" role="alert">
                                                    <strong>{{ @$errors->first('disabledates') }}</strong>
                                                </span>
...
jQuery(document).ready(function($){
    ...
    $('#add-more').click(function() {
        ...
        if( startMinutes == 0 && endMinutes == 0 ) {
            var $newSelectBox = generateTimeSlots1(startHour, endHour,30,slotCount1);
        } else if( startMinutes == 0 && endMinutes != 0 ) {
            var $newSelectBox = generateTimeSlots2(startHour, endHour, endMinutes,30,slotCount1);
        } else if( startMinutes != 0 && endMinutes != 0 ) {
            var $newSelectBox = generateTimeSlots3(startHour, startMinutes, endHour,endMinutes,30,slotCount1);
        }
        const newSlot = '<div class="row"><div class="col-3 col-md-3 col-lg-3"><div class="form-group"><label for="time-slot-1" class="timeSlotCls">Date And Time Slot '+slotCount+':</label></div></div><div class="col-3 col-md-3 col-lg-3"><div class="form-group"><label for=""></label></div></div><div class="col-6 col-md-6 col-lg-6"><div class="form-group"><label for=""></label><input type="text" class="form-control date" style="width: 47%;margin-left: -194px;" name="disabledates['+slotCount1+'][]"><div id="select-box-container_'+slotCount+'" style="margin-top: -60px;"></div></div></div></div>';
