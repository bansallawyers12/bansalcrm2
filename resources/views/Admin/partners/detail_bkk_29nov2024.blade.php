                                                    ...
                                                    <tr style="height:25px;">
                                                        ...
                                                        <td>
                                                            ...
                                                            if($data->total_course_fee_amount != ""){
                                                                ...
                                                                echo $total_course_fee_amount = 'N/P';
                                                            } ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            if($data->total_anticipated_fee != ""){
                                                                ...
                                                                echo $total_anticipated_fee = 'N/P';
                                                            } ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            if($data->fee_reported_by_college != ""){
                                                                ...
                                                                echo $fee_reported_by_college = 'N/P';
                                                            } ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            if($data->commission_as_per_anticipated_fee != ""){
                                                                ...
                                                                echo $commission_as_per_anticipated_fee = 'N/P';
                                                            } ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            if($data->commission_as_per_fee_reported != ""){
                                                                ...
                                                                echo $commission_as_per_fee_reported = 'N/P';
                                                            } ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            if($data->commission_payable_as_per_anticipated_fee != ""){
                                                                ...
                                                                echo $commission_payable_as_per_anticipated_fee = 'N/P';
                                                            } ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            if($data->commission_paid_as_per_fee_reported != ""){
                                                                ...
                                                                echo $commission_paid_as_per_fee_reported = 'N/P';
                                                            } ?>
                                                        </td>
                                ...
                                <div class="tab-pane fade" id="invoice" role="tabpanel" aria-labelledby="invoice-tab">
                                    <div class="row">
										<div class="col-md-12 mt-3 mb-3">
                                            ...
                                            //$Total_Projected_Fee = DB::table('partner_student_invoices')->where('partner_id',$fetchedData->id)->where('invoice_type',3)->sum('amount_aud');
                                            //dd($Total_Projected_Fee);
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table border="1" style="margin-bottom:0rem !important;" class="table text_wrap table-striped table-hover table-md vertical_align">
                                                        ...
                                                        <tbody class="productitemList_invoice">
                                                            ...
                                                            ?>
                                                            <tr  id="TrRow_<?php echo $inv_val->id;?>">
                                                                <td>
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table border="1" style="margin-bottom:0rem !important;" class="table text_wrap table-striped table-hover table-md vertical_align">
                                                        ...
                                                        <tbody class="productitemList_payment">
                                                            ...
                                                            ?>
                                                            <tr  id="TrRow_<?php echo $pay_val->id;?>">
                                                                <td>
...
jQuery(document).ready(function($){
	...
	$(document).delegate('.sent_option', 'change', function(){
        var $select = $(this); // Get the current select element
        ...
        if(sel_invoice_id != "" && sel_option_val == 'Yes'){
            ...
            /*var result = confirm("Are you sure you want to confirm the invoice?");
            if(result){
                $.ajax({
                    type:'post',
                    url: '{{URL::to('/admin/partners/updateInvoiceSentOptionToYes')}}',
                    sync:true,
                    data: {sel_invoice_id:sel_invoice_id},
                    success: function(response){
                        location.reload();
                    }
                });
