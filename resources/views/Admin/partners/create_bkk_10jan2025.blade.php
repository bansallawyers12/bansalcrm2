											...
											<div class="row">
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
                                                        ...
                                                        <a href="javascript:;" class="btn btn-outline-primary openpartnerphonenew" style="margin-bottom: 5px;margin-left: 30px;"><i class="fa fa-plus"></i> Add Phone Number</a>
    ...
    $(document).delegate('.savepartneremail','click', function() {
        ...
        if ($('table#metatag_table').find('#metatag_'+itag_email).length > 0) {
            ...
            if(!flag){
                ...
                var html = '<div class="row" id="metatag_'+itag_email+'">';
