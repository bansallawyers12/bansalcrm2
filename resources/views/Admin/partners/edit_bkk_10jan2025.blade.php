									...
									<div class="accordion">
										...
										<div class="accordion-body collapse show" id="contact_details" data-parent="#accordion" >
                                            ...
                                            <div class="partnerphonedata">
                                                <?php
                                                $partnerphones = \App\PartnerPhone::where('partner_id', $fetchedData->id)->get();
                                                $iii=0;
                                                ...
                                                if(count($partnerphones)>0) {
                                                    ...
                                                    ?>
                                                    <script>
                                                    partnerphonedata[<?php echo $iii; ?>] = { "country_code" :'<?php echo $partnerphone->partner_country_code; ?>',"phone" :'<?php echo $partnerphone->partner_phone; ?>'}
                                                    </script>
                                                    <div class="row" id="metatag2_{{$iii}}">
                                                        <div class="col-12 col-md-4 col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="cus_field_input">
                                                                    <div class="country_code">
                                                                        <input class="telephone" id="telephone" type="tel" name="partner_country_code[]" value="<?php echo $partnerphone->partner_country_code;?>" readonly >
                                                                    </div>
                                                                    {{ Form::text('partner_phone[]', $partnerphone->partner_phone, array('class' => 'form-control tel_input', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Enter Phone' ,'readonly' => 'readonly')) }}
                                            ...
                                            <a href="javascript:;" class="btn btn-outline-primary openpartneremailnew"><i class="fa fa-plus"></i> Add Email</a>
                                            ...
                                            <div class="partneremaildata">
                                                <?php
                                                $partneremails = \App\PartnerEmail::where('partner_id', $fetchedData->id)->get();
                                                $ii=0;
                                                ...
                                                if(count($partneremails)>0) {
                                                    ...
                                                    ?>
                                                    <script>
                                                    partneremaildata[<?php echo $ii; ?>] = { "email" :'<?php echo $partneremail->partner_email; ?>'}
                                                    </script>
                                                    <div class="row" id="metatag1_{{$ii}}">
                                                        <div class="col-12 col-md-4 col-lg-4">
                                                            <div class="form-group">
                                                                <label for="partner_email">Email</label>
                                                                <input class="form-control" readonly autocomplete="off" placeholder="" name="partner_email[]" type="text" value="{{$partneremail->partner_email}}">
                                                            </div>
...
jQuery(document).ready(function($){
    ...
    $(document).delegate('.savepartneremail','click', function() {
        ...
        if ($('table#metatag_table').find('#metatag1_'+itag_email).length > 0) {
            ...
            if(!flag){
                ...
                console.log(str);
                partneremaildata[itag_email] = {"email":str[0].value}
                console.log(partneremaildata);
                var html = '<div class="row" id="metatag1_'+itag_email+'">';
    ...
    $(document).delegate('.savepartnerphone','click', function() {
        ...
        if ($('table#metatag_table').find('#metatag2_'+itag_phone).length > 0) {
            ...
            var flag = false;
            if(partner_phone == ''){
                $('.partner_phone_error').html('The Email field is required.');
            ...
            if(!flag){
                ...
                console.log(str);
                partnerphonedata[itag_phone] = {"country_code":str[0].value ,"phone":str[1].value}
                console.log(partnerphonedata);

                var html = '<div class="row" id="metatag_'+itag_phone+'">';
                            ...
                            html += '<div class="form-group">';
                                ...
                                html += '<div class="cus_field_input">';
                                    html += '<div class="country_code">';
                                        html += '<input class="telephone" id="telephone" type="tel" name="partner_country_code[]" value="'+str[0].value+'" readonly >';
                                    html += '</div>';
                                    html += '<input class="form-control tel_input" readonly autocomplete="off" placeholder="Enter Phone" name="partner_phone[]" type="text" value="'+str[1].value+'">';
                                html += '</div>';
