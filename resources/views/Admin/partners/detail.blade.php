...
jQuery(document).ready(function($){
    // Handlers moved to modules:
    // - application-tab.js
    // - notes-handlers.js
    // - mail-upload.js

    // Invoice and payment handlers moved to invoice-handlers.js module
    
   
    // Promotion handlers moved to promotion-handlers.js module

    // Notes/contact/email handlers moved to notes-contact-handlers.js module
    // Payment field handlers moved to payment-field-handlers.js module
    // Notes/contact/email handlers moved to notes-contact-handlers.js module
...
function formatRepoSelection (repo) {
  ...
  // DataTable handlers moved to datatable-handlers.js module
...
$(document).delegate('#intrested_workflow', 'change', function(){
    ...
    // Application handlers moved to application-handlers.js module
