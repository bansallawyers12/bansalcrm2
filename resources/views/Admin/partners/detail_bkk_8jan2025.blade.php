											...
											<tbody class="tdata invoicedatalist">
                                                ...
                                                { ?>
                                                    <tr style="height:25px;">
                                                        ...
                                                        <td>
                                                            <button style="margin-bottom:3px;"  class="btn btn-sm btn-primary change-status-btn"
                                                                data-id="<?php echo $data->id; ?>"
                                                                data-current-status="<?php echo $data->status; ?>"
                                                                data-toggle="modal"
...
jQuery(document).ready(function($){
    ...
    $('#popoverdatetime').datepicker({ format: 'dd/mm/yyyy',todayHighlight: true,autoclose: true }).datepicker('setDate', new Date());
