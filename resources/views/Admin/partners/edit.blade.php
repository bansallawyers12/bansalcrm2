						...
						<div class="card">
							<div class="card-header">
								...
								<div class="card-header-action">
									<a href="{{route('partners.index')}}" class="btn btn-primary">@icon('arrow-left') Back</a>
								</div>
							</div>
						</div>
					</div>
								...
								<div id="accordion">
									...
									<div class="accordion">
										...
										<div class="accordion-body collapse show" id="contact_details" data-parent="#accordion" >
                                            ...
                                            <!--<div class="row">
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group">
                                                        ...
                                                        <a href="javascript:;" class="btn btn-outline-primary openpartneremailnew" style="margin-bottom: 5px;margin-left: 145px;">@icon('plus') Add Email</a>
											...
											<!--<a href="javascript:;" class="btn btn-outline-primary openpartnerphonenew">@icon('plus') Add Phone</a>-->

                                            <div class="col-12 col-md-12 col-lg-12">
                                                <div class="row">
                                                    <div class="col-6 col-md-6 col-lg-6">
                                                       <a href="javascript:;" class="btn btn-outline-primary openpartnerphonenew" style="margin: 10px 0px 15px 0px;">@icon('plus') Add Contact</a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                if(count($partnerphones)>0) {
                                                    ...
                                                    <div class="col-12 col-md-12 col-lg-12">
                                                        <div class="row" id="metatag2_{{$iii}}">
                                                            ...
                                                            <a href="javascript:;" dataid="{{$iii}}" class="editpartnerphone">@icon('edit')</a>-->
                                                                <a href="javascript:;" dataid="{{$iii}}" partnerphoneid="{{$partnerphone->id}}" class="deletepartnerphone">@icon('times')</a>
                                                            </div>--}}
                                                        </div>
                                                    </div>
                                                    <?php
                                            ...
                                            <div class="col-12 col-md-12 col-lg-12">
                                                <div class="row">
                                                    <div class="col-6 col-md-6 col-lg-6">
                                                    <a href="javascript:;" class="btn btn-outline-primary openpartneremailnew" style="margin: 10px 0px 15px 0px;">@icon('plus') Add Email</a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                if(count($partneremails)>0) {
                                                    ...
                                                    <div class="col-12 col-md-12 col-lg-12">
                                                        <div class="row" id="metatag1_{{$ii}}">
                                                            ...
                                                            {{--<div class="col-12 col-md-1 col-lg-1">
                                                            <a href="javascript:;" dataid="{{$ii}}" class="editpartneremail">@icon('edit')</a>-->
                                                                <a href="javascript:;" dataid="{{$ii}}" partneremailid="{{$partneremail->id}}" class="deletepartneremail">@icon('times')</a>
                                                            </div>--}}
                                                        </div>
                                                    </div>
                                                    <?php
									...
									<div class="accordion">
										...
										<div class="accordion-body collapse show" id="branch" data-parent="#accordion">
                                            <div class="row">
                                                <div class="col-12 col-md-12 col-lg-12">
                                                    <a href="javascript:;" class="btn btn-outline-primary openbranchnew" >@icon('plus') Add Branch</a>
                                                </div>
                                            </div>
                                            <script>
                                            ...
                                            <div class="branchdata">
                                                ...
                                                if(count($branches)>0) {
                                                    ...
                                                    <div class="row" id="metatag_{{$i}}">
                                                        ...
                                                        <div class="col-12 col-md-1 col-lg-1">
                                                            <a href="javascript:;" dataid="{{$i}}" class="editbranch">@icon('edit')</a>
                                                            <a href="javascript:;" dataid="{{$i}}" branchid="{{$branch->id}}" class="deletebranch">@icon('times')</a>
                                                        </div>
                                                    </div>
                                                    <?php
                                                    $i++;
...
jQuery(document).ready(function($){
	...
	$(document).delegate('.savebranch','click', function(){
		...
		if ($('table#metatag_table').find('#metatag_'+itag).length > 0) {
            ...
            if(!flag){
                ...
                html +=  '<a href="javascript:;" dataid="'+itag+'" class="editbranch">@icon('edit')</a>';
                html +=  '<a href="javascript:;" dataid="'+itag+'" class="deletebranch">@icon('times')</a>';
                html += '</div>';
				html += '</div></div>';
	...
	$(document).delegate('#update_branch','click', function(){
        ...
        if(!flag){
            ...
            html += '<input autocomplete="off" placeholder="" name="branchstate[]" type="hidden" value="'+str[4].value+'"><input autocomplete="off" placeholder="" name="branchaddress[]" type="hidden" value="'+str[5].value+'"><input autocomplete="off" placeholder="" name="branchzip[]" type="hidden" value="'+str[6].value+'"><input autocomplete="off" placeholder="" name="branchreg[]" type="hidden" value="'+str[7].value+'"><input autocomplete="off" placeholder="" name="branchcountry_code[]" type="hidden" value="'+str[8].value+'"><input autocomplete="off" placeholder="" name="branchphone[]" type="hidden" value="'+str[9].value+'"><input autocomplete="off" placeholder="" name="branchid[]" type="hidden" value="<?php if(isset($branch->id)){echo $branch->id;} ?>"></div>';
            html += '<div class="col-12 col-md-1 col-lg-1">';
            html +=  '<a href="javascript:;" dataid="'+mtval+'" class="editbranch">@icon('edit')</a>';
            html +=  '<a href="javascript:;" dataid="'+mtval+'" class="deletebranch">@icon('times')</a>';
            html += '</div>';
            html += '</div>';
        ...
        if ($('table#metatag_table').find('#metatag1_'+itag_email).length > 0) {
            ...
            if(!flag){
                ...
                var html = '<div class="col-12 col-md-12 col-lg-12">';
                    ...
                    //html += '<div class="col-12 col-md-1 col-lg-1">';
                    //html +=  '<a href="javascript:;" dataid="'+itag_email+'" class="editpartneremail">@icon('edit')</a>';
                    //html +=  '<a href="javascript:;" dataid="'+itag_email+'" class="deletepartneremail">@icon('times')</a>';
                    //html += '</div>';
                    html += '</div>';
	...
	/*$(document).delegate('#update_partneremail','click', function(){ console.log('click-update=');
        ...
        if(!flag){
            ...
            var html = '<div class="col-12 col-md-3 col-lg-3">';
                ...
                //html += '<div class="col-12 col-md-1 col-lg-1">';
                //html +=  '<a href="javascript:;" dataid="'+mtval_email+'" class="editpartneremail">@icon('edit')</a>';
                //html +=  '<a href="javascript:;" dataid="'+mtval_email+'" class="deletepartneremail">@icon('times')</a>';
                //html += '</div>';
                html += '</div>';
        ...
        if ($('table#metatag_table').find('#metatag2_'+itag_phone).length > 0) {
            ...
            if(!flag){
                ...
                var html = '<div class="col-12 col-md-12 col-lg-12">';
                    ...
                    //html += '<div class="col-12 col-md-1 col-lg-1">';
                    //html +=  '<a href="javascript:;" dataid="'+itag_phone+'" class="editpartnerphone">@icon('edit')</a>';
                    //html +=  '<a href="javascript:;" dataid="'+itag_phone+'" class="deletepartnerphone">@icon('times')</a>';
                    //html += '</div>';
                    html += '</div></div>';
