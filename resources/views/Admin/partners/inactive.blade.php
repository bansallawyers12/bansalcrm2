					...
					<div class="card">
						...
						<div class="card-body">
						    ...
						    <div class="filter_panel">
								...
								<form action="{{URL::to('/admin/partners-inactive')}}" method="get">
									<div class="row">
										<div class="col-md-3">
								...
								<table class="table text_wrap">
									...
									<tbody class="tdata">
										...
										<?php
                                            ...
                                            $latestnote = \App\Note::select('title','description')->where('client_id',$list->id)->whereNull('assigned_to')->whereNull('task_group')->where('type','partner')->orderby('pin', 'DESC')->orderBy('created_at', 'DESC')->first();
