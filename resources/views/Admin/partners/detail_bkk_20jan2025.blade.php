						...
						<div class="card-body">
							<p class="clearfix"> 
								...
								<span class="float-right text-muted">
                                    {{--$fetchedData->phone--}}
                                    <?php
                                    if( \App\PartnerPhone::where('partner_id', $fetchedData->id)->exists()) {
                                        $partnerContacts = \App\PartnerPhone::select('partner_phone','partner_country_code','partner_phone_type')->where('partner_id', $fetchedData->id)->get();
                                    } else {
                                        if( \App\Partner::where('id', $fetchedData->id)->exists()){
                                            $partnerContacts = \App\Partner::select('phone as partner_phone','country_code as partner_country_code')->where('id', $fetchedData->id)->get();
                                        } else {
							...
							<p class="clearfix"> 
								...
								<span class="float-right text-muted">
                                    {{--$fetchedData->email--}}
                                    <?php
                                    if( \App\PartnerEmail::where('partner_id', $fetchedData->id)->exists()) {
                                        $partnerEmails = \App\PartnerEmail::select('partner_email','partner_email_type')->where('partner_id', $fetchedData->id)->get();
                                    } else {
                                        if( \App\Partner::where('id', $fetchedData->id)->exists()){
                                            $partnerEmails = \App\Partner::select('email as partner_email')->where('id', $fetchedData->id)->get();
                                        } else {
                                            $partnerEmails = array();
                                        }
                                    }
				...
				$workflow = \App\Workflow::where('id', $alist->workflow)->first();
                                 ...
                                 <div class="tab-pane fade" id="partner-activities" role="tabpanel" aria-labelledby="partner-activities-tab">
                                    <div class="activities">
                                        <?php
                                        $activities = \App\ActivitiesLog::where('client_id', $fetchedData->id)->where('task_group', 'partner')->orderby('created_at', 'DESC')->get();
                                        //dd($activities);
                                        foreach($activities as $activit){
                                            $admin = \App\Admin::select('id', 'first_name', 'last_name')->where('id', $activit->created_by)->first();
                                            ?>
								...
								<div class="tab-pane fade" id="noteterm" role="tabpanel" aria-labelledby="noteterm-tab">
									...
									$querynotelist = \App\Note::where('client_id', $fetchedData->id)->where('type', 'partner')->whereNull('task_group')->orderby('pin', 'DESC')->orderby('created_at', 'DESC');
										...
										<div class="tab-content" id="conversationContent">
											<div class="tab-pane fade show active" id="inbox" role="tabpanel" aria-labelledby="inbox-tab">
                                                ...
                                                <div class="tab-content" id="conversationContent">
                                                    <div class="tab-pane show active" id="fetchemail" role="tabpanel" aria-labelledby="fetchemail-tab">
                                                        <?php
                                                        //inbox mail
                                                        $mailreports = \App\MailReport::where('client_id',$fetchedData->id)->where('type','partner')->where('mail_type',1)->where('conversion_type','partner_email_fetch')->where('mail_body_type','inbox')->orderby('created_at', 'DESC')->get();
                                                        //dd($mailreports);
                                                        foreach($mailreports as $mailreport)
                                                        {
                                                            $DocInfo = \App\Document::select('id','doc_type','myfile','mail_type')->where('id',$mailreport->uploaded_doc_id)->first();
                                                            $PartnerInfo = \App\Partner::select('id','partner_name','email')->where('id',$mailreport->client_id)->first();
                                                        ?>
                                            ...
                                            <div class="tab-pane fade" id="sent" role="tabpanel" aria-labelledby="sent-tab">
                                                ...
                                                foreach($mailreports as $mailreport){
                                                    ...
                                                    $partner = \App\Partner::Where('id', $fetchedData->id)->first();
                                                ...
                                                <div class="tab-content" id="studentContent">
                                                    <div class="student_drop_table_data" style="display: inline-block;margin-right: 10px;">
                                                        ...
                                                        <div class="dropdown_list student_dropdown_list">
                                                            ...
                                                            <label class="dropdown-option"><input type="checkbox" value="19" checked /> Commission paid as per fee Reported</label>
                                                            <label class="dropdown-option"><input type="checkbox" value="20" checked /> Commission Pending</label>
                                                            <label class="dropdown-option"><input type="checkbox" value="21" checked /> Student Status</label>
                                                        </div>
                                                    </div>
                                                    <div class="table-responsive student_table_data">
                                                        ...
                                                        <table class="table text_wrap table-3">
                                                            ...
                                                            <tbody class="invoicedatalist">
                                                                <?php
                                                                //dd($fetchedData->id);
                                                                $studentdatas = \App\Application::join('admins', 'applications.client_id', '=', 'admins.id')
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            if($data->client_reference){
                                                                                ...
                                                                                echo $client_reference = '<a href="'.url('/admin/clients/detail/'.$client_encoded_id).'" target="_blank" >'.$data->client_reference.'</a>';
                                                                            } else {
                                                ...
                                                <div class="table-responsive student_table_data1">
                                                    <table class="table text_wrap table-31">
                                                        ...
                                                        <tbody class="invoicedatalist">
                                                            <?php
                                                            //dd($fetchedData->id);
                                                            $studentdatas1 = \App\Application::join('admins', 'applications.client_id', '=', 'admins.id')
                                                            ->leftJoin('partners', 'applications.partner_id', '=', 'partners.id')
                                                            ->leftJoin('products', 'applications.product_id', '=', 'products.id')
                                                            ->leftJoin('application_fee_options', 'applications.id', '=', 'application_fee_options.app_id')
                                                            ->select(
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        if($data1->client_reference){
                                                                            ...
                                                                            echo $client_reference1 = '<a href="'.url('/admin/clients/detail/'.$client_encoded_id1).'" target="_blank" >'.$data1->client_reference.'</a>';
                                                                        } else {
                                                                    ...
                                                                    <td style="white-space: initial;">
                                                                        <div class="dropdown d-inline">
                                                                            ...
                                                                            <div class="dropdown-menu">
                                                                                ...
                                                                                <!--<a class="dropdown-item has-icon" href="{{--URL::to('/admin/clients/edit/'.base64_encode(convert_uuencode(@$list->id)))--}}">Add Note</a>-->
                                 ...
                                 <div class="tab-pane fade" id="invoice" role="tabpanel" aria-labelledby="invoice-tab">
                                    <div class="row">
										<div class="col-md-12 mt-3 mb-3">
                                            <?php
                                            $studentdataArr = \App\Application::leftJoin('partners', 'applications.partner_id', '=', 'partners.id')
                                            ->leftJoin('application_fee_options', 'applications.id', '=', 'application_fee_options.app_id')
                                            ->select(
                                                'application_fee_options.tution_fees',
                                                'application_fee_options.commission_as_per_fee_reported',
                                                        ...
                                                        <tbody class="productitemList">
                                                            ...
                                                            <tr  id="TrRow_<?php echo $rec_val->invoice_id;?>">
                                                                ...
                                                                <td style="padding-top: 5px !important;padding-bottom: 5px !important;">
                                                                    ...
                                                                    <a target="_blank" class="link-primary" href="{{URL::to('/admin/partners/printpreviewcreateinvoice')}}/{{$rec_val->invoice_id}}"><i class="fa fa-print" aria-hidden="true"></i></a>
               ...
               //location.reload(); // Reload to reflect changes
                ...
                if (data.status) {
                    ...
                    const rowIndex = table.rows().eq(0).filter((rowIdx) => {
                        ...
                        return table.cell(rowIdx, 21).data() == studentId; // Match student ID column
                    });

                    // Update the cell value
                    if (rowIndex.length > 0) {
                        table.cell(rowIndex[0], 20).data(newStatus).draw(); // Update the status column
...
jQuery(document).ready(function($){
   ...
   //////////////////////////////
    ...
    $(document).delegate('.openproductrinfo', 'click', function(){
        ...
        $.ajax({
            type:'post',
            url: '{{URL::to('/admin/partners/getEnrolledStudentList')}}',
            sync:true,
    ...
    function getTopReceiptValInDB(type) {
        $.ajax({
            type:'post',
            url: '{{URL::to('/admin/partners/getTopReceiptValInDB')}}',
            sync:true,
            data: {type:type},
            success: function(response){
    ...
    function getTopInvoiceValInDB(type) {
        $.ajax({
            type:'post',
            url: '{{URL::to('/admin/partners/getTopInvoiceValInDB')}}',
            sync:true,
            data: {type:type},
            success: function(response){
    ...
    $(document).delegate('.student_no_cls', 'change', function(){
        ...
        if(sel_student_id != ""){
            $.ajax({
                type:'post',
                url: '{{URL::to('/admin/partners/getStudentInfo')}}',
                sync:true,
        ...
        if(sel_student_id != "")
        {
            ...
            $.ajax({
                type:'post',
                url: '{{URL::to('/admin/partners/getStudentCourseInfo')}}',
                sync:true,
                    ...
                    confirm: {
                        ...
                        action: function () {
                            ...
                            if (sentDate) {
                                ...
                                $.ajax({
                                    type:'post',
                                    url: '{{URL::to('/admin/partners/updateInvoiceSentOptionToYes')}}',
                                    sync:true,
    ...
    function getInfoByInvoiceId(invoiceid) {
        $.ajax({
            type:'post',
            url: '{{URL::to('/admin/partners/getInfoByInvoiceId')}}',
            sync:true,
    ...
    $(document).delegate('.deletestudentinvoice', 'click', function(){
        ...
        if( invoiceid != "" && confirm('Are you sure you want to delete this invoice?') ) {
            $.ajax({
                type:'post',
                url: '{{URL::to('/admin/partners/deleteStudentRecordByInvoiceId')}}',
                sync:true,
    ...
    function getEnrolledStudentListInEditMode(partnerid,uniqueRowId) {
        $.ajax({
            type:'post',
            url: '{{URL::to('/admin/partners/getEnrolledStudentListInEditMode')}}',
            sync:true,
    ...
    $(document).delegate('.deletestudentrecordinvoice', 'click', function(){
        ...
        if( id != "" && confirm('Are you sure you want to delete this record invoice?') ) {
            $.ajax({
                type:'post',
                url: '{{URL::to('/admin/partners/deleteStudentRecordInvoiceByInvoiceId')}}',
                sync:true,
    ...
    function getRecordedInvoiceList(partnerid) {
        ...
        $.ajax({
            type:'post',
            url: '{{URL::to('/admin/partners/getRecordedInvoiceList')}}',
            sync:true,
            data: {partnerid:partnerid},
            success: function(response){
                var obj = $.parseJSON(response); //console.log('record_get=='+obj.record_get);
    ...
    $('#createrecordpaymentmodal').on('show.bs.modal', function() {
     ...
     $(document).delegate('.deletestudentpaymentinvoice', 'click', function(){
        ...
        if( id != "" && confirm('Are you sure you want to delete this payment invoice?') ) {
            $.ajax({
                type:'post',
                url: '{{URL::to('/admin/partners/deleteStudentPaymentInvoiceByInvoiceId')}}',
                sync:true,
                data: {id:id,invoicetype:invoicetype,partnerid:partnerid},
                success: function(response){
                    var obj = $.parseJSON(response);
...
function getallactivities(){
    ...
    $('#noteType').on('change', function() {
        ...
        if(selectedValue === "Call") {
            ...
            $('.popuploader').show();
            $.ajax({
                url: "{{URL::to('/admin/partners/fetchPartnerContactNo')}}",
                method: "POST",
...
var table33 = $(".table-3").DataTable({
    ...
    drawCallback: function () {
        ...
        var totalCommissionPaidAsPerFeeReported = sumAllRecords(18).toFixed(2);
        var totalCommissionPending = sumAllRecords(19).toFixed(2);
    ...
    $(".dataTables_filter").append(statusFilter);
     ...
     $("#statusFilter").on("change", function () {
        ...
        if (statusFilterval === "") {
            ...
            table33.column(20).search("").draw(); // Adjust index to match "Student Status" column
        } else {
            // Apply filter with regex for exact match
            table33.column(20).search("^" + statusFilterval + "$", true, false).draw();
        }
    });
...
$(".table-31").dataTable({
    ...
    drawCallback: function () {
        ...
        var totalCommissionPaidAsPerFeeReported1 = sumColumn1(18).toFixed(2);
        var totalCommissionPending1 = sumColumn1(19).toFixed(2);
