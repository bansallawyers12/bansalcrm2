					...
					<div class="card">
						<div class="card-body p-0" style="display: block;">
							<ul class="nav nav-pills flex-column"> <!---->
								<li class="nav-item"> <a href="{{route('admin.taxrates')}}" id="ember5167" class="nav-link active ember-view"> Tax Rates </a> </li><!----><!----><!----><!----><li class="nav-item"> <a href="{{route('returnsetting')}}" id="ember5168" class="nav-link ember-view"> GST Settings </a> </li> <!----><!----> </ul>
						</div>
					</div>
				</div>
				<div class="col-md-8">
