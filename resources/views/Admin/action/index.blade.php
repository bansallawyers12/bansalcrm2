						...
						<div class="card-header">
                            ...
                            <ul class="nav nav-pills" id="client_tabs" role="tablist">
                                <li class="nav-item is_checked_clientn12">
									<a class="nav-link" id="assigned_by_me"  href="{{URL::to('/admin/action/assigned-by-me')}}">Assigned by me</a>
								</li>

                                <li class="nav-item is_checked_clientn11">
									<a class="nav-link active" id="archived-tab"  href="{{URL::to('/admin/action/completed')}}">Completed</a>
								</li>
                            </ul>
                        </div>
