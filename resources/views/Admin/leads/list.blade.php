		...
		@if($list->followup_type == 'mail_compose')
			<div> 
				...
				<div class="timeline-item" style="padding: 10px;">
					...
					<span class="name">{{@$list->staff->first_name}} {{@$list->staff->last_name}}</span> <a  onclick="return confirm('Are you sure?')" style="color:#808080;" href="{{URL::to('/leads/notes/delete/'.$list->id)}}"><i style="color:#6777ef;"  class="fa fa-trash"></i></a>
