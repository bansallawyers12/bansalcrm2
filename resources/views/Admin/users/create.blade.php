...
<div class="main-content">
	<section class="section">
		...
		<div class="server-error">
			...
			{!! Form::open(array('url' => 'users/store', 'name'=>"edit-user", 'autocomplete'=>'off', "enctype"=>"multipart/form-data"))  !!}
						...
						<div class="card">
							<div class="card-header">
								...
								<div class="card-header-action">
									<a href="{{route('users.active')}}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group">
									...
									<select name="default_email_id" id="default_email_id" class="form-control">
										...
										@foreach($emails as $mail)
											<option value="{{ $mail->id }}" {{ old('default_email_id') == $mail->id ? 'selected' : '' }}>{{ $mail->email }}{{ $mail->display_name ? ' (' . $mail->display_name . ')' : '' }}</option>
										@endforeach
									</select>
								...
								<div class="form-group">
									...
									<textarea name="email_signature" id="email_signature" class="form-control summernote-simple" rows="6" placeholder="e.g. Regards, {{ name }}">{{ old('email_signature', '') }}</textarea>
