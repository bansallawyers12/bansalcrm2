							...
							{!! Form::open(array('url' => 'invoice/store', 'name'=>"add-invoice", 'autocomplete'=>'off', "enctype"=>"multipart/form-data"))  !!}
												...
												<tr class="item_row" style="display:none;">
													...
													<td class="last_item_col">
														...
														<div class="item_action">
															<!--<a class="item_clone" href="javascript:;">@icon('copy')</a>-->
															<a class="item_remove" href="javascript:;">@icon('close')</a>
														</div>
													</td>
													</tr>
								...
								<div style="margin-bottom:0px;" class="form-group float-end invoice_save_btn">
									...
									<div class="dropdown-menu" x-placement="top-start">
										...
										<a savetype="save_send" class="dropdown-item" tabindex="-1" href="javascript:;" onClick='customInvoiceValidate("add-invoice", "save_send")'>@icon('envelope') Save & Send</a>
										
										<a savetype="save_share" class="dropdown-item" tabindex="-1" href="javascript:;" onClick='customInvoiceValidate("add-invoice", "save_share")'>@icon('share') Save & Share</a>
										
										<a savetype="save_send_later" class="dropdown-item" tabindex="-1" href="javascript:;" onClick='customInvoiceValidate("add-invoice", "save_send_later")'>@icon('times') Save & Send Later</a>
									</div>
