						...
						<div class="card">
							<div class="card-header">
								...
								<div class="card-header-action">
									<a href="{{route('products.index')}}" class="btn btn-primary">@icon('arrow-left') Back</a>
								</div>
							</div>
						</div>
					</div>
											...
											<div class="row">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<select data-valid="required" class="form-control tomselect" id="intrested_product" name="partner">
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<select data-valid="required" class="form-control tomselect" id="intrested_branch" name="branches">
...
jQuery(document).ready(function($){
	...
	$(document).delegate('#intrested_product', 'change', function(){
		...
		if (v != '') {
			...
			reinitTomSelectAfterHtml('#intrested_branch', '<option value="">Select</option>', productBranchOpts);
		}
	});
});
</script>
