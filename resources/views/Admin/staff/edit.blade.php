...
<div class="main-content">
	<section class="section">
		...
		<div class="server-error">
			...
			{!! Form::open(array('url' => 'staff/edit', 'name'=>"edit-staff", 'autocomplete'=>'off', "enctype"=>"multipart/form-data"))  !!}
						...
						<div class="card">
							<div class="card-header">
								...
								<div class="card-header-action">
									<a href="{{route('staff.active')}}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group"> 
									...
									{!! Form::text('first_name', @$fetchedData->first_name, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Staff First Name' ))  !!}
								...
								<div class="form-group">
									...
									{!! Form::text('last_name', @$fetchedData->last_name, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Staff Last Name' ))  !!}
								...
								<div class="form-group">
									...
									<input type="password" value="" name="password" class="form-control" autocomplete="off" placeholder="Enter Password (leave blank to keep current)" data-valid="" />							
								...
								<div class="form-group">
									...
									<input type="password" value="" name="password_confirmation" class="form-control" autocomplete="off" placeholder="Enter Password" data-valid="" />							
									@if ($errors->has('password'))
										<span class="custom-error" role="alert">
											<strong>{{ @$errors->first('password') }}</strong>
										</span> 
					...
					<div class="col-12 col-md-6 col-lg-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group">
									<label for="role">Staff Role (Type)</label>
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<label><input @checked(filter_var(old('quick_access_enabled', $fetchedData->quick_access_enabled ?? false), FILTER_VALIDATE_BOOLEAN)) value="1" type="checkbox" name="quick_access_enabled"> Allow this user to start short ({{ config('crm_access.quick_grant_minutes', 15) }} min) access to records they are not assigned to</label>
								</div>
								<hr class="my-3">
								<div class="form-group">
									<label class="d-block font-weight-bold">Full access</label>
									<input type="hidden" name="crm_full_access" value="0">
									<label><input @checked(filter_var(old('crm_full_access', $fetchedData->crm_full_access ?? false), FILTER_VALIDATE_BOOLEAN)) value="1" type="checkbox" name="crm_full_access"> See all clients and leads (bypass assignee / allocation when strict access is on)</label>
								</div>
								<hr class="my-3">
								<div class="form-group mb-0">
									...
									<label><input @checked(filter_var(old('crm_access_approver', $fetchedData->crm_access_approver ?? false), FILTER_VALIDATE_BOOLEAN)) value="1" type="checkbox" name="crm_access_approver"> Can approve or reject pending supervisor access requests (queue)</label>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group">
									...
									<p class="text-muted small">Used when this staff sends emails. Leave blank for no signature.</p>
								</div>
							</div>
						</div>
					</div>	
