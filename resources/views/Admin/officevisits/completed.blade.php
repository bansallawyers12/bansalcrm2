					...
					<div class="card">
						...
						<div class="card-body">
							...
							<ul class="nav nav-pills" id="checkin_tabs" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active" id="completed-tab"  href="{{URL::to('/office-visits/completed')}}" >Completed <span class="countAction">{{ $InPersonCount_completed_type }}</span></a>
								</li>
								<li class="nav-item">
							...
							<div class="mydropdown" style="margin-top:10px;">
								  ...
								  <a href="{{URL::to('/office-visits/completed')}}">All Branches</a>
								  <?php
								  $branchs = \App\Models\Branch::all();
								  foreach($branchs as $branch){
									?>
									<a href="{{URL::to('/office-visits/completed')}}?office={{$branch->id}}&office_name={{$branch->office_name}}">{{$branch->office_name}}</a>
								  <?php } ?>
