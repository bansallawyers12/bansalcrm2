					...
					<div class="card">
						...
						<div class="card-body">
							<ul class="nav nav-pills" id="checkin_tabs" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link" id="completed-tab"  href="{{URL::to('/admin/office-visits/completed')}}" >Completed</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="archived-tab"  href="{{URL::to('/admin/office-visits/archived')}}" >Archived</a>
								</li>
								<li class="nav-item">
									<a class="nav-link active" id="all-tab"  href="{{URL::to('/admin/office-visits')}}" >All</a>
								</li>
							</ul> 
							<div class="tab-content" id="checkinContent">
								<div class="mydropdown" style="margin-top:10px;">
								  ...
								  <a href="{{URL::to('/admin/office-visits/')}}">All Branches</a>
								  <?php
								  $branchs = \App\Branch::all();
								  foreach($branchs as $branch){
									?>
									<a href="{{URL::to('/admin/office-visits/')}}?office={{$branch->id}}&office_name={{$branch->office_name}}">{{$branch->office_name}}</a>
								  <?php } ?>
