					...
					<div class="card">
						...
						<div class="card-body">
							<ul class="nav nav-pills" id="checkin_tabs" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active" id="waiting-tab"  href="{{URL::to('/admin/office-visits/waiting')}}" >Waiting</a>
								</li>
								<li class="nav-item">
							...
							<div class="tab-content" id="checkinContent">
								...
								<div class="tab-pane fade show active" id="active" role="tabpanel" aria-labelledby="active-tab">
									<div class="table-responsive common_table"> 
										...
										<td><a href="javascript:;" data-id="{{@$list->id}}" class="btn btn-success attendsessionforclient">Pls send</a>
