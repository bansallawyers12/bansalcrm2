...
<div class="main-content">
	<section class="section">
		...
		<div class="section-body">
			<form action="{{ url('admin/clients/edit-new') }}" method="POST" name="edit-clients-new" autocomplete="off" enctype="multipart/form-data">
				@csrf
							...
							<div class="card-header d-flex justify-content-between align-items-center">
								<div class="header-title-section">
									<h4 class="mb-1">
										...
										Edit Client (New): {{ @$fetchedData->first_name }} {{ @$fetchedData->last_name }}
									</h4>
								...
								<div class="card-header-action">
								    ...
								    <button type="submit" class="btn btn-primary" onclick="customValidate('edit-clients-new')">
