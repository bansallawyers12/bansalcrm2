						...
						<div class="card-body">
							...
							<div class="client_assign client_info_tags">
								...
								<div class="assigneeshow" style="display:none;">
								    <table>
								        <tr>
								            <td><select class="form-control select2" id="changeassignee" name="changeassignee">
						                 	<?php
												foreach(\App\Admin::where('role','!=',7)->orderby('first_name','ASC')->get() as $admin){
													$branchname = \App\Branch::where('id',$admin->office_id)->first();
											?>
							...
							<div class="tab-content" id="clientContent" style="padding-top:15px;">
								<div class="tab-pane fade <?php if(!isset($_GET['tab']) ){ echo 'show active'; } ?>" id="activities" role="tabpanel" aria-labelledby="activities-tab">
									<div class="activities">
										<?php
										$activities = \App\ActivitiesLog::where('client_id', $fetchedData->id)->orderby('created_at', 'DESC')->get(); //->where('subject', '<>','added a note')
										//dd($activities);
                                        foreach($activities as $activit){
											...
											<div class="activity">
												...
												<div class="activity-detail">
													...
													<p><b>{{$admin->first_name}}</b>  <?php echo @$activit->subject; ?></p></div><div class="activity-date"><span class="text-job">{{date('d M Y, H:i A', strtotime($activit->created_at))}}</span></div></div>
											...
											<div class="extra_content">
												...
												<div class="left">
													...
													<div class="note_modify">
														<small>Last Modified <span>{{date('Y-m-d h:i A', strtotime($list->updated_at))}}</span></small>
