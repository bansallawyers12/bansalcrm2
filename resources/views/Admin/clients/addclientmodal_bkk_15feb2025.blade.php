					...
					<div class="row">
						...
						<div class="col-12 col-md-12 col-lg-12">
							<div class="form-group row align-items-center">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::text('client_name', @$fetchedData->client_id, array('class' => 'form-control', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Enter Client Reference','readonly'=>'readonly' )) }}
                        ...
                        <div class="col-12 col-md-12 col-lg-12 appointment_row" id="appointment_details" style="display: none;">
                            <div class="form-group row align-items-center">
                                <label for="appointment_details" class="heading_title col-sm-3 col-form-label">Appointment details <span class="span_req">*</span></label>
                                <div class="col-sm-9">
                        ...
                        <div class="col-6 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<select data-valid="required" class="form-control select2" name="checklist[]" id="checklist" multiple>
									<option value="">Select</option>
									<?php
									$eduChkList = \App\DocumentChecklist::where('status',1)->get();
...
<div class="modal fade custom_modal" id="refund_application" tabindex="-1" role="dialog" aria-labelledby="applicationModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="{{URL::to('/admin/refund_application')}}" name="refund_app" id="refund_app" autocomplete="off" enctype="multipart/form-data">
				    @csrf
