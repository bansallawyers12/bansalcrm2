				...
				<div class="col-8 col-md-8 col-lg-8">-->
					<div class="card left_section_lower">
						<div class="card-header">
							...
							<!--<h4>Personal Details</h4>
							<div class="add_note" style="margin-left: 65px;">
							    <a href="javascript:;" style="border-radius: 0px;padding: 2px 5px;" datatype="note" class="create_note_d btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add Notes</a>
							</div>-->
						</div>
						<div class="card-body">
							...
							<p class="clearfix">
								<span class="float-left">Last Updated:</span>
...
$(document).ready(function() {
    ...
    $(document).delegate('.total_fee_am','blur', function(){
       ...
       // var percentage = ( parseFloat(total_fee_am) * parseFloat(commission_percentage))/100;
        ...
        var tution_fee = parseFloat(total_course_fee_amount) - parseFloat(enrolment_fee_amount) - parseFloat(material_fee_amount);
        if(tution_fee >0){
