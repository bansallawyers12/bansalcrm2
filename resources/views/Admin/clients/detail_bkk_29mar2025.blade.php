                                    ...
                                    <div class="tab-content" id="composeemailContent">
                                            ...
                                            <div class="table-responsive uploadchecklists">
                                                ...
                                                <table id="mychecklist-datatable" class="table text_wrap table-2">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><input type="checkbox" name="checklistfile[]" value="{{$uclist->id}}"></td>
                                        ...
                                        <div class="tab-pane fade" id="composedocument" role="tabpanel" aria-labelledby="composedocument-tab">
                                            ...
                                            <table id="mydocumentlist-datatable" class="table text_wrap table-2">
                                                ...
                                                <tbody>
                                                    @foreach(\App\Document::where('client_id',$fetchedData->id)->where('type','client')->whereIn('doc_type', ['education', 'migration', 'documents'])->whereNull('not_used_doc')->orderby('created_at', 'DESC')->get() as $composedoclist)
                                                    <tr>
                                                        <td><input type="checkbox" name="checklistfile_document[]" value="{{$composedoclist->id}}"></td>
                                                        ...
                                                        <td style="white-space: initial;">
                                                            ...
                                                            if( isset($composedoclist->doc_type) && $composedoclist->doc_type != "" )
                                                            {
                                                                ...
                                                                else if( $composedoclist->doc_type == "documents")
                                                                {
                                                                    ...
                                                                    {
                                                                        $clientInfo = \App\Admin::where('id',$fetchedData->id)->select('client_id')->first();
                                                                        if($clientInfo){
                                                                        ...
                                                                        //https://bansalcrm.s3.ap-southeast-2.amazonaws.com/KHUS230728437/documents/1732261922Inv%203676.pdf
                                                                        ?>
