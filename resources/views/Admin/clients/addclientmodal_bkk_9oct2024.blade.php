			...
			<div class="modal-body">
				...
				<input type="hidden" name="client_id" value="{{$fetchedData->id}}">
					<div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-12  info_row" id="info" style="display: none;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control description" placeholder="Enter Description" name="description" data-valid="required"></textarea>
                                        </div>
                                    </div>

                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="description">Date & Time <span class="span_req">*</span></label>
                        ...
                        <div class="col-12 col-md-6 col-lg-6" id="promo_code_used" style="display: none;">
							<div class="form-group">
								<label for="invites">Promo Code</label>
