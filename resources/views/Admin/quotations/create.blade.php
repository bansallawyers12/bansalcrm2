...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			{{ Form::open(array('url' => 'admin/quotations/store', 'name'=>"add-quotations", 'autocomplete'=>'off', "enctype"=>"multipart/form-data")) }}
				<div class="row">
					...
					<div class="col-12 col-md-4 col-lg-4">
						<div class="card">
							...
							<div class="card-body">
								<p>{{$fetchedData->first_name}} {{$fetchedData->last_name}}<br>{{$fetchedData->email}}</p>
						...
						<div class="card">							
							<div class="card-body">
								<div class="form-group"> 
									...
									{{ Form::text('due_date', '', array('class' => 'form-control datepicker', 'data-valid'=>'required', 'autocomplete'=>'off','placeholder'=>'Select Date' )) }}
								...
								<div class="form-group"> 
									...
									?>
									<div class="bfh-selectbox bfh-currencies" data-currency="{{$cuttency}}" data-flags="true" data-name="quotation_currency"></div>
