				...
				<div class="col-12 col-md-12 col-lg-12">
					<div class="card">
						...
						@elseif($type=="Jrp")
                            ...
                            <h4>Shubam/yadwinder Appointments Calendar</h4>	
						@elseif($type=="Tourist")
...
if($type=="Jrp"){ //shubam/Yadwinder
    //2- Temporary Residency Appointment and service_id = 2=>Free
    //3- JRP/Skill Assessment and service_id = 2=>Free
    $appointments = \App\Appointment::whereIn('noe_id', [2,3])->where('service_id','=', 2)->get();
}

if($type == "Education"){ //5=>Education/Course Change/Student Visa/Student Depen and 2=>Free
   $appointments = \App\Appointment::where('noe_id','=', 5)->where('service_id','=', 2)->get();
}

if($type == "Tourist"){ //4=>Tourist Visa and 2=>Free
    $appointments = \App\Appointment::where('noe_id','=', 4)->where('service_id','=', 2)->get();
}
//dd($appointments);
                ...
                <div class="modal-body rounded-0">
                    ...
                    <div class="container-fluid">
                        ...
                        <dl>
                            ...
                            <dt class="text-muted">InPerson Address</dt>
