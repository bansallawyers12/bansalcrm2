										...
										<div class="col-12 col-md-6 col-lg-6">
											<div class="form-group">
												...
												<div class="cus_field_input">
													...
													{{ Form::date('date',@$appointment->date, array('class' => 'form-control date', 'data-valid'=>'', 'autocomplete'=>'off','placeholder'=>'Select date' )) }}
													@if ($errors->has('date'))
														<span class="custom-error" role="alert">
                                    ...
                                    <div class="row">
										...
										<div class="col-12 col-md-6 col-lg-6">
											<div class="form-group">
												...
												{!! Form::select('status', ['Pending','Approved','Completed','Rejected','N/P','Inrogress','Did Not Come','Cancelled','Missed','Pending With Payment Pending','Pending With Payment Success','Pending With Payment Failed'], 'Pending', ['class' => 'form-control']) !!}
												@elseif(@$appointment->status =='1')
												{!! Form::select('status', ['Approved','Pending','Completed','Rejected','N/P','Inrogress','Did Not Come','Cancelled','Missed','Pending With Payment Pending','Pending With Payment Success','Pending With Payment Failed'], 'Approved', ['class' => 'form-control']) !!}
												@elseif(@$appointment->status =='2')
												{!! Form::select('status', ['Completed','Approved','Pending','Rejected','N/P','Inrogress','Did Not Come','Cancelled','Missed','Pending With Payment Pending','Pending With Payment Success','Pending With Payment Failed'], 'Completed', ['class' => 'form-control']) !!}
												@elseif(@$appointment->status =='3')
												{!! Form::select('status', ['Rejected','Completed','Approved','Pending','N/P','Inrogress','Did Not Come','Cancelled','Missed','Pending With Payment Pending','Pending With Payment Success','Pending With Payment Failed'], 'Rejected', ['class' => 'form-control']) !!}
												@elseif(@$appointment->status =='4')
												{!! Form::select('status', ['N/P','Rejected','Completed','Approved','Pending','Inrogress','Did Not Come','Cancelled','Missed','Pending With Payment Pending','Pending With Payment Success','Pending With Payment Failed'], 'N/P', ['class' => 'form-control']) !!}
                                                @elseif(@$appointment->status =='5')
												{!! Form::select('status', ['Inrogress','N/P','Rejected','Completed','Approved','Pending','Did Not Come','Cancelled','Missed','Pending With Payment Pending','Pending With Payment Success','Pending With Payment Failed'], 'Inrogress', ['class' => 'form-control']) !!}

                                                @elseif(@$appointment->status =='6')
												{!! Form::select('status', ['Did Not Come','Inrogress','N/P','Rejected','Completed','Approved','Pending','Cancelled','Missed','Pending With Payment Pending','Pending With Payment Success','Pending With Payment Failed'], 'Did Not Come', ['class' => 'form-control']) !!}
                                                @elseif(@$appointment->status =='7')
												{!! Form::select('status', ['Cancelled','Did Not Come','Inrogress','N/P','Rejected','Completed','Approved','Pending','Missed','Pending With Payment Pending','Pending With Payment Success','Pending With Payment Failed'], 'Cancelled', ['class' => 'form-control']) !!}
                                                @elseif(@$appointment->status =='8')
												{!! Form::select('status', ['Missed','Cancelled','Did Not Come','Inrogress','N/P','Rejected','Completed','Approved','Pending','Pending With Payment Pending','Pending With Payment Success','Pending With Payment Failed'], 'Missed', ['class' => 'form-control']) !!}
                                                @elseif(@$appointment->status =='9')
												{!! Form::select('status', ['Pending With Payment Pending','Missed','Cancelled','Did Not Come','Inrogress','N/P','Rejected','Completed','Approved','Pending','Pending With Payment Success','Pending With Payment Failed'], 'Pending With Payment Pending', ['class' => 'form-control']) !!}
                                                @elseif(@$appointment->status =='10')
												{!! Form::select('status', ['Pending With Payment Success','Pending With Payment Pending','Missed','Cancelled','Did Not Come','Inrogress','N/P','Rejected','Completed','Approved','Pending','Pending With Payment Failed'], 'Pending With Payment Success', ['class' => 'form-control']) !!}
                                                @elseif(@$appointment->status =='11')
												{!! Form::select('status', ['Pending With Payment Failed','Pending With Payment Success','Pending With Payment Pending','Missed','Cancelled','Did Not Come','Inrogress','N/P','Rejected','Completed','Approved','Pending'], 'Pending With Payment Failed', ['class' => 'form-control']) !!}
                                                @endif
