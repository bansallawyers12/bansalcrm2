					...
					<div class="card">
                            ...
                            <div class="card-header-action">
                                ...
                                <!--<form class="form-inline mr-auto">
                                    <div class=&quot;search-element&quot;>
                                        <select class="form-control js-data-example-ajaxccsearch12" type="search" placeholder="Search" aria-label="Search" data-width="200" style="width:200px"></select>
						...
						<div class="card-body">
							<div class="tab-content" id="quotationContent">
                                <form action="{{ route('assignee.activities') }}" method="get">
                                    <div class="row">
                                        <div class="col-md-12 group_type_section"><?php //echo $task_group;?>
                                            ...
                                            <a href="{{URL::to('/admin/activities?group_type=All')}}" id="All" class="group_type <?php if($task_group == 'All') { echo 'active';}?>">All <span class="countAction">{{ $assigneesCount_All_type }}</span></a> | &nbsp;

                                            <button type="button" class="btn btn-light">
                                                <a href="{{URL::to('/admin/activities?group_type=Call')}}" id="Call" class="group_type <?php if($task_group == 'Call') { echo 'active';}?>"> <i class="fa fa-phone" aria-hidden="true"></i> Call <span class="countAction">{{ $assigneesCount_call_type }}</span></a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="{{URL::to('/admin/activities?group_type=Checklist')}}" id="Checklist" class="group_type <?php if($task_group == 'Checklist') { echo 'active';}?>"><i class="fa fa-bars" aria-hidden="true"></i> Checklist <span class="countAction">{{ $assigneesCount_Checklist_type }}</span></a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="{{URL::to('/admin/activities?group_type=Review')}}" id="Review" class="group_type <?php if($task_group == 'Review') { echo 'active';}?>"> <i class="fa fa-check" aria-hidden="true"></i> Review <span class="countAction">{{ $assigneesCount_Review_type }}</span></a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="{{URL::to('/admin/activities?group_type=Query')}}" id="Query" class="group_type <?php if($task_group == 'Query') { echo 'active';}?>"><i class="fa fa-question" aria-hidden="true"></i> Query <span class="countAction">{{ $assigneesCount_Query_type }}</span></a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="{{URL::to('/admin/activities?group_type=Urgent')}}" id="Urgent" class="group_type <?php if($task_group == 'Urgent') { echo 'active';}?>"> <i class="fa fa-flag" aria-hidden="true"></i> Urgent <span class="countAction">{{ $assigneesCount_Urgent_type }}</span></a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="{{URL::to('/admin/activities?group_type=Personal Task')}}" id="Personal Task" class="group_type <?php if($task_group == 'Personal Task') { echo 'active';}?>"> <i class="fa fa-tasks" aria-hidden="true"></i> Personal Task <span class="countAction">{{ $assigneesCount_Personal_Task_type }}</span></a> &nbsp;
                                            </button>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 group_type_section">
                                            <div class="" style="display: inline-flex;float: right;margin-top: 15px;">
									...
									<div class="table-responsive common_table">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{-- @if($list->noteClient) --}}
                                                    <form action="{{ route('assignee.destroy_activity',$list->id) }}" method="POST">
                                                ...
                                                <?php } ?>
                                                        ...
                                                        <?php if($list->task_group != 'Personal Task'){?>
                                                        <button type="button" data-noteid="{{ $list->description }}" data-taskid="{{ $list->id }}" data-toggle="tooltip" title="" class="btn btn-primary btn-block reassign_task" data-container="body" data-role="popover" data-placement="bottom" data-html="true" data-content="<div id=&quot;popover-content&quot;>
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="8"><b>There is no incompleted activity exist.</b></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
