                                ...
                                <form action="{{ route('assignee.activities') }}" method="get">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 group_type_section"><?php //echo $task_group;?>
                                            ...
                                            <a href="{{URL::to('/admin/activities?group_type=All')}}" id="All" class="group_type <?php if($task_group == 'All') { echo 'active';}?>">All</a> | &nbsp;

                                            <button type="button" class="btn btn-light">
                                                <a href="{{URL::to('/admin/activities?group_type=Call')}}" id="Call" class="group_type <?php if($task_group == 'Call') { echo 'active';}?>"> <i class="fa fa-phone" aria-hidden="true"></i> Call</a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="{{URL::to('/admin/activities?group_type=Checklist')}}" id="Checklist" class="group_type <?php if($task_group == 'Checklist') { echo 'active';}?>"><i class="fa fa-bars" aria-hidden="true"></i> Checklist</a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="{{URL::to('/admin/activities?group_type=Review')}}" id="Review" class="group_type <?php if($task_group == 'Review') { echo 'active';}?>"> <i class="fa fa-check" aria-hidden="true"></i> Review</a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="{{URL::to('/admin/activities?group_type=Query')}}" id="Query" class="group_type <?php if($task_group == 'Query') { echo 'active';}?>"><i class="fa fa-question" aria-hidden="true"></i> Query</a> &nbsp;
                                            </button>

                                            <button type="button" class="btn btn-light">
                                                <a href="{{URL::to('/admin/activities?group_type=Urgent')}}" id="Urgent" class="group_type <?php if($task_group == 'Urgent') { echo 'active';}?>"> <i class="fa fa-flag" aria-hidden="true"></i> Urgent</a> &nbsp;
                                            </button>
                                    ...
                                    </div>" data-original-title="" title="" style="width: 105px;display: inline;margin-left: 25px">Add My Task</button>
                                                ...
                                                <td>
                                                   {{--@if($list->noteClient)--}}
                                                    <form action="{{ route('assignee.destroy_activity',$list->id) }}" method="POST">
                                                        ...
                                                        <!--<a class="btn btn-primary" data-toggle="tooltip" title="Edit" href="{{ url('/admin/clients/edit/'.base64_encode(convert_uuencode(@$list->client_id)).'') }}"> <i class="fa fa-edit" aria-hidden="true"></i> </a>-->
