						...
						<div class="card-header">
                            ...
                            <ul class="nav nav-pills" id="client_tabs" role="tablist">
								...
								<li class="nav-item is_checked_clientn11">
									<a class="nav-link" id="archived-tab"  href="{{URL::to('/admin/assignee-completed')}}">Complete</a>
								</li>

                                <li class="nav-item is_checked_clientn12">
									<a class="nav-link active" id="assigned_by_me"  href="{{URL::to('/admin/assigned_by_me')}}">Assigned by me</a>
								</li>
									...
									<div class="table-responsive common_table">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($list->noteClient)
                                                    <form action="{{ route('assignee.destroy_by_me',$list->id) }}" method="POST">
                                    ...
                                    <div class="table-responsive common_table">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{URL::to('/admin/clients/detail/'.base64_encode(convert_uuencode(@$listC->client_id)))}}" target="_blank" >{{ $list->noteClient->client_id ?? 'N/P' }}</a></td>
                                                <td>{{ date('d/m/Y',strtotime($listC->followup_date)) ?? 'N/P'}} </td>
                                                <td>{{ $listC->task_group??'N/P' }}</td>
                                                <td>{{ $listC->description??'N/P' }}</td>

                                                <!--<td>$listC->title??'N --}}/P' --}}</td>
                                                <td>{{-- $listC->noteClient->service??'N/P' --}}</td>-->
                                                ...
                                                <td>
                                                    @if($listC->noteClient)
                                                    <form action="{{ route('assignee.destroy_by_me',$listC->id) }}" method="POST">
                                                        ...
                                                        <input id=&quot;assign_client_id&quot;  type=&quot;hidden&quot; value=&quot;{{base64_encode(convert_uuencode(@$listC->client_id))}}&quot;>
                                                        <div class=&quot;box-footer&quot; style=&quot;padding:10px 0&quot;>
                                                        <div class=&quot;row&quot;>
                                                            <input type=&quot;hidden&quot; value=&quot;&quot; id=&quot;popoverrealdate&quot; name=&quot;popoverrealdate&quot; />
                                                        </div>
