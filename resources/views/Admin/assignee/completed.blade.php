						...
						<div class="card-header">
                            ...
                            <ul class="nav nav-pills" id="client_tabs" role="tablist">
								...
								<li class="nav-item is_checked_clientn11">
									<a class="nav-link active" id="archived-tab"  href="{{URL::to('/admin/assignee-completed')}}">Completed</a>
								</li>
										...
										<tr>
											...
											<td>
												...
												<form action="{{ route('assignee.destroy',$list->id) }}" method="POST">
                                                    ...
                                                    <a class="btn btn-primary not_complete_task" data-id="{{ $list->id }}" href="javascript:void(0)">Incomplete</a>
