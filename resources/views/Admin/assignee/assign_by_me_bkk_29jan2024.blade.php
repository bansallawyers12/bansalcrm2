						...
						<div class="card-header">
                            ...
                            <ul class="nav nav-pills" id="client_tabs" role="tablist">
                                <li class="nav-item is_checked_clientn12">
									<a class="nav-link" id=""  href="{{URL::to('/admin/activities')}}">Incomplete</a>
								</li>

                                <li class="nav-item is_checked_clientn11">
									<a class="nav-link" id="archived-tab"  href="{{URL::to('/admin/activities_completed')}}">Completed</a>
								</li>
                            </ul>
						</div>
						<div class="card-body">
							<div class="tab-content" id="quotationContent">
                                <form action="{{ route('assignee.assigned_by_me') }}" method="get">
                                    <div class="row">
