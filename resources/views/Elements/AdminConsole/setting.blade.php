...
<div class="custom_nav_setting">
    <ul>
		...
		<li class="{{ Route::currentRouteName() === 'adminconsole.followups.calendar-settings.index' || Route::currentRouteName() === 'adminconsole.followups.calendar-settings.edit' ? 'active' : '' }}"><a class="nav-link adminconsole-sub-link" href="{{ route('adminconsole.followups.calendar-settings.index') }}"><i class="fas fa-clock me-1"></i>Calendar Setting</a></li>
		<li class="{{ is_string(Route::currentRouteName()) && str_starts_with(Route::currentRouteName(), 'adminconsole.followups.blocked-times') ? 'active' : '' }}"><a class="nav-link adminconsole-sub-link" href="{{ route('adminconsole.followups.blocked-times.index') }}"><i class="fas fa-ban me-1"></i>Calendar Blocked Time</a></li> 
