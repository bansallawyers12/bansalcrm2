...
<nav class="navbar navbar-expand-lg main-navbar sticky">
				...
				<div class="dropdown-list-content dropdown-list-message">
					...
					<a href="#" class="dropdown-item">
						<span class="dropdown-item-avatar text-white">
							<img alt="image" src="{!! asset('public/img/users/user-2.png') !!}" class="rounded-circle">
						</span>
					...
					<a href="#" class="dropdown-item">
						<span class="dropdown-item-avatar text-white">
							<img alt="image" src="{!! asset('public/img/users/user-5.png') !!}" class="rounded-circle">
						</span>
						<span class="dropdown-item-desc">
	...
	<li class="dropdown dropdown-list-toggle">
		@if(Auth::user())
			<a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg" data-toggle="tooltip" data-placement="bottom" title="Click To See Notifications"><i data-feather="bell" class="bell"></i><span class="countbell" id="countbell_notification"><?php  echo \App\Notification::where('receiver_id', Auth::user()->id)->where('receiver_status', 0)->count(); ?></span></a>
        @endif
			<!--<div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
		...
		<li class="dropdown">
			<a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
				...
				@else
				<img  alt="{{str_limit(Auth::user()->first_name.' '.Auth::user()->last_name, 150, '...')}}" src="{{asset('public/img/profile_imgs')}}/{{@Auth::user()->profile_img}}" class="user-img-radious-style"/>
				@endif	
