...
<div class="custom_nav_setting">
    <ul>
        <?php
			if(Route::currentRouteName() == 'adminconsole.producttype.index' || Route::currentRouteName() == 'adminconsole.producttype.create' || Route::currentRouteName() == 'adminconsole.producttype.edit' || Route::currentRouteName() == 'adminconsole.visatype.index' || Route::currentRouteName() == 'adminconsole.visatype.create' || Route::currentRouteName() == 'adminconsole.visatype.edit' || Route::currentRouteName() == 'adminconsole.mastercategory.index' || Route::currentRouteName() == 'adminconsole.mastercategory.create' || Route::currentRouteName() == 'adminconsole.mastercategory.edit' || Route::currentRouteName() == 'adminconsole.leadservice.index' || Route::currentRouteName() == 'adminconsole.leadservice.create' || Route::currentRouteName() == 'adminconsole.leadservice.edit' || Route::currentRouteName() == 'adminconsole.subject.index' || Route::currentRouteName() == 'adminconsole.subject.create' || Route::currentRouteName() == 'adminconsole.subject.edit' || Route::currentRouteName() == 'adminconsole.source.index' || Route::currentRouteName() == 'adminconsole.source.create' || Route::currentRouteName() == 'adminconsole.source.edit' || Route::currentRouteName() == 'adminconsole.tags.index' || Route::currentRouteName() == 'adminconsole.tags.create' || Route::currentRouteName() == 'adminconsole.tags.edit' || Route::currentRouteName() == 'adminconsole.workflow.index' || Route::currentRouteName() == 'adminconsole.workflow.create' || Route::currentRouteName() == 'adminconsole.workflow.edit'){
