...
<nav class="navbar navbar-expand-lg main-navbar sticky">
	...
	<li class="dropdown dropdown-list-toggle">
		@if(Auth::user())
			<a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg"><i data-feather="bell" class="bell"></i><span class="countbell"><?php  echo \App\Notification::where('receiver_id', Auth::user()->id)->where('receiver_status', 0)->orderby('created_at','DESC')->count(); ?></span></a>
        @endif
			<div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
