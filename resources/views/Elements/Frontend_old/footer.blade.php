				...
				<div class="col-12 col-sm-12 col-md-3 col-lg-3">
					<div class="footer-widget">
						...
						<div class="widget-title">
							...
							<p>MARN: 1569359<br/> <a href="https://www.mara.gov.au/tools-for-agents-subsite/Files/code-of-conduct.pdf" target="_blank" rel="noopener">Code of Conduct</a></p>
						</div>
					</div>
				</div>
				<div class="col-12 col-sm-12 col-md-9 col-lg-9">
					<div class="row office_row">
						@foreach (@$officelists as $list)	
						<div class="col-12 col-sm-6 col-md-6 col-lg-3 office_info_col">
							<div class="footer-widget">
								<h4>{{@$list->name}}</h4>
								<ul class="office_list">
									...
									<?php }
										if(@$list->phone != '') {	
									?>
									<li><i class="fa fa-phone"></i> <a href="tel:{{@$list->phone}}">{{@$list->phone}}</a></li>
									<?php }
										if(@$list->phone2 != '') {	
									?>
									<li><i class="fa fa-phone"></i> <a href="tel:{{@$list->phone2}}">{{@$list->phone2}}</a></li>
									<?php }
										if(@$list->email != '') {	
									?>
								...
								<div class="footer_social_info">
									<ul class="social_link">										
										...
										<?php if($twicon !=  ''){  ?>
										<li class="tw_icon"><a href="<?php echo $twicon; ?>"><i class="fa fa-twitter"></i></a></li>
										<?php } ?>
